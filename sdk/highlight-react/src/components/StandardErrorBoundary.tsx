...
export type StandardErrorBoundaryProps = {
	...
	/**
	 * A custom fallback component that gets rendered when the error boundary encounters an error.
	 * This takes precedence over the fallback prop.
	 */
...
export interface StandardErrorBoundaryState {
	componentStack: string | null
	error: Error | null
	showingDialog: boolean
}

const INITIAL_STATE: StandardErrorBoundaryState = {
	componentStack: null,
	error: null,
	showingDialog: false,
}
...
> {
	...
	public state: StandardErrorBoundaryState = INITIAL_STATE
	...
	render() {
		const { fallback, customFallback, children, customDialog } = this.props
