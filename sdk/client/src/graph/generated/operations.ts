...
export type IdentifySessionMutation = { __typename?: 'Mutation', identifySession: string };
...
export type AddSessionPropertiesMutation = { __typename?: 'Mutation', addSessionProperties: string };
...
export type InitializeSessionMutationVariables = Exact<{
  ...
  appVersion?: InputMaybe<Scalars['String']>;
  client_id: Scalars['String'];
  network_recording_domains?: InputMaybe<Array<Scalars['String']> | Scalars['String']>;
  disable_session_recording?: InputMaybe<Scalars['Boolean']>;
}>;


export type InitializeSessionMutation = { __typename?: 'Mutation', initializeSession: { __typename?: 'InitializeSessionResponse', secure_id: string, project_id: string } };
...
export const PushPayloadDocument = gql`
    mutation PushPayload($session_secure_id: String!, $events: ReplayEventsInput!, $messages: String!, $resources: String!, $web_socket_events: String!, $errors: [ErrorObjectInput]!, $is_beacon: Boolean, $has_session_unloaded: Boolean, $highlight_logs: String, $payload_id: ID) {
  pushPayload(
...
export const InitializeSessionDocument = gql`
    mutation initializeSession($session_secure_id: String!, $organization_verbose_id: String!, $enable_strict_privacy: Boolean!, $enable_recording_network_contents: Boolean!, $clientVersion: String!, $firstloadVersion: String!, $clientConfig: String!, $environment: String!, $id: String!, $appVersion: String, $client_id: String!, $network_recording_domains: [String!], $disable_session_recording: Boolean) {
  initializeSession(
    session_secure_id: $session_secure_id
