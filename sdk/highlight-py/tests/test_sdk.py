...
def test_record_exception(mocker, mock_otlp, project_id, session_id, request_id, environment):
    integrations, instrument_logging = mock_otlp
    h = highlight_io.H(
        project_id, integrations=integrations, instrument_logging=instrument_logging, environment=environment
    )
