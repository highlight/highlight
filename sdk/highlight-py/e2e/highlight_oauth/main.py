...
def perform_oauth_flow():
    r = requests.get(f'{OAUTH_URL}/token', verify=False, params={
...
def make_request(url):
    ...
    r = requests.post(
        ...
        json={
            ...
            "variables": {"query": {"isAnd": True, "rules": [
                ["custom_processed", "is", "true"],
                ["custom_created_at", "between_date", "2023-09-12T03:51:47.260Z_2023-10-12T03:51:47.260Z"]]},
                          "count": 10,
                          "page": 1, "project_id": "1",
                          "sort_desc": True},
