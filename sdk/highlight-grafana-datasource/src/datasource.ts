...
export const metricOptions: { value: string; label: string; tables: Table[] }[] = [
  { value: 'Count', label: 'Count', tables: ['traces', 'logs', 'errors'] },
  { value: 'Min', label: 'Min', tables: ['traces', 'logs'] },
  { value: 'Avg', label: 'Avg', tables: ['traces', 'logs'] },
  { value: 'P50', label: 'P50', tables: ['traces', 'logs'] },
  { value: 'P90', label: 'P90', tables: ['traces', 'logs'] },
  { value: 'P95', label: 'P95', tables: ['traces', 'logs'] },
  { value: 'P99', label: 'P99', tables: ['traces', 'logs'] },
  { value: 'Max', label: 'Max', tables: ['traces', 'logs'] },
  { value: 'Sum', label: 'Sum', tables: ['traces', 'logs'] },
];
