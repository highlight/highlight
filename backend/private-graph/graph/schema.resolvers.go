...
func (r *queryResolver) Logs(ctx context.Context, projectID int, params modelInputs.QueryInput, after *string, before *string, at *string, direction modelInputs.SortDirection, aggregate *bool) (*modelInputs.LogConnection, error) {
	project, err := r.isUserInProjectOrDemoProject(ctx, projectID)
	if err != nil {
		return nil, err
	}
