...
func (h *HubspotMock) CreateContactForAdmin(adminID int, email string, userDefinedRole string, userDefinedPersona string, first string, last string, referral string) (*int, error) {
	return nil, nil
}
