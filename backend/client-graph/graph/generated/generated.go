...
type ComplexityRoot struct {
	Mutation struct {
		...
		PushPayload          func(childComplexity int, sessionID int, events model.ReplayEventsInput, messages string, resources string, errorObjects []*model.ErrorObjectInput) int
	}
...
type MutationResolver interface {
	...
	PushPayload(ctx context.Context, sessionID int, events model.ReplayEventsInput, messages string, resources string, errorObjects []*model.ErrorObjectInput) (*int, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.pushPayload":
		...
		return e.complexity.Mutation.PushPayload(childComplexity, args["session_id"].(int), args["events"].(model.ReplayEventsInput), args["messages"].(string), args["resources"].(string), args["errorObjects"].([]*model.ErrorObjectInput)), true
...
func (ec *executionContext) field_Mutation_pushPayload_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["errorObjects"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("errorObjects"))
...
func (ec *executionContext) _Mutation_pushPayload(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().PushPayload(rctx, args["session_id"].(int), args["events"].(model.ReplayEventsInput), args["messages"].(string), args["resources"].(string), args["errorObjects"].([]*model.ErrorObjectInput))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
