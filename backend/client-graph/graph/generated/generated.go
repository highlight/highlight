...
type ComplexityRoot struct {
	Mutation struct {
		...
		PushPayload          func(childComplexity int, sessionID int, events string, messages string, resources string, errors []*model.ErrorObjectInput) int
	}
...
type MutationResolver interface {
	...
	PushPayload(ctx context.Context, sessionID int, events string, messages string, resources string, errors []*model.ErrorObjectInput) (*int, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.pushPayload":
		...
		return e.complexity.Mutation.PushPayload(childComplexity, args["session_id"].(int), args["events"].(string), args["messages"].(string), args["resources"].(string), args["errors"].([]*model.ErrorObjectInput)), true
...
func (ec *executionContext) field_Mutation_addSessionProperties_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["properties_object"]; ok {
		ctx := graphql.WithFieldInputContext(ctx, graphql.NewFieldInputWithField("properties_object"))
...
func (ec *executionContext) field_Mutation_identifySession_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["user_identifier"]; ok {
		ctx := graphql.WithFieldInputContext(ctx, graphql.NewFieldInputWithField("user_identifier"))
...
func (ec *executionContext) field_Mutation_pushPayload_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["errors"]; ok {
		ctx := graphql.WithFieldInputContext(ctx, graphql.NewFieldInputWithField("errors"))
...
func (ec *executionContext) _Mutation_pushPayload(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().PushPayload(rctx, args["session_id"].(int), args["events"].(string), args["messages"].(string), args["resources"].(string), args["errors"].([]*model.ErrorObjectInput))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalInputErrorObjectInput(ctx context.Context, obj interface{}) (model.ErrorObjectInput, error) {
	...
	for k, v := range asMap {
		...
		case "lineNumber":
			...
			ctx := graphql.WithFieldInputContext(ctx, graphql.NewFieldInputWithField("lineNumber"))
		...
		case "columnNumber":
			...
			ctx := graphql.WithFieldInputContext(ctx, graphql.NewFieldInputWithField("columnNumber"))
		...
		case "trace":
			...
			ctx := graphql.WithFieldInputContext(ctx, graphql.NewFieldInputWithField("trace"))
			it.Trace, err = ec.unmarshalNStackFrameInput2ᚕᚖgithubᚗcomᚋjayᚑkhatriᚋfullstoryᚋbackendᚋclientᚑgraphᚋgraphᚋmodelᚐStackFrameInput(ctx, v)
			if err != nil {
				return it, err
			}
		}
...
func (ec *executionContext) unmarshalInputStackFrameInput(ctx context.Context, obj interface{}) (model.StackFrameInput, error) {
	...
	for k, v := range asMap {
		...
		case "isEval":
			...
			ctx := graphql.WithFieldInputContext(ctx, graphql.NewFieldInputWithField("isEval"))
		...
		case "isNative":
			...
			ctx := graphql.WithFieldInputContext(ctx, graphql.NewFieldInputWithField("isNative"))
...
func (ec *executionContext) unmarshalNStackFrameInput2ᚕᚖgithubᚗcomᚋjayᚑkhatriᚋfullstoryᚋbackendᚋclientᚑgraphᚋgraphᚋmodelᚐStackFrameInput(ctx context.Context, v interface{}) ([]*model.StackFrameInput, error) {
	var vSlice []interface{}
	if v != nil {
		if tmp1, ok := v.([]interface{}); ok {
			vSlice = tmp1
	...
	for i := range vSlice {
		ctx := graphql.WithFieldInputContext(ctx, graphql.NewFieldInputWithIndex(i))
		res[i], err = ec.unmarshalOStackFrameInput2ᚖgithubᚗcomᚋjayᚑkhatriᚋfullstoryᚋbackendᚋclientᚑgraphᚋgraphᚋmodelᚐStackFrameInput(ctx, vSlice[i])
		if err != nil {
			return nil, graphql.WrapErrorWithInputPath(ctx, err)
		}
	}
...
func (ec *executionContext) unmarshalOStackFrameInput2ᚖgithubᚗcomᚋjayᚑkhatriᚋfullstoryᚋbackendᚋclientᚑgraphᚋgraphᚋmodelᚐStackFrameInput(ctx context.Context, v interface{}) (*model.StackFrameInput, error) {
	if v == nil {
		return nil, nil
	}
