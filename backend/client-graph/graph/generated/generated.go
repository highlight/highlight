...
type ComplexityRoot struct {
	Mutation struct {
		...
		PushPayload          func(childComplexity int, sessionID int, eventsObject model.ReplayEventsInput, messages string, resources string, errors []*model.ErrorObjectInput) int
	}
...
type MutationResolver interface {
	...
	PushPayload(ctx context.Context, sessionID int, eventsObject model.ReplayEventsInput, messages string, resources string, errors []*model.ErrorObjectInput) (*int, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.pushPayload":
		...
		return e.complexity.Mutation.PushPayload(childComplexity, args["session_id"].(int), args["eventsObject"].(model.ReplayEventsInput), args["messages"].(string), args["resources"].(string), args["errors"].([]*model.ErrorObjectInput)), true
...
func (ec *executionContext) field_Mutation_pushPayload_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["eventsObject"]; ok {
		ctx := graphql.WithFieldInputContext(ctx, graphql.NewFieldInputWithField("eventsObject"))
...
func (ec *executionContext) _Mutation_pushPayload(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().PushPayload(rctx, args["session_id"].(int), args["eventsObject"].(model.ReplayEventsInput), args["messages"].(string), args["resources"].(string), args["errors"].([]*model.ErrorObjectInput))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalInputErrorObjectInput(ctx context.Context, obj interface{}) (model.ErrorObjectInput, error) {
	...
	for k, v := range asMap {
		...
		case "trace":
			...
			it.Trace, err = ec.unmarshalNAny2ᚕinterface(ctx, v)
			if err != nil {
				return it, err
			}
		}
