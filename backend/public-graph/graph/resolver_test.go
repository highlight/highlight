	...
	for name, tc := range tests {
		util.RunTestWithDBWipeWithName(t, resolver.DB, name, func(t *testing.T) {
			...
			for _, emb := range tc.embeddingsToInsert {
				eo := model.ErrorObject{ErrorGroupID: createdErrorGroup.ID}
