			...
			expectedErrorGroups: []model.ErrorGroup{
				{
					...
					FieldGroup:     &nullStr,
					Environments:   `{"dev":2}`,
					SecureID:       "pCMwdx5RK061qPZ9AIFppAuQ0Am1",
				},
			},
		},
			...
			expectedErrorGroups: []model.ErrorGroup{
				{
					...
					SecureID:       "M9vReGheSq4NF5QntXM6g8t6J8Eq",
				},
			},
		},
			...
			expectedErrorGroups: []model.ErrorGroup{
				{
					...
					FieldGroup:     &nullStr,
					Environments:   `{"dev":1}`,
					SecureID:       "MbzYfIyA0EGHOxHRaird88ZhJDew",
				},
			},
		},
			...
			expectedErrorGroups: []model.ErrorGroup{
				{
					...
					SecureID:         "EtUwzAMOC590WXKteO8oDdHyqJ9I",
				},
			},
		},
			...
			expectedErrorGroups: []model.ErrorGroup{
				{
					...
					State:            model.ErrorGroupStates.OPEN,
					MappedStackTrace: util.MakeStringPointer("null"),
					SecureID:         "fQ3eKJ968ZXORLJookvvVD0WpamV",
				},
			},
		},
	}
