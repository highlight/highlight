...
var testCases = []struct {
	...
	{
		ptr.String(`{"user_properties":null,"excluded_properties":null,"track_properties":null,"excluded_track_properties":null,"date_range":null,"length_range":null,"browser":null,"os":null,"environments":null,"app_versions":null,"device_id":null,"visited_url":null,"referrer":null,"identified":false,"hide_viewed":false,"first_time":false,"show_live_sessions":false,"query":"{\"isAnd\":true,\"rules\":[[\"user_email\",\"not_contains\",\"dashworks\"],[\"custom_processed\",\"is\",\"true\"],[\"track_event\",\"is\",\"hl-search-query\"],[\"session_country\",\"is\",\"united states\"]]}"}`),
		ptr.String(`{"Query":"email!=*dashworks* processed=true event=hl-search-query country="united states""}`),
	},
	{
		ptr.String(`{"user_properties":null,"excluded_properties":null,"track_properties":null,"excluded_track_properties":null,"date_range":null,"length_range":null,"browser":null,"os":null,"environments":null,"app_versions":null,"device_id":null,"visited_url":null,"referrer":null,"identified":false,"hide_viewed":false,"first_time":false,"show_live_sessions":false,"query":"{\"isAnd\":true,\"rules\":[[\"user_email\",\"not_contains\",\"dashworks\"],[\"custom_processed\",\"is\",\"true\"],[\"track_event\",\"is\",\"hl-search-query\"],[\"session_country\",\"is\",\"costa rica\",\"united states\"]]}"}`),
		ptr.String(`{"Query":"email!=*dashworks* processed=true event=hl-search-query country=("costa rica" OR "united states")"}`),
	},
	{
		ptr.String(`{"user_properties":null,"excluded_properties":null,"track_properties":null,"excluded_track_properties":null,"date_range":null,"length_range":null,"browser":null,"os":null,"environments":null,"app_versions":null,"device_id":null,"visited_url":null,"referrer":null,"identified":false,"hide_viewed":false,"first_time":false,"show_live_sessions":false,"query":"{\"isAnd\":true,\"rules\":[[\"user_email\",\"not_contains\",\"dashworks\"],[\"custom_processed\",\"is\",\"true\"],[\"track_event\",\"is\",\"hl-search-query\"],[\"session_country\",\"is_not\",\"united states\"]]}"}`),
		ptr.String(`{"Query":"email!=*dashworks* processed=true event=hl-search-query country!="united states""}`),
	},
	{
	...
	{
		ptr.String(`{"user_properties":null,"excluded_properties":null,"track_properties":null,"excluded_track_properties":null,"date_range":null,"length_range":null,"browser":null,"os":null,"environments":null,"app_versions":null,"device_id":null,"visited_url":null,"referrer":null,"identified":false,"hide_viewed":false,"first_time":false,"show_live_sessions":false,"query":"{\"isAnd\":true,\"rules\":[[\"custom_processed\",\"is\",\"true\"],[\"custom_created_at\",\"between_date\",\"30 days\"],[\"custom_active_length\",\"between_time\",\"3_60\"],[\"session_country\",\"not_contains\",\"spain\"],[\"session_country\",\"not_contains\",\"united states\"],[\"session_country\",\"not_contains\",\"japan\"]]}"}`),
		ptr.String(`{"Query":"processed=true (active_length>=3 AND active_length<=60) country!=*spain* country!="*united states*" country!=*japan*"}`),
	},
	{
