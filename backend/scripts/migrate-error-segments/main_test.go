...
var testCases = []struct {
	...
	},
	{
		...
		ptr.String(`{"Query":"status=OPEN status=RESOLVED"}`),
	},
	{
		...
		ptr.String(`{"Query":"status=OPEN browser=Chrome browser=Chrome environment!=production"}`),
	},
	{
		...
		ptr.String(`{"Query":"status=OPEN visited_url!=*localhost*"}`),
	},
	{
	...
	},
	{
		...
		ptr.String(`{"Query":"status=OPEN browser=Chrome browser=Chrome environment=(production OR prod)"}`),
	},
	{
