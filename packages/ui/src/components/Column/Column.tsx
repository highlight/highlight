...
import { Box, PaddingProps, Props as BoxProps } from '../Box/Box'
...
const Columns: React.FC<ColumnsProps> = ({ children, gap, ...props }) => (
	<ColumnsContext.Provider value={{ gap }}>
		<Box cssClass={clsx(styles.columns, negativeMargin(gap))} {...props}>
			{children}
		</Box>
