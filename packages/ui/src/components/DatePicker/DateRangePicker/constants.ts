...
export const VALID_DATE_INPUT_FORMATS = [
	...
	DATE_INPUT_FORMAT_WITH_MONTH_AND_DAY,
	DATE_INPUT_FORMAT_WITH_MONTH_AND_SINGLE_DAY,
	DATE_INPUT_FORMAT_WITH_NO_COMMA_NO_YEAR,
