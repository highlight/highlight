...
export type UpdateErrorGroupStateMutation = (
  ...
  & { updateErrorGroupState?: Types.Maybe<(
    ...
    & Pick<Types.ErrorGroup, 'secure_id' | 'state'>
  )> }
);
...
export type OpenSlackConversationMutation = (
  { __typename?: 'Mutation' }
  & Pick<Types.Mutation, 'openSlackConversation'>
);
...
export type CreateErrorAlertMutation = (
  ...
  & { createErrorAlert?: Types.Maybe<(
    ...
    & Pick<Types.ErrorAlert, 'id' | 'Name' | 'ExcludedEnvironments' | 'CountThreshold' | 'ThresholdWindow' | 'LastAdminToEditID' | 'RegexGroups' | 'Frequency'>
...
export type CreateMetricMonitorMutation = (
  ...
  & { createMetricMonitor?: Types.Maybe<(
    ...
    & Pick<Types.MetricMonitor, 'id' | 'updated_at' | 'name' | 'function' | 'metric_to_monitor' | 'last_admin_to_edit_id' | 'threshold'>
...
export type CreateRageClickAlertMutation = (
  { __typename?: 'Mutation' }
  & { createRageClickAlert?: Types.Maybe<(
    { __typename?: 'SessionAlert' }
    & Pick<Types.SessionAlert, 'id' | 'Name' | 'ExcludedEnvironments' | 'CountThreshold' | 'ThresholdWindow' | 'LastAdminToEditID'>
    & { ChannelsToNotify: Array<Types.Maybe<(
      { __typename?: 'SanitizedSlackChannel' }
      & Pick<Types.SanitizedSlackChannel, 'webhook_channel' | 'webhook_channel_id'>
    )>> }
...
export type UpdateErrorAlertMutation = (
  ...
  & { updateErrorAlert?: Types.Maybe<(
    { __typename?: 'ErrorAlert' }
    & Pick<Types.ErrorAlert, 'Name' | 'ExcludedEnvironments' | 'CountThreshold' | 'ThresholdWindow' | 'LastAdminToEditID' | 'RegexGroups' | 'Frequency'>
    & { ChannelsToNotify: Array<Types.Maybe<(
      { __typename?: 'SanitizedSlackChannel' }
      & Pick<Types.SanitizedSlackChannel, 'webhook_channel' | 'webhook_channel_id'>
    )>> }
...
export type CreateSessionFeedbackAlertMutation = (
  { __typename?: 'Mutation' }
...
export type UpdateSessionFeedbackAlertMutation = (
  { __typename?: 'Mutation' }
  & { updateSessionFeedbackAlert?: Types.Maybe<(
    { __typename?: 'SessionAlert' }
    & Pick<Types.SessionAlert, 'id' | 'ExcludedEnvironments' | 'CountThreshold' | 'ThresholdWindow' | 'Name' | 'LastAdminToEditID'>
    & { ChannelsToNotify: Array<Types.Maybe<(
      { __typename?: 'SanitizedSlackChannel' }
      & Pick<Types.SanitizedSlackChannel, 'webhook_channel' | 'webhook_channel_id'>
    )>> }
...
export type CreateNewUserAlertMutation = (
  { __typename?: 'Mutation' }
...
export type CreateNewSessionAlertMutationVariables = Types.Exact<{
  ...
  environments: Array<Types.Maybe<Types.Scalars['String']>> | Types.Maybe<Types.Scalars['String']>;
  threshold_window: Types.Scalars['Int'];
  exclude_rules: Array<Types.Maybe<Types.Scalars['String']>> | Types.Maybe<Types.Scalars['String']>;
}>;


export type CreateNewSessionAlertMutation = (
  { __typename?: 'Mutation' }
  & { createNewSessionAlert?: Types.Maybe<(
    { __typename?: 'SessionAlert' }
    & Pick<Types.SessionAlert, 'id' | 'Name' | 'ExcludedEnvironments' | 'CountThreshold' | 'ThresholdWindow' | 'LastAdminToEditID' | 'ExcludeRules'>
    & { ChannelsToNotify: Array<Types.Maybe<(
      { __typename?: 'SanitizedSlackChannel' }
      & Pick<Types.SanitizedSlackChannel, 'webhook_channel' | 'webhook_channel_id'>
    )>> }
...
export type UpdateNewSessionAlertMutation = (
  { __typename?: 'Mutation' }
...
export type UpdateRageClickAlertMutation = (
  { __typename?: 'Mutation' }
  & { updateRageClickAlert?: Types.Maybe<(
    { __typename?: 'SessionAlert' }
    & Pick<Types.SessionAlert, 'ExcludedEnvironments' | 'CountThreshold' | 'ThresholdWindow'>
    & { ChannelsToNotify: Array<Types.Maybe<(
      { __typename?: 'SanitizedSlackChannel' }
      & Pick<Types.SanitizedSlackChannel, 'webhook_channel' | 'webhook_channel_id'>
    )>> }
...
export type UpdateNewUserAlertMutation = (
  { __typename?: 'Mutation' }
  & { updateNewUserAlert?: Types.Maybe<(
    { __typename?: 'SessionAlert' }
    & Pick<Types.SessionAlert, 'id' | 'ExcludedEnvironments' | 'CountThreshold' | 'LastAdminToEditID'>
    & { ChannelsToNotify: Array<Types.Maybe<(
      { __typename?: 'SanitizedSlackChannel' }
      & Pick<Types.SanitizedSlackChannel, 'webhook_channel' | 'webhook_channel_id'>
    )>> }
...
export type CreateTrackPropertiesAlertMutationVariables = Types.Exact<{
  ...
  slack_channels: Array<Types.Maybe<Types.SanitizedSlackChannelInput>> | Types.Maybe<Types.SanitizedSlackChannelInput>;
  environments: Array<Types.Maybe<Types.Scalars['String']>> | Types.Maybe<Types.Scalars['String']>;
  track_properties: Array<Types.Maybe<Types.TrackPropertyInput>> | Types.Maybe<Types.TrackPropertyInput>;
  threshold_window: Types.Scalars['Int'];
}>;


export type CreateTrackPropertiesAlertMutation = (
  { __typename?: 'Mutation' }
...
export type UpdateTrackPropertiesAlertMutation = (
  { __typename?: 'Mutation' }
  & { updateTrackPropertiesAlert?: Types.Maybe<(
    { __typename?: 'SessionAlert' }
    & Pick<Types.SessionAlert, 'id' | 'ExcludedEnvironments' | 'CountThreshold' | 'LastAdminToEditID' | 'Name'>
    & { ChannelsToNotify: Array<Types.Maybe<(
      { __typename?: 'SanitizedSlackChannel' }
      & Pick<Types.SanitizedSlackChannel, 'webhook_channel' | 'webhook_channel_id'>
    )>>, TrackProperties: Array<Types.Maybe<(
...
export type CreateUserPropertiesAlertMutationVariables = Types.Exact<{
  ...
  slack_channels: Array<Types.Maybe<Types.SanitizedSlackChannelInput>> | Types.Maybe<Types.SanitizedSlackChannelInput>;
  environments: Array<Types.Maybe<Types.Scalars['String']>> | Types.Maybe<Types.Scalars['String']>;
  user_properties: Array<Types.Maybe<Types.UserPropertyInput>> | Types.Maybe<Types.UserPropertyInput>;
  threshold_window: Types.Scalars['Int'];
}>;


export type CreateUserPropertiesAlertMutation = (
  { __typename?: 'Mutation' }
...
export type UpdateUserPropertiesAlertMutation = (
  { __typename?: 'Mutation' }
  & { updateUserPropertiesAlert?: Types.Maybe<(
    { __typename?: 'SessionAlert' }
    & Pick<Types.SessionAlert, 'id' | 'ExcludedEnvironments' | 'CountThreshold' | 'Name' | 'LastAdminToEditID'>
    & { ChannelsToNotify: Array<Types.Maybe<(
      { __typename?: 'SanitizedSlackChannel' }
      & Pick<Types.SanitizedSlackChannel, 'webhook_channel' | 'webhook_channel_id'>
    )>>, UserProperties: Array<Types.Maybe<(
...
export type GetWebVitalDashboardQuery = (
  { __typename?: 'Query' }
  & { web_vital_dashboard: Array<Types.Maybe<(
    { __typename?: 'WebVitalDashboardPayload' }
    & Pick<Types.WebVitalDashboardPayload, 'date' | 'avg' | 'p50' | 'p75' | 'p90' | 'p99'>
  )>> }
);
...
export type GetMetricPreviewQuery = (
  { __typename?: 'Query' }
  & { metric_preview: Array<Types.Maybe<(
    { __typename?: 'MetricPreview' }
    & Pick<Types.MetricPreview, 'value' | 'date'>
  )>> }
);
...
export type GetSessionQuery = (
  ...
  & { session?: Types.Maybe<(
    { __typename?: 'Session' }
    & Pick<Types.Session, 'secure_id' | 'os_name' | 'os_version' | 'browser_name' | 'browser_version' | 'environment' | 'app_version' | 'city' | 'state' | 'postal' | 'fingerprint' | 'created_at' | 'language' | 'user_object' | 'user_properties' | 'identifier' | 'starred' | 'enable_strict_privacy' | 'enable_recording_network_contents' | 'field_group' | 'object_storage_enabled' | 'payload_size' | 'processed' | 'within_billing_quota' | 'client_version' | 'client_config' | 'is_public' | 'event_counts' | 'direct_download_url' | 'resources_url' | 'messages_url' | 'deviceMemory' | 'last_user_interaction_time'>
...
export type GetWorkspaceAdminsByProjectIdQuery = (
  { __typename?: 'Query' }
  & { admins: Array<Types.Maybe<(
    { __typename?: 'Admin' }
    & Pick<Types.Admin, 'id' | 'name' | 'email' | 'photo_url' | 'role'>
  )>> }
);
...
export type GetSessionsOpenSearchQuery = (
  ...
  & { sessions_opensearch: (
    ...
    & { sessions: Array<(
      { __typename?: 'Session' }
      & Pick<Types.Session, 'id' | 'secure_id' | 'fingerprint' | 'identifier' | 'os_name' | 'os_version' | 'browser_name' | 'browser_version' | 'city' | 'state' | 'postal' | 'created_at' | 'language' | 'length' | 'active_length' | 'enable_recording_network_contents' | 'viewed' | 'starred' | 'processed' | 'first_time' | 'user_properties' | 'event_counts' | 'last_user_interaction_time'>
      & { fields?: Types.Maybe<Array<Types.Maybe<(
        { __typename?: 'Field' }
...
export type GetErrorGroupsOpenSearchQuery = (
  ...
  & { error_groups_opensearch: (
    ...
    & { error_groups: Array<(
      { __typename?: 'ErrorGroup' }
      & Pick<Types.ErrorGroup, 'created_at' | 'id' | 'secure_id' | 'type' | 'event' | 'state' | 'environments' | 'stack_trace' | 'error_frequency'>
      & { structured_stack_trace: Array<Types.Maybe<(
        { __typename?: 'ErrorTrace' }
        & Pick<Types.ErrorTrace, 'fileName' | 'lineNumber' | 'functionName' | 'columnNumber'>
      )>>, metadata_log: Array<Types.Maybe<(
        { __typename?: 'ErrorMetadata' }
        & Pick<Types.ErrorMetadata, 'error_id' | 'session_secure_id' | 'timestamp'>
      )>> }
    )> }
  ) }
);
...
export type GetSessionsQuery = (
  ...
  & { sessions: (
    ...
    & { sessions: Array<(
      { __typename?: 'Session' }
      & Pick<Types.Session, 'id' | 'secure_id' | 'fingerprint' | 'identifier' | 'os_name' | 'os_version' | 'browser_name' | 'browser_version' | 'city' | 'state' | 'postal' | 'created_at' | 'language' | 'length' | 'active_length' | 'enable_recording_network_contents' | 'viewed' | 'starred' | 'processed' | 'field_group' | 'first_time' | 'user_properties' | 'event_counts' | 'last_user_interaction_time'>
      & { fields?: Types.Maybe<Array<Types.Maybe<(
        { __typename?: 'Field' }
        & Pick<Types.Field, 'name' | 'value' | 'type' | 'id'>
      )>>> }
...
export type GetWorkspaceQuery = (
  ...
  & { workspace?: Types.Maybe<(
    { __typename?: 'Workspace' }
    & Pick<Types.Workspace, 'id' | 'name' | 'secret'>
...
export type GetAdminQuery = (
  ...
  & { admin?: Types.Maybe<(
    { __typename?: 'Admin' }
    & Pick<Types.Admin, 'id' | 'uid' | 'name' | 'email' | 'photo_url' | 'slack_im_channel_id' | 'role' | 'email_verified'>
  )> }
);
...
export type GetProjectQuery = (
  ...
  & { project?: Types.Maybe<(
    { __typename?: 'Project' }
    & Pick<Types.Project, 'id' | 'name' | 'verbose_id' | 'billing_email'>
  )>, workspace?: Types.Maybe<(
    { __typename?: 'Workspace' }
...
export type GetBillingDetailsQuery = (
  ...
  & { billingDetails: (
    ...
    { __typename?: 'Workspace' }
    & Pick<Types.Workspace, 'id' | 'trial_end_date' | 'billing_period_end' | 'next_invoice_date' | 'allow_meter_overage' | 'eligible_for_trial_extension'>
  )> }
);
...
export type GetErrorGroupQuery = (
  ...
  & { error_group?: Types.Maybe<(
    { __typename?: 'ErrorGroup' }
    & Pick<Types.ErrorGroup, 'created_at' | 'id' | 'secure_id' | 'type' | 'project_id' | 'event' | 'state' | 'mapped_stack_trace' | 'stack_trace' | 'error_frequency' | 'is_public'>
    & { structured_stack_trace: Array<Types.Maybe<(
      { __typename?: 'ErrorTrace' }
      & Pick<Types.ErrorTrace, 'fileName' | 'lineNumber' | 'functionName' | 'columnNumber'>
    )>>, metadata_log: Array<Types.Maybe<(
      { __typename?: 'ErrorMetadata' }
      & Pick<Types.ErrorMetadata, 'error_id' | 'session_secure_id' | 'environment' | 'timestamp' | 'os' | 'browser' | 'visited_url' | 'fingerprint' | 'identifier' | 'user_properties' | 'request_id'>
    )>>, fields?: Types.Maybe<Array<Types.Maybe<(
...
export type GetErrorGroupsQuery = (
  { __typename?: 'Query' }
...
export type UnprocessedSessionsCountQuery = (
  { __typename?: 'Query' }
  & Pick<Types.Query, 'unprocessedSessionsCount'>
);
...
export type GetSlackChannelSuggestionQuery = (
  { __typename?: 'Query' }
  & { slack_channel_suggestion?: Types.Maybe<Array<Types.Maybe<(
    { __typename?: 'SanitizedSlackChannel' }
    & Pick<Types.SanitizedSlackChannel, 'webhook_channel' | 'webhook_channel_id'>
  )>>> }
);
...
export type GetAlertsPagePayloadQuery = (
  { __typename?: 'Query' }
  & Pick<Types.Query, 'is_integrated_with_slack' | 'identifier_suggestion'>
  & { slack_channel_suggestion?: Types.Maybe<Array<Types.Maybe<(
    { __typename?: 'SanitizedSlackChannel' }
    & Pick<Types.SanitizedSlackChannel, 'webhook_channel' | 'webhook_channel_id'>
  )>>>, admins: Array<Types.Maybe<(
    ...
    { __typename?: 'ErrorAlert' }
    & Pick<Types.ErrorAlert, 'ExcludedEnvironments' | 'updated_at' | 'CountThreshold' | 'LastAdminToEditID' | 'ThresholdWindow' | 'RegexGroups' | 'Frequency' | 'id' | 'Type' | 'Name' | 'DailyFrequency'>
    & { ChannelsToNotify: Array<Types.Maybe<(
      { __typename?: 'SanitizedSlackChannel' }
      & Pick<Types.SanitizedSlackChannel, 'webhook_channel' | 'webhook_channel_id'>
    )>> }
    ...
    { __typename?: 'SessionAlert' }
    & Pick<Types.SessionAlert, 'updated_at' | 'ExcludedEnvironments' | 'CountThreshold' | 'ThresholdWindow' | 'LastAdminToEditID' | 'id' | 'Name' | 'Type' | 'DailyFrequency'>
    & { ChannelsToNotify: Array<Types.Maybe<(
      { __typename?: 'SanitizedSlackChannel' }
      & Pick<Types.SanitizedSlackChannel, 'webhook_channel' | 'webhook_channel_id'>
    )>> }
    ...
    { __typename?: 'SessionAlert' }
    & Pick<Types.SessionAlert, 'ExcludedEnvironments' | 'CountThreshold' | 'ThresholdWindow' | 'updated_at' | 'LastAdminToEditID' | 'Name' | 'id' | 'Type' | 'ExcludeRules' | 'DailyFrequency'>
    & { ChannelsToNotify: Array<Types.Maybe<(
      { __typename?: 'SanitizedSlackChannel' }
      & Pick<Types.SanitizedSlackChannel, 'webhook_channel' | 'webhook_channel_id'>
    )>> }
    ...
    { __typename?: 'SessionAlert' }
    & Pick<Types.SessionAlert, 'id' | 'ExcludedEnvironments' | 'CountThreshold' | 'ThresholdWindow' | 'updated_at' | 'LastAdminToEditID' | 'Name' | 'Type' | 'DailyFrequency'>
    & { ChannelsToNotify: Array<Types.Maybe<(
      { __typename?: 'SanitizedSlackChannel' }
      & Pick<Types.SanitizedSlackChannel, 'webhook_channel' | 'webhook_channel_id'>
    )>> }
    ...
    { __typename?: 'SessionAlert' }
    & Pick<Types.SessionAlert, 'id' | 'ExcludedEnvironments' | 'CountThreshold' | 'updated_at' | 'LastAdminToEditID' | 'Name' | 'Type' | 'DailyFrequency'>
    & { ChannelsToNotify: Array<Types.Maybe<(
      { __typename?: 'SanitizedSlackChannel' }
      & Pick<Types.SanitizedSlackChannel, 'webhook_channel' | 'webhook_channel_id'>
    )>> }
    ...
    { __typename?: 'SessionAlert' }
    & Pick<Types.SessionAlert, 'id' | 'ExcludedEnvironments' | 'updated_at' | 'LastAdminToEditID' | 'CountThreshold' | 'Name' | 'Type' | 'DailyFrequency'>
    & { ChannelsToNotify: Array<Types.Maybe<(
      { __typename?: 'SanitizedSlackChannel' }
      & Pick<Types.SanitizedSlackChannel, 'webhook_channel' | 'webhook_channel_id'>
    )>>, TrackProperties: Array<Types.Maybe<(
...
export type GetCommentMentionSuggestionsQuery = (
  ...
  & { admins: Array<Types.Maybe<(
    { __typename?: 'Admin' }
    & Pick<Types.Admin, 'id' | 'name' | 'email' | 'photo_url'>
  )>>, slack_members: Array<Types.Maybe<(
    { __typename?: 'SanitizedSlackChannel' }
    & Pick<Types.SanitizedSlackChannel, 'webhook_channel' | 'webhook_channel_id'>
  )>> }
);
