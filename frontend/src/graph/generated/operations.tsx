...
export type GetFieldsOpensearchQuery = (
  { __typename?: 'Query' }
  & Pick<Types.Query, 'fields_opensearch'>
);
...
export type GetQuickFieldsOpensearchQuery = (
  { __typename?: 'Query' }
  & { quickFields_opensearch: Array<Types.Maybe<(
    { __typename?: 'Field' }
    & Pick<Types.Field, 'type' | 'name' | 'value'>
  )>> }
);
...
export type GetErrorFieldsOpensearchQuery = (
  { __typename?: 'Query' }
  & Pick<Types.Query, 'error_fields_opensearch'>
);
...
export type GetSessionsOpenSearchQuery = (
  { __typename?: 'Query' }
  & { sessions_opensearch: (
...
export type GetSessionsHistogramQuery = (
  { __typename?: 'Query' }
  & { sessions_histogram: (
...
export type GetErrorGroupsOpenSearchQuery = (
  { __typename?: 'Query' }
...
export type GetErrorsHistogramQuery = (
  { __typename?: 'Query' }
  & { errors_histogram: (
...
export type ErrorObjectFragment = (
  { __typename?: 'ErrorObject' }
  & Pick<Types.ErrorObject, 'id' | 'created_at' | 'project_id' | 'session_id' | 'trace_id' | 'span_id' | 'log_cursor' | 'error_group_id' | 'error_group_secure_id' | 'event' | 'type' | 'url' | 'source' | 'lineNumber' | 'columnNumber' | 'stack_trace' | 'timestamp' | 'payload' | 'request_id' | 'os' | 'browser' | 'environment' | 'serviceVersion'>
  & { session?: Types.Maybe<(
    { __typename?: 'Session' }
...
export type GetLogsHistogramQuery = (
  ...
  & { logs_histogram: (
    ...
    & Pick<Types.LogsHistogram, 'totalCount'>
    & { buckets: Array<(
...
export type GetLogsKeyValuesQuery = (
  { __typename?: 'Query' }
  & Pick<Types.Query, 'logs_key_values'>
);
...
export type GetWorkspaceSettingsQuery = (
  ...
  & { workspaceSettings?: Types.Maybe<(
    { __typename?: 'AllWorkspaceSettings' }
    & Pick<Types.AllWorkspaceSettings, 'workspace_id' | 'ai_application' | 'ai_insights' | 'enable_enhanced_errors'>
  )> }
);
  ...
  & { error_objects: (
    ...
    & { edges: Array<(
      ...
      & { node: (
        ...
        & Pick<Types.ErrorObjectNode, 'id' | 'createdAt' | 'event' | 'timestamp' | 'errorGroupSecureID'>
        & { session?: Types.Maybe<(
          { __typename?: 'ErrorObjectNodeSession' }
          & Pick<Types.ErrorObjectNodeSession, 'secureID' | 'email' | 'appVersion' | 'fingerprint'>
        )> }
      ) }
    )>, pageInfo: (
      { __typename?: 'PageInfo' }
