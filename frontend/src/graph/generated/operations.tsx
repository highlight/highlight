...
export type MarkErrorGroupAsViewedMutation = (
  { __typename?: 'Mutation' }
  & { markErrorGroupAsViewed?: Types.Maybe<(
    { __typename?: 'ErrorGroup' }
    & Pick<Types.ErrorGroup, 'secure_id' | 'viewed'>
  )> }
);
...
export type MarkSessionAsViewedMutation = (
  { __typename?: 'Mutation' }
  & { markSessionAsViewed?: Types.Maybe<(
    { __typename?: 'Session' }
    & Pick<Types.Session, 'secure_id' | 'viewed'>
  )> }
);
...
export type SaveBillingPlanMutation = (
  { __typename?: 'Mutation' }
  & Pick<Types.Mutation, 'saveBillingPlan'>
);
...
export type UpdateBillingDetailsMutation = (
  { __typename?: 'Mutation' }
  & Pick<Types.Mutation, 'updateBillingDetails'>
);
...
export type UpdateErrorGroupStateMutation = (
  { __typename?: 'Mutation' }
  & { updateErrorGroupState?: Types.Maybe<(
    { __typename?: 'ErrorGroup' }
    & Pick<Types.ErrorGroup, 'secure_id' | 'state' | 'snoozed_until'>
  )> }
);
...
export type SendEmailSignupMutation = (
  { __typename?: 'Mutation' }
  & Pick<Types.Mutation, 'emailSignup'>
);
...
export type AddAdminToWorkspaceMutation = (
  { __typename?: 'Mutation' }
  & Pick<Types.Mutation, 'addAdminToWorkspace'>
);
...
export type JoinWorkspaceMutation = (
  { __typename?: 'Mutation' }
  & Pick<Types.Mutation, 'joinWorkspace'>
);
...
export type ChangeAdminRoleMutation = (
  { __typename?: 'Mutation' }
  & Pick<Types.Mutation, 'changeAdminRole'>
);
...
export type DeleteAdminFromProjectMutation = (
  { __typename?: 'Mutation' }
  & Pick<Types.Mutation, 'deleteAdminFromProject'>
);
...
export type SubmitRegistrationFormMutation = (
  { __typename?: 'Mutation' }
  & Pick<Types.Mutation, 'submitRegistrationForm'>
);
...
export type CreateAdminMutation = (
  ...
  & { createAdmin: (
    { __typename?: 'Admin' }
    & Pick<Types.Admin, 'id' | 'name' | 'email' | 'email_verified' | 'about_you_details_filled'>
  ) }
);
...
export type EditProjectMutation = (
  ...
  & { editProject?: Types.Maybe<(
    { __typename?: 'Project' }
    & Pick<Types.Project, 'id' | 'name' | 'billing_email' | 'excluded_users' | 'error_filters' | 'error_json_paths' | 'filter_chrome_extension' | 'rage_click_window_seconds' | 'rage_click_radius_pixels' | 'rage_click_count'>
  )> }
);
...
export type EditProjectSettingsMutation = (
  { __typename?: 'Mutation' }
  & { editProjectSettings?: Types.Maybe<(
    { __typename?: 'AllProjectSettings' }
    & Pick<Types.AllProjectSettings, 'id' | 'name' | 'billing_email' | 'excluded_users' | 'error_filters' | 'error_json_paths' | 'filter_chrome_extension' | 'rage_click_window_seconds' | 'rage_click_radius_pixels' | 'rage_click_count' | 'filterSessionsWithoutError' | 'autoResolveStaleErrorsDayInterval'>
    & { sampling: (
      { __typename?: 'Sampling' }
      & Pick<Types.Sampling, 'session_sampling_rate' | 'error_sampling_rate' | 'log_sampling_rate' | 'trace_sampling_rate' | 'session_minute_rate_limit' | 'error_minute_rate_limit' | 'log_minute_rate_limit' | 'trace_minute_rate_limit' | 'session_exclusion_query' | 'error_exclusion_query' | 'log_exclusion_query' | 'trace_exclusion_query'>
    ) }
  )> }
);
...
export type EditWorkspaceSettingsMutation = (
  { __typename?: 'Mutation' }
  & { editWorkspaceSettings?: Types.Maybe<(
    { __typename?: 'AllWorkspaceSettings' }
    & Pick<Types.AllWorkspaceSettings, 'workspace_id' | 'ai_application' | 'ai_insights'>
  )> }
);
...
export type DeleteSegmentMutation = (
  { __typename?: 'Mutation' }
  & Pick<Types.Mutation, 'deleteSegment'>
);
...
export type EditSegmentMutation = (
  { __typename?: 'Mutation' }
  & Pick<Types.Mutation, 'editSegment'>
);
...
export type CreateSessionCommentMutationVariables = Types.Exact<{
  ...
  tagged_admins: Array<Types.Maybe<Types.SanitizedAdminInput>> | Types.Maybe<Types.SanitizedAdminInput>;
  tagged_slack_users: Array<Types.Maybe<Types.SanitizedSlackChannelInput>> | Types.Maybe<Types.SanitizedSlackChannelInput>;
  ...
  tags: Array<Types.Maybe<Types.SessionCommentTagInput>> | Types.Maybe<Types.SessionCommentTagInput>;
  integrations: Array<Types.Maybe<Types.IntegrationType>> | Types.Maybe<Types.IntegrationType>;
...
export type CreateSessionCommentMutation = (
  ...
  & { createSessionComment?: Types.Maybe<(
    ...
    & Pick<Types.SessionComment, 'id' | 'timestamp' | 'created_at' | 'updated_at' | 'text' | 'x_coordinate' | 'y_coordinate'>
    & { author?: Types.Maybe<(
      { __typename?: 'SanitizedAdmin' }
      & Pick<Types.SanitizedAdmin, 'id' | 'name' | 'email'>
    )>, attachments: Array<Types.Maybe<(
      { __typename?: 'ExternalAttachment' }
      & Pick<Types.ExternalAttachment, 'id' | 'integration_type' | 'external_id' | 'title'>
    )>> }
  )> }
);
...
export type DeleteSessionCommentMutation = (
  { __typename?: 'Mutation' }
  & Pick<Types.Mutation, 'deleteSessionComment'>
);
...
export type ReplyToSessionCommentMutation = (
  { __typename?: 'Mutation' }
  & { replyToSessionComment?: Types.Maybe<(
    { __typename?: 'CommentReply' }
    & Pick<Types.CommentReply, 'id' | 'created_at' | 'updated_at' | 'text'>
    & { author: (
      { __typename?: 'SanitizedAdmin' }
      & Pick<Types.SanitizedAdmin, 'id' | 'name' | 'email' | 'photo_url'>
    ) }
  )> }
);
...
export type CreateErrorCommentMutation = (
  { __typename?: 'Mutation' }
  & { createErrorComment?: Types.Maybe<(
    { __typename?: 'ErrorComment' }
    & Pick<Types.ErrorComment, 'id' | 'created_at' | 'updated_at' | 'text'>
    & { author: (
      { __typename?: 'SanitizedAdmin' }
      & Pick<Types.SanitizedAdmin, 'id' | 'name' | 'email'>
    ) }
...
export type CreateIssueForErrorCommentMutation = (
  { __typename?: 'Mutation' }
...
export type DeleteErrorCommentMutation = (
  { __typename?: 'Mutation' }
  & Pick<Types.Mutation, 'deleteErrorComment'>
);
...
export type MuteErrorCommentThreadMutation = (
  { __typename?: 'Mutation' }
  & Pick<Types.Mutation, 'muteErrorCommentThread'>
);
...
export type RemoveErrorIssueMutation = (
  { __typename?: 'Mutation' }
  & Pick<Types.Mutation, 'removeErrorIssue'>
);
...
export type ReplyToErrorCommentMutation = (
  { __typename?: 'Mutation' }
...
export type DeleteErrorSegmentMutation = (
  { __typename?: 'Mutation' }
  & Pick<Types.Mutation, 'deleteErrorSegment'>
);
...
export type EditErrorSegmentMutation = (
  { __typename?: 'Mutation' }
  & Pick<Types.Mutation, 'editErrorSegment'>
);
...
export type CreateErrorSegmentMutation = (
  { __typename?: 'Mutation' }
  & { createErrorSegment?: Types.Maybe<(
    { __typename?: 'ErrorSegment' }
    & Pick<Types.ErrorSegment, 'name' | 'id'>
  )> }
);
...
export type CreateErrorAlertMutationVariables = Types.Exact<{
  ...
  slack_channels: Array<Types.Maybe<Types.SanitizedSlackChannelInput>> | Types.Maybe<Types.SanitizedSlackChannelInput>;
  discord_channels: Array<Types.DiscordChannelInput> | Types.DiscordChannelInput;
  webhook_destinations: Array<Types.WebhookDestinationInput> | Types.WebhookDestinationInput;
  emails: Array<Types.Maybe<Types.Scalars['String']>> | Types.Maybe<Types.Scalars['String']>;
  environments: Array<Types.Maybe<Types.Scalars['String']>> | Types.Maybe<Types.Scalars['String']>;
  regex_groups: Array<Types.Maybe<Types.Scalars['String']>> | Types.Maybe<Types.Scalars['String']>;
  frequency: Types.Scalars['Int'];
  default?: Types.Maybe<Types.Scalars['Boolean']>;
}>;


export type CreateErrorAlertMutation = (
  { __typename?: 'Mutation' }
  & { createErrorAlert?: Types.Maybe<(
    { __typename?: 'ErrorAlert' }
    & Pick<Types.ErrorAlert, 'id' | 'EmailsToNotify' | 'Name' | 'ExcludedEnvironments' | 'CountThreshold' | 'ThresholdWindow' | 'LastAdminToEditID' | 'RegexGroups' | 'Frequency' | 'disabled'>
    & { ChannelsToNotify: Array<Types.Maybe<(
      { __typename?: 'SanitizedSlackChannel' }
      & Pick<Types.SanitizedSlackChannel, 'webhook_channel' | 'webhook_channel_id'>
    )>> }
  )> }
);
...
export type CreateMetricMonitorMutationVariables = Types.Exact<{
  ...
  filters?: Types.Maybe<Array<Types.MetricTagFilterInput> | Types.MetricTagFilterInput>;
...
export type CreateMetricMonitorMutation = (
  { __typename?: 'Mutation' }
  & { createMetricMonitor?: Types.Maybe<(
    { __typename?: 'MetricMonitor' }
    & Pick<Types.MetricMonitor, 'id' | 'updated_at' | 'name' | 'emails_to_notify' | 'aggregator' | 'period_minutes' | 'metric_to_monitor' | 'last_admin_to_edit_id' | 'threshold' | 'units'>
    & { channels_to_notify: Array<Types.Maybe<(
      { __typename?: 'SanitizedSlackChannel' }
      & Pick<Types.SanitizedSlackChannel, 'webhook_channel' | 'webhook_channel_id'>
    )>> }
  )> }
...
export type UpdateMetricMonitorMutationVariables = Types.Exact<{
  ...
  slack_channels?: Types.Maybe<Array<Types.Maybe<Types.SanitizedSlackChannelInput>> | Types.Maybe<Types.SanitizedSlackChannelInput>>;
  discord_channels: Array<Types.DiscordChannelInput> | Types.DiscordChannelInput;
  webhook_destinations: Array<Types.WebhookDestinationInput> | Types.WebhookDestinationInput;
...
export type UpdateMetricMonitorMutation = (
  { __typename?: 'Mutation' }
...
export type DeleteMetricMonitorMutation = (
  { __typename?: 'Mutation' }
  & { deleteMetricMonitor?: Types.Maybe<(
    { __typename?: 'MetricMonitor' }
    & Pick<Types.MetricMonitor, 'id' | 'updated_at' | 'name' | 'emails_to_notify' | 'aggregator' | 'metric_to_monitor' | 'last_admin_to_edit_id' | 'threshold'>
    & { channels_to_notify: Array<Types.Maybe<(
      { __typename?: 'SanitizedSlackChannel' }
      & Pick<Types.SanitizedSlackChannel, 'webhook_channel' | 'webhook_channel_id'>
    )>> }
...
export type UpdateErrorAlertMutationVariables = Types.Exact<{
  ...
  webhook_destinations: Array<Types.WebhookDestinationInput> | Types.WebhookDestinationInput;
  emails?: Types.Maybe<Array<Types.Maybe<Types.Scalars['String']>> | Types.Maybe<Types.Scalars['String']>>;
  environments?: Types.Maybe<Array<Types.Maybe<Types.Scalars['String']>> | Types.Maybe<Types.Scalars['String']>>;
  regex_groups?: Types.Maybe<Array<Types.Maybe<Types.Scalars['String']>> | Types.Maybe<Types.Scalars['String']>>;
  frequency?: Types.Maybe<Types.Scalars['Int']>;
  disabled?: Types.Maybe<Types.Scalars['Boolean']>;
}>;


export type UpdateErrorAlertMutation = (
  { __typename?: 'Mutation' }
  & { updateErrorAlert?: Types.Maybe<(
    { __typename?: 'ErrorAlert' }
    & Pick<Types.ErrorAlert, 'Name' | 'EmailsToNotify' | 'ExcludedEnvironments' | 'CountThreshold' | 'ThresholdWindow' | 'LastAdminToEditID' | 'RegexGroups' | 'Frequency' | 'disabled'>
    & { ChannelsToNotify: Array<Types.Maybe<(
      { __typename?: 'SanitizedSlackChannel' }
      & Pick<Types.SanitizedSlackChannel, 'webhook_channel' | 'webhook_channel_id'>
    )>>, DiscordChannelsToNotify: Array<(
      { __typename?: 'DiscordChannel' }
      & Pick<Types.DiscordChannel, 'id' | 'name'>
    )> }
  )> }
);
...
export type DeleteErrorAlertMutation = (
  { __typename?: 'Mutation' }
  & { deleteErrorAlert?: Types.Maybe<(
    { __typename?: 'ErrorAlert' }
    & Pick<Types.ErrorAlert, 'id'>
  )> }
);
...
export type DeleteSessionAlertMutation = (
  { __typename?: 'Mutation' }
  & { deleteSessionAlert?: Types.Maybe<(
    { __typename?: 'SessionAlert' }
    & Pick<Types.SessionAlert, 'id'>
  )> }
);
...
export type UpdateLogAlertMutation = (
  { __typename?: 'Mutation' }
  & { updateLogAlert?: Types.Maybe<(
    { __typename?: 'LogAlert' }
    & Pick<Types.LogAlert, 'id'>
  )> }
);
...
export type CreateLogAlertMutation = (
  { __typename?: 'Mutation' }
...
export type DeleteLogAlertMutation = (
  { __typename?: 'Mutation' }
...
export type UpdateLogAlertIsDisabledMutation = (
  { __typename?: 'Mutation' }
...
export type UpdateErrorAlertIsDisabledMutation = (
  { __typename?: 'Mutation' }
...
export type CreateSessionAlertMutation = (
  { __typename?: 'Mutation' }
  & { createSessionAlert?: Types.Maybe<(
    { __typename?: 'SessionAlert' }
    & Pick<Types.SessionAlert, 'id' | 'EmailsToNotify' | 'Name' | 'ExcludedEnvironments' | 'CountThreshold' | 'ThresholdWindow' | 'LastAdminToEditID' | 'disabled'>
    & { ChannelsToNotify: Array<Types.Maybe<(
      { __typename?: 'SanitizedSlackChannel' }
      & Pick<Types.SanitizedSlackChannel, 'webhook_channel' | 'webhook_channel_id'>
    )>> }
...
export type UpdateSessionAlertMutation = (
  { __typename?: 'Mutation' }
  & { updateSessionAlert?: Types.Maybe<(
    { __typename?: 'SessionAlert' }
    & Pick<Types.SessionAlert, 'id' | 'EmailsToNotify' | 'ExcludedEnvironments' | 'CountThreshold' | 'ThresholdWindow' | 'Name' | 'LastAdminToEditID' | 'disabled'>
    & { ChannelsToNotify: Array<Types.Maybe<(
      { __typename?: 'SanitizedSlackChannel' }
      & Pick<Types.SanitizedSlackChannel, 'webhook_channel' | 'webhook_channel_id'>
    )>>, DiscordChannelsToNotify: Array<(
...
export type UpdateSessionIsPublicMutation = (
  { __typename?: 'Mutation' }
  & { updateSessionIsPublic?: Types.Maybe<(
    { __typename?: 'Session' }
    & Pick<Types.Session, 'secure_id' | 'is_public'>
  )> }
);
...
export type UpdateErrorGroupIsPublicMutation = (
  { __typename?: 'Mutation' }
  & { updateErrorGroupIsPublic?: Types.Maybe<(
    { __typename?: 'ErrorGroup' }
    & Pick<Types.ErrorGroup, 'secure_id' | 'is_public'>
  )> }
);
...
export type UpdateAllowMeterOverageMutation = (
  { __typename?: 'Mutation' }
  & { updateAllowMeterOverage?: Types.Maybe<(
    { __typename?: 'Workspace' }
    & Pick<Types.Workspace, 'id' | 'allow_meter_overage'>
  )> }
);
...
export type SyncSlackIntegrationMutation = (
  { __typename?: 'Mutation' }
  & { syncSlackIntegration: (
    { __typename?: 'SlackSyncResponse' }
    & Pick<Types.SlackSyncResponse, 'success' | 'newChannelsAddedCount'>
  ) }
);
...
export type RequestAccessMutation = (
  { __typename?: 'Mutation' }
  & Pick<Types.Mutation, 'requestAccess'>
);
...
export type UpsertDashboardMutationVariables = Types.Exact<{
  ...
  project_id: Types.Scalars['ID'];
  name: Types.Scalars['String'];
  metrics: Array<Types.DashboardMetricConfigInput> | Types.DashboardMetricConfigInput;
...
export type UpsertDashboardMutation = (
  { __typename?: 'Mutation' }
  & Pick<Types.Mutation, 'upsertDashboard'>
);
...
export type DeleteDashboardMutation = (
  { __typename?: 'Mutation' }
  & Pick<Types.Mutation, 'deleteDashboard'>
);
...
export type DeleteSessionsMutation = (
  { __typename?: 'Mutation' }
  & Pick<Types.Mutation, 'deleteSessions'>
);
...
export type ExportSessionMutation = (
  { __typename?: 'Mutation' }
  & Pick<Types.Mutation, 'exportSession'>
);

export type UpdateVercelSettingsMutationVariables = Types.Exact<{
  project_id: Types.Scalars['ID'];
  project_mappings: Array<Types.VercelProjectMappingInput> | Types.VercelProjectMappingInput;
}>;


export type UpdateVercelSettingsMutation = (
  { __typename?: 'Mutation' }
  & Pick<Types.Mutation, 'updateVercelProjectMappings'>
);

export type UpdateClickUpSettingsMutationVariables = Types.Exact<{
  workspace_id: Types.Scalars['ID'];
  project_mappings: Array<Types.ClickUpProjectMappingInput> | Types.ClickUpProjectMappingInput;
}>;


export type UpdateClickUpSettingsMutation = (
  { __typename?: 'Mutation' }
  & Pick<Types.Mutation, 'updateClickUpProjectMappings'>
);

export type UpdateIntegrationProjectSettingsMutationVariables = Types.Exact<{
  workspace_id: Types.Scalars['ID'];
  integration_type: Types.IntegrationType;
  project_mappings: Array<Types.IntegrationProjectMappingInput> | Types.IntegrationProjectMappingInput;
}>;
...
export type UpdateEmailOptOutMutation = (
  { __typename?: 'Mutation' }
  & Pick<Types.Mutation, 'updateEmailOptOut'>
);
...
export type EditServiceGithubSettingsMutation = (
  { __typename?: 'Mutation' }
  & { editServiceGithubSettings?: Types.Maybe<(
    { __typename?: 'Service' }
    & Pick<Types.Service, 'id' | 'projectID' | 'name' | 'status' | 'githubRepoPath' | 'buildPrefix' | 'githubPrefix' | 'errorDetails'>
  )> }
);
...
export type CreateErrorTagMutation = (
  { __typename?: 'Mutation' }
  & { createErrorTag: (
    { __typename?: 'ErrorTag' }
    & Pick<Types.ErrorTag, 'id' | 'created_at' | 'title' | 'description'>
  ) }
);

export type UpdateErrorTagsMutationVariables = Types.Exact<{ [key: string]: never; }>;


export type UpdateErrorTagsMutation = (
  { __typename?: 'Mutation' }
  & Pick<Types.Mutation, 'updateErrorTags'>
);
...
export type UpsertSlackChannelMutation = (
  { __typename?: 'Mutation' }
  & { upsertSlackChannel: (
    { __typename?: 'SanitizedSlackChannel' }
    & Pick<Types.SanitizedSlackChannel, 'webhook_channel' | 'webhook_channel_id'>
...
export type UpsertDiscordChannelMutation = (
  { __typename?: 'Mutation' }
...
export type TestErrorEnhancementMutation = (
  { __typename?: 'Mutation' }
  & { testErrorEnhancement?: Types.Maybe<(
    { __typename?: 'ErrorObject' }
    & Pick<Types.ErrorObject, 'id' | 'type' | 'serviceName' | 'serviceVersion' | 'stack_trace'>
    & { structured_stack_trace: Array<Types.Maybe<(
      { __typename?: 'ErrorTrace' }
      & Pick<Types.ErrorTrace, 'columnNumber' | 'enhancementSource' | 'enhancementVersion' | 'error' | 'externalLink' | 'fileName' | 'functionName' | 'lineContent' | 'lineNumber' | 'linesAfter' | 'linesBefore'>
    )>> }
  )> }
);
...
export type DeleteSavedSegmentMutation = (
  { __typename?: 'Mutation' }
  & Pick<Types.Mutation, 'deleteSavedSegment'>
);
...
export type EditSavedSegmentMutation = (
  { __typename?: 'Mutation' }
  & Pick<Types.Mutation, 'editSavedSegment'>
);
...
export type CreateSavedSegmentMutation = (
  ...
  & { createSavedSegment?: Types.Maybe<(
    ...
    & Pick<Types.SavedSegment, 'name' | 'id'>
  )> }
);
...
export type SessionPayloadFragmentFragment = (
  ...
  & { errors: Array<Types.Maybe<(
    { __typename?: 'ErrorObject' }
    & Pick<Types.ErrorObject, 'id' | 'error_group_secure_id' | 'event' | 'type' | 'url' | 'source' | 'stack_trace' | 'timestamp' | 'payload' | 'request_id'>
    & { structured_stack_trace: Array<Types.Maybe<(
      { __typename?: 'ErrorTrace' }
      & Pick<Types.ErrorTrace, 'fileName' | 'lineNumber' | 'functionName' | 'columnNumber'>
    )>> }
  )>>, rage_clicks: Array<(
    { __typename?: 'RageClickEvent' }
    & Pick<Types.RageClickEvent, 'start_timestamp' | 'end_timestamp' | 'total_clicks'>
  )>, session_comments: Array<Types.Maybe<(
    { __typename?: 'SessionComment' }
    & Pick<Types.SessionComment, 'id' | 'timestamp' | 'session_id' | 'session_secure_id' | 'created_at' | 'updated_at' | 'project_id' | 'text' | 'x_coordinate' | 'y_coordinate' | 'type' | 'metadata'>
    & { author?: Types.Maybe<(
      { __typename?: 'SanitizedAdmin' }
      & Pick<Types.SanitizedAdmin, 'id' | 'name' | 'email' | 'photo_url'>
    )>, attachments: Array<Types.Maybe<(
      { __typename?: 'ExternalAttachment' }
      & Pick<Types.ExternalAttachment, 'integration_type' | 'external_id' | 'title'>
    )>> }
  )>> }
);
...
export type SessionAlertFragmentFragment = (
  { __typename?: 'SessionAlert' }
  & Pick<Types.SessionAlert, 'CountThreshold' | 'DailyFrequency' | 'disabled' | 'default' | 'EmailsToNotify' | 'ExcludedEnvironments' | 'ExcludeRules' | 'id' | 'LastAdminToEditID' | 'Name' | 'updated_at' | 'ThresholdWindow' | 'Type'>
  & { ChannelsToNotify: Array<Types.Maybe<(
    { __typename?: 'SanitizedSlackChannel' }
    & Pick<Types.SanitizedSlackChannel, 'webhook_channel' | 'webhook_channel_id'>
  )>>, DiscordChannelsToNotify: Array<(
    ...
    & Pick<Types.WebhookDestination, 'url' | 'authorization'>
  )>, TrackProperties: Array<Types.Maybe<(
    { __typename?: 'TrackProperty' }
    & Pick<Types.TrackProperty, 'id' | 'name' | 'value'>
  )>>, UserProperties: Array<Types.Maybe<(
    { __typename?: 'UserProperty' }
    & Pick<Types.UserProperty, 'id' | 'name' | 'value'>
  )>> }
);
...
export type GetMetricsTimelineQuery = (
  { __typename?: 'Query' }
  & { metrics_timeline: Array<Types.Maybe<(
    { __typename?: 'DashboardPayload' }
    & Pick<Types.DashboardPayload, 'date' | 'value' | 'aggregator' | 'group'>
  )>> }
);
...
export type GetSessionPayloadQuery = (
  ...
  & { errors?: Types.Maybe<Array<Types.Maybe<(
    ...
    { __typename?: 'SessionComment' }
    & Pick<Types.SessionComment, 'id' | 'timestamp' | 'session_id' | 'session_secure_id' | 'created_at' | 'updated_at' | 'project_id' | 'text' | 'x_coordinate' | 'y_coordinate' | 'type' | 'metadata' | 'tags'>
    & { author?: Types.Maybe<(
      { __typename?: 'SanitizedAdmin' }
      & Pick<Types.SanitizedAdmin, 'id' | 'name' | 'email' | 'photo_url'>
    )>, attachments: Array<Types.Maybe<(
...
export type GetCommentTagsForProjectQuery = (
  { __typename?: 'Query' }
  & { session_comment_tags_for_project: Array<(
    { __typename?: 'SessionCommentTag' }
    & Pick<Types.SessionCommentTag, 'id' | 'name'>
  )> }
);
...
export type GetEventChunkUrlQuery = (
  { __typename?: 'Query' }
  & Pick<Types.Query, 'event_chunk_url'>
);
...
export type GetEventChunksQuery = (
  { __typename?: 'Query' }
  & { event_chunks: Array<(
    { __typename?: 'EventChunk' }
    & Pick<Types.EventChunk, 'session_id' | 'chunk_index' | 'timestamp'>
  )> }
);
...
export type GetSessionQuery = (
  ...
  & { session?: Types.Maybe<(
    { __typename?: 'Session' }
    & Pick<Types.Session, 'secure_id' | 'os_name' | 'os_version' | 'browser_name' | 'browser_version' | 'environment' | 'app_version' | 'ip' | 'city' | 'state' | 'country' | 'postal' | 'fingerprint' | 'created_at' | 'payload_updated_at' | 'language' | 'user_object' | 'user_properties' | 'identifier' | 'identified' | 'client_id' | 'starred' | 'enable_strict_privacy' | 'privacy_setting' | 'enable_recording_network_contents' | 'field_group' | 'object_storage_enabled' | 'payload_size' | 'processed' | 'excluded' | 'excluded_reason' | 'has_rage_clicks' | 'has_errors' | 'within_billing_quota' | 'client_version' | 'firstload_version' | 'client_config' | 'is_public' | 'event_counts' | 'direct_download_url' | 'resources_url' | 'web_socket_events_url' | 'timeline_indicators_url' | 'deviceMemory' | 'last_user_interaction_time' | 'length' | 'active_length' | 'chunked'>
    & { fields?: Types.Maybe<Array<Types.Maybe<(
      { __typename?: 'Field' }
      & Pick<Types.Field, 'name' | 'value' | 'type'>
    )>>> }
  )> }
);
...
export type GetWorkspaceAdminsByProjectIdQuery = (
  { __typename?: 'Query' }
  & { admins: Array<(
    { __typename?: 'WorkspaceAdminRole' }
    & Pick<Types.WorkspaceAdminRole, 'role'>
    & { admin: (
      { __typename?: 'Admin' }
      & Pick<Types.Admin, 'id' | 'name' | 'email' | 'photo_url'>
    ) }
  )> }
);
...
export type GetWorkspaceAdminsQuery = (
  ...
  & { admins: Array<(
    ...
    { __typename?: 'Workspace' }
    & Pick<Types.Workspace, 'id' | 'name' | 'secret' | 'allowed_auto_join_email_origins'>
  )>, workspace_invite_links: (
    { __typename?: 'WorkspaceInviteLink' }
    & Pick<Types.WorkspaceInviteLink, 'id' | 'invitee_email' | 'invitee_role' | 'expiration_date' | 'secret'>
  ) }
);
...
export type GetSessionInsightQuery = (
  { __typename?: 'Query' }
  & { session_insight?: Types.Maybe<(
    { __typename?: 'SessionInsight' }
    & Pick<Types.SessionInsight, 'id' | 'insight'>
  )> }
);
...
export type GetSessionExportsQuery = (
  { __typename?: 'Query' }
  & { session_exports: Array<(
    { __typename?: 'SessionExportWithSession' }
    & Pick<Types.SessionExportWithSession, 'created_at' | 'type' | 'url' | 'error' | 'secure_id' | 'identifier' | 'active_length'>
  )> }
);
...
export type GetSessionCommentsQuery = (
  { __typename?: 'Query' }
  & { session_comments: Array<Types.Maybe<(
    { __typename?: 'SessionComment' }
    & Pick<Types.SessionComment, 'id' | 'timestamp' | 'session_id' | 'session_secure_id' | 'created_at' | 'updated_at' | 'project_id' | 'text' | 'x_coordinate' | 'y_coordinate' | 'type' | 'metadata' | 'tags'>
...
export type GetSessionCommentsForAdminQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type GetSessionCommentsForAdminQuery = (
  { __typename?: 'Query' }
  & { session_comments_for_admin: Array<Types.Maybe<(
    { __typename?: 'SessionComment' }
    & Pick<Types.SessionComment, 'id' | 'timestamp' | 'created_at' | 'project_id' | 'updated_at' | 'text'>
    & { author?: Types.Maybe<(
      { __typename?: 'SanitizedAdmin' }
      & Pick<Types.SanitizedAdmin, 'id' | 'name' | 'email' | 'photo_url'>
    )> }
...
export type IsSessionPendingQuery = (
  { __typename?: 'Query' }
  & Pick<Types.Query, 'isSessionPending'>
);
...
export type GetAccountsQuery = (
  { __typename?: 'Query' }
  & { accounts?: Types.Maybe<Array<Types.Maybe<(
    { __typename?: 'Account' }
    & Pick<Types.Account, 'id' | 'name' | 'session_count_cur' | 'view_count_cur' | 'session_count_prev' | 'view_count_prev' | 'session_count_prev_prev' | 'session_limit' | 'paid_prev' | 'paid_prev_prev' | 'email' | 'subscription_start' | 'plan_tier' | 'stripe_customer_id' | 'member_count' | 'member_limit'>
  )>>> }
);
...
export type GetAccountDetailsQuery = (
  ...
  & { account_details: (
    ...
    & Pick<Types.AccountDetails, 'id' | 'name' | 'stripe_customer_id'>
    & { session_count_per_month?: Types.Maybe<Array<Types.Maybe<(
      { __typename?: 'NamedCount' }
      & Pick<Types.NamedCount, 'name' | 'count'>
    )>>>, session_count_per_day?: Types.Maybe<Array<Types.Maybe<(
      { __typename?: 'NamedCount' }
      & Pick<Types.NamedCount, 'name' | 'count'>
    )>>>, members: Array<(
      { __typename?: 'AccountDetailsMember' }
      & Pick<Types.AccountDetailsMember, 'id' | 'name' | 'email' | 'last_active'>
    )> }
  ) }
);
...
export type GetErrorCommentsQuery = (
  { __typename?: 'Query' }
  & { error_comments: Array<Types.Maybe<(
    { __typename?: 'ErrorComment' }
    & Pick<Types.ErrorComment, 'id' | 'created_at' | 'updated_at' | 'text' | 'project_id'>
    & { author: (
      { __typename?: 'SanitizedAdmin' }
      & Pick<Types.SanitizedAdmin, 'id' | 'name' | 'email' | 'photo_url'>
    ), attachments: Array<Types.Maybe<(
...
export type GetErrorIssuesQuery = (
  { __typename?: 'Query' }
  & { error_issue: Array<Types.Maybe<(
    { __typename?: 'ExternalAttachment' }
    & Pick<Types.ExternalAttachment, 'id' | 'integration_type' | 'external_id' | 'title'>
  )>> }
);
...
export type GetEnhancedUserDetailsQuery = (
  { __typename?: 'Query' }
  & { enhanced_user_details?: Types.Maybe<(
    { __typename?: 'EnhancedUserDetailsResult' }
    & Pick<Types.EnhancedUserDetailsResult, 'id' | 'name' | 'bio' | 'avatar' | 'email'>
    & { socials?: Types.Maybe<Array<Types.Maybe<(
      { __typename?: 'SocialLink' }
      & Pick<Types.SocialLink, 'type' | 'link'>
    )>>> }
  )> }
);
...
export type GetOnboardingStepsQuery = (
  { __typename?: 'Query' }
  & Pick<Types.Query, 'isIntegrated' | 'adminHasCreatedComment'>
  & { workspace?: Types.Maybe<(
    { __typename?: 'Workspace' }
    & Pick<Types.Workspace, 'id' | 'slack_channels'>
  )>, admins: Array<(
    { __typename?: 'WorkspaceAdminRole' }
    & { admin: (
      { __typename?: 'Admin' }
    ...
    { __typename?: 'Session' }
    & Pick<Types.Session, 'secure_id'>
  )>, admin?: Types.Maybe<(
    { __typename?: 'Admin' }
    & Pick<Types.Admin, 'slack_im_channel_id'>
  )> }
);
...
export type GetSessionIntervalsQuery = (
  { __typename?: 'Query' }
  & { session_intervals: Array<(
    { __typename?: 'SessionInterval' }
    & Pick<Types.SessionInterval, 'start_time' | 'end_time' | 'active' | 'duration'>
  )> }
);
...
export type GetTimelineIndicatorEventsQuery = (
  { __typename?: 'Query' }
  & { timeline_indicator_events: Array<(
    { __typename?: 'TimelineIndicatorEvent' }
    & Pick<Types.TimelineIndicatorEvent, 'timestamp' | 'data' | 'type' | 'sid'>
  )> }
);
...
export type GetWebSocketEventsQuery = (
  { __typename?: 'Query' }
  & Pick<Types.Query, 'websocket_events'>
);
...
export type GetFieldTypesClickhouseQuery = (
  { __typename?: 'Query' }
  & { field_types: Array<(
    { __typename?: 'Field' }
    & Pick<Types.Field, 'type' | 'name'>
  )> }
);
...
export type GetFieldsClickhouseQuery = (
  { __typename?: 'Query' }
  & Pick<Types.Query, 'fields_clickhouse'>
);
...
export type GetErrorFieldsClickhouseQuery = (
  { __typename?: 'Query' }
  & Pick<Types.Query, 'error_fields_clickhouse'>
);
...
export type GetSessionsClickhouseQuery = (
  { __typename?: 'Query' }
  & { sessions_clickhouse: (
    { __typename?: 'SessionResults' }
    & Pick<Types.SessionResults, 'totalCount'>
    & { sessions: Array<(
      { __typename?: 'Session' }
      & Pick<Types.Session, 'id' | 'secure_id' | 'client_id' | 'fingerprint' | 'identifier' | 'identified' | 'os_name' | 'os_version' | 'browser_name' | 'browser_version' | 'ip' | 'city' | 'state' | 'country' | 'postal' | 'created_at' | 'language' | 'length' | 'active_length' | 'enable_recording_network_contents' | 'viewed' | 'starred' | 'processed' | 'has_rage_clicks' | 'has_errors' | 'first_time' | 'user_properties' | 'event_counts' | 'last_user_interaction_time' | 'is_public' | 'excluded'>
      & { fields?: Types.Maybe<Array<Types.Maybe<(
        { __typename?: 'Field' }
        & Pick<Types.Field, 'name' | 'value' | 'type' | 'id'>
      )>>> }
    )> }
  ) }
);
...
export type GetSessionsHistogramClickhouseQuery = (
  { __typename?: 'Query' }
  & { sessions_histogram_clickhouse: (
    { __typename?: 'SessionsHistogram' }
    & Pick<Types.SessionsHistogram, 'bucket_times' | 'sessions_without_errors' | 'sessions_with_errors' | 'total_sessions'>
  ) }
);
...
export type GetSessionsReportQuery = (
  { __typename?: 'Query' }
  & { sessions_report: Array<(
    { __typename?: 'SessionsReportRow' }
    & Pick<Types.SessionsReportRow, 'key' | 'num_sessions' | 'num_days_visited' | 'num_months_visited' | 'avg_active_length_mins' | 'max_active_length_mins' | 'total_active_length_mins' | 'avg_length_mins' | 'max_length_mins' | 'total_length_mins' | 'location'>
  )> }
);
...
export type GetErrorGroupsClickhouseQuery = (
  { __typename?: 'Query' }
  & { error_groups_clickhouse: (
    { __typename?: 'ErrorResults' }
    & Pick<Types.ErrorResults, 'totalCount'>
    & { error_groups: Array<(
      { __typename?: 'ErrorGroup' }
      & Pick<Types.ErrorGroup, 'created_at' | 'updated_at' | 'id' | 'secure_id' | 'type' | 'event' | 'state' | 'snoozed_until' | 'environments' | 'stack_trace' | 'error_frequency' | 'is_public' | 'project_id'>
      & { structured_stack_trace: Array<Types.Maybe<(
        { __typename?: 'ErrorTrace' }
        & Pick<Types.ErrorTrace, 'fileName' | 'lineNumber' | 'functionName' | 'columnNumber'>
      )>>, error_metrics: Array<(
        { __typename?: 'ErrorDistributionItem' }
        & Pick<Types.ErrorDistributionItem, 'error_group_id' | 'date' | 'name' | 'value'>
...
export type GetErrorsHistogramClickhouseQuery = (
  { __typename?: 'Query' }
  & { errors_histogram_clickhouse: (
    { __typename?: 'ErrorsHistogram' }
    & Pick<Types.ErrorsHistogram, 'bucket_times' | 'error_objects'>
  ) }
);
...
export type GetProjectsQuery = (
  ...
  & { projects?: Types.Maybe<Array<Types.Maybe<(
    { __typename?: 'Project' }
    & Pick<Types.Project, 'id' | 'name' | 'workspace_id'>
  )>>> }
);
...
export type GetWorkspaceQuery = (
  ...
  & { workspace?: Types.Maybe<(
    { __typename?: 'Workspace' }
    & Pick<Types.Workspace, 'id' | 'name' | 'secret' | 'plan_tier' | 'unlimited_members' | 'clearbit_enabled'>
    & { projects: Array<Types.Maybe<(
      { __typename?: 'Project' }
      & Pick<Types.Project, 'id' | 'name'>
    )>> }
  )> }
...
export type GetWorkspaceForInviteLinkQuery = (
  { __typename?: 'Query' }
  & { workspace_for_invite_link: (
    { __typename?: 'WorkspaceForInviteLink' }
    & Pick<Types.WorkspaceForInviteLink, 'expiration_date' | 'existing_account' | 'invitee_email' | 'secret' | 'workspace_id' | 'workspace_name'>
  ) }
);
...
export type GetWorkspacesQuery = (
  { __typename?: 'Query' }
  & { workspaces?: Types.Maybe<Array<Types.Maybe<(
    { __typename?: 'Workspace' }
    & Pick<Types.Workspace, 'id' | 'name'>
  )>>>, joinable_workspaces?: Types.Maybe<Array<Types.Maybe<(
    { __typename?: 'Workspace' }
    & Pick<Types.Workspace, 'id' | 'name'>
    & { projects: Array<Types.Maybe<(
      { __typename?: 'Project' }
...
export type GetWorkspacesCountQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type GetWorkspacesCountQuery = (
  { __typename?: 'Query' }
  & Pick<Types.Query, 'workspaces_count'>
);

export type GetProjectsAndWorkspacesQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type GetProjectsAndWorkspacesQuery = (
  { __typename?: 'Query' }
  & { projects?: Types.Maybe<Array<Types.Maybe<(
    { __typename?: 'Project' }
    & Pick<Types.Project, 'id' | 'name'>
...
export type GetProjectOrWorkspaceQuery = (
  { __typename?: 'Query' }
  & { project?: Types.Maybe<(
    { __typename?: 'Project' }
    & Pick<Types.Project, 'id' | 'name' | 'billing_email'>
  )>, workspace?: Types.Maybe<(
    { __typename?: 'Workspace' }
    & Pick<Types.Workspace, 'id' | 'name'>
  )> }
...
export type GetProjectDropdownOptionsQuery = (
  { __typename?: 'Query' }
  & { project?: Types.Maybe<(
    { __typename?: 'Project' }
    & Pick<Types.Project, 'id' | 'name' | 'verbose_id' | 'billing_email' | 'secret' | 'workspace_id' | 'error_filters'>
  )>, workspace?: Types.Maybe<(
    { __typename?: 'Workspace' }
    & Pick<Types.Workspace, 'id' | 'name'>
    & { projects: Array<Types.Maybe<(
...
export type GetWorkspaceDropdownOptionsQuery = (
  { __typename?: 'Query' }
  & { workspace?: Types.Maybe<(
    { __typename?: 'Workspace' }
    & Pick<Types.Workspace, 'id' | 'name'>
...
export type GetAdminQuery = (
  ...
  & { admin?: Types.Maybe<(
    { __typename?: 'Admin' }
    & Pick<Types.Admin, 'id' | 'uid' | 'name' | 'email' | 'phone' | 'photo_url' | 'slack_im_channel_id' | 'email_verified' | 'user_defined_role' | 'about_you_details_filled'>
  )> }
);
...
export type GetAdminRoleByProjectQuery = (
  { __typename?: 'Query' }
...
export type GetAdminAboutYouQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type GetAdminAboutYouQuery = (
  { __typename?: 'Query' }
  & { admin?: Types.Maybe<(
    { __typename?: 'Admin' }
    & Pick<Types.Admin, 'id' | 'name' | 'user_defined_role' | 'referral'>
  )> }
);
...
export type GetProjectQuery = (
  ...
  & { project?: Types.Maybe<(
    { __typename?: 'Project' }
    & Pick<Types.Project, 'id' | 'name' | 'verbose_id' | 'billing_email' | 'excluded_users' | 'error_filters' | 'error_json_paths' | 'filter_chrome_extension' | 'rage_click_window_seconds' | 'rage_click_radius_pixels' | 'rage_click_count' | 'secret'>
  )>, workspace?: Types.Maybe<(
    { __typename?: 'Workspace' }
    & Pick<Types.Workspace, 'id' | 'slack_webhook_channel'>
  )> }
);
...
export type GetBillingDetailsForProjectQuery = (
  { __typename?: 'Query' }
  & { billingDetailsForProject?: Types.Maybe<(
    { __typename?: 'BillingDetails' }
    & Pick<Types.BillingDetails, 'meter' | 'membersMeter' | 'errorsMeter' | 'logsMeter' | 'tracesMeter' | 'sessionsBillingLimit' | 'errorsBillingLimit' | 'logsBillingLimit' | 'tracesBillingLimit'>
    & { plan: (
      { __typename?: 'Plan' }
      & Pick<Types.Plan, 'type' | 'interval' | 'membersLimit' | 'sessionsLimit' | 'errorsLimit' | 'logsLimit' | 'tracesLimit' | 'sessionsRate' | 'errorsRate' | 'logsRate' | 'tracesRate'>
    ) }
  )>, workspace_for_project?: Types.Maybe<(
    { __typename?: 'Workspace' }
    & Pick<Types.Workspace, 'id' | 'trial_end_date' | 'billing_period_end' | 'next_invoice_date' | 'allow_meter_overage' | 'eligible_for_trial_extension' | 'trial_extension_enabled'>
  )> }
);
...
export type GetBillingDetailsQuery = (
  ...
  & { billingDetails: (
    { __typename?: 'BillingDetails' }
    & Pick<Types.BillingDetails, 'meter' | 'membersMeter' | 'errorsMeter' | 'logsMeter' | 'tracesMeter' | 'sessionsBillingLimit' | 'errorsBillingLimit' | 'logsBillingLimit' | 'sessionsDailyAverage' | 'errorsDailyAverage' | 'logsDailyAverage' | 'tracesDailyAverage'>
    & { plan: (
      { __typename?: 'Plan' }
      & Pick<Types.Plan, 'type' | 'interval' | 'membersLimit' | 'sessionsLimit' | 'errorsLimit' | 'logsLimit' | 'tracesLimit' | 'sessionsRate' | 'errorsRate' | 'logsRate' | 'tracesRate' | 'enableBillingLimits'>
    ) }
  ), subscription_details: (
    { __typename?: 'SubscriptionDetails' }
    & Pick<Types.SubscriptionDetails, 'baseAmount' | 'billingIssue' | 'billingIngestBlocked'>
    & { discount?: Types.Maybe<(
      { __typename?: 'SubscriptionDiscount' }
      & Pick<Types.SubscriptionDiscount, 'name' | 'amount' | 'percent' | 'until'>
    )>, lastInvoice?: Types.Maybe<(
      { __typename?: 'Invoice' }
      & Pick<Types.Invoice, 'amountDue' | 'amountPaid' | 'attemptCount' | 'date' | 'url' | 'status'>
    )> }
  ), workspace?: Types.Maybe<(
    { __typename?: 'Workspace' }
    & Pick<Types.Workspace, 'id' | 'trial_end_date' | 'billing_period_end' | 'next_invoice_date' | 'allow_meter_overage' | 'eligible_for_trial_extension' | 'retention_period' | 'errors_retention_period' | 'sessions_max_cents' | 'errors_max_cents' | 'logs_max_cents' | 'traces_max_cents'>
  )> }
);
...
export type GetErrorGroupQuery = (
  { __typename?: 'Query' }
  & { error_group?: Types.Maybe<(
    { __typename?: 'ErrorGroup' }
    & Pick<Types.ErrorGroup, 'created_at' | 'updated_at' | 'id' | 'secure_id' | 'type' | 'project_id' | 'event' | 'state' | 'snoozed_until' | 'mapped_stack_trace' | 'stack_trace' | 'error_frequency' | 'is_public' | 'last_occurrence' | 'first_occurrence' | 'serviceName'>
    & { structured_stack_trace: Array<Types.Maybe<(
      { __typename?: 'ErrorTrace' }
      & Pick<Types.ErrorTrace, 'fileName' | 'lineNumber' | 'functionName' | 'columnNumber' | 'lineContent' | 'linesBefore' | 'linesAfter' | 'error'>
    )>>, fields?: Types.Maybe<Array<Types.Maybe<(
      { __typename?: 'ErrorField' }
      & Pick<Types.ErrorField, 'name' | 'value'>
    )>>>, error_metrics: Array<(
      { __typename?: 'ErrorDistributionItem' }
      & Pick<Types.ErrorDistributionItem, 'error_group_id' | 'date' | 'name' | 'value'>
    )>, error_tag?: Types.Maybe<(
...
export type GetErrorObjectForLogQuery = (
  { __typename?: 'Query' }
  & { error_object_for_log?: Types.Maybe<(
    { __typename?: 'ErrorObject' }
    & Pick<Types.ErrorObject, 'id' | 'error_group_secure_id' | 'project_id'>
  )> }
);

export type ErrorObjectFragment = (
  { __typename?: 'ErrorObject' }
  & Pick<Types.ErrorObject, 'id' | 'created_at' | 'project_id' | 'session_id' | 'trace_id' | 'span_id' | 'log_cursor' | 'error_group_id' | 'error_group_secure_id' | 'event' | 'type' | 'url' | 'source' | 'lineNumber' | 'columnNumber' | 'stack_trace' | 'timestamp' | 'payload' | 'request_id' | 'os' | 'browser' | 'environment' | 'serviceVersion' | 'serviceName'>
  & { session?: Types.Maybe<(
    { __typename?: 'Session' }
    & Pick<Types.Session, 'identifier' | 'fingerprint' | 'secure_id' | 'city' | 'state' | 'country' | 'user_properties' | 'processed' | 'excluded' | 'excluded_reason'>
    & { session_feedback?: Types.Maybe<Array<(
      { __typename?: 'SessionComment' }
      & Pick<Types.SessionComment, 'id' | 'timestamp' | 'created_at' | 'updated_at' | 'project_id' | 'text'>
    )>> }
  )>, structured_stack_trace: Array<Types.Maybe<(
    { __typename?: 'ErrorTrace' }
    & Pick<Types.ErrorTrace, 'fileName' | 'lineNumber' | 'functionName' | 'columnNumber' | 'lineContent' | 'linesBefore' | 'linesAfter' | 'error' | 'enhancementSource' | 'enhancementVersion' | 'externalLink'>
    & { sourceMappingErrorMetadata?: Types.Maybe<(
      { __typename?: 'SourceMappingError' }
      & Pick<Types.SourceMappingError, 'errorCode' | 'stackTraceFileURL' | 'sourcemapFetchStrategy' | 'sourceMapURL' | 'minifiedFetchStrategy' | 'actualMinifiedFetchedPath' | 'minifiedLineNumber' | 'minifiedColumnNumber' | 'actualSourcemapFetchedPath' | 'sourcemapFileSize' | 'minifiedFileSize' | 'mappedLineNumber' | 'mappedColumnNumber'>
    )> }
  )>> }
);
...
export type GetErrorObjectQuery = (
  { __typename?: 'Query' }
...
export type GetErrorInstanceQuery = (
  { __typename?: 'Query' }
  & { error_instance?: Types.Maybe<(
    { __typename?: 'ErrorInstance' }
    & Pick<Types.ErrorInstance, 'next_id' | 'previous_id'>
    & { error_object: (
      { __typename?: 'ErrorObject' }
      & ErrorObjectFragment
    ) }
...
export type GetFieldSuggestionQuery = (
  { __typename?: 'Query' }
  & { field_suggestion?: Types.Maybe<Array<Types.Maybe<(
    { __typename?: 'Field' }
    & Pick<Types.Field, 'name' | 'value'>
  )>>> }
);
...
export type GetEnvironmentsQuery = (
  { __typename?: 'Query' }
  & { environment_suggestion?: Types.Maybe<Array<Types.Maybe<(
    { __typename?: 'Field' }
    & Pick<Types.Field, 'name' | 'value'>
  )>>> }
);
...
export type GetAppVersionsQuery = (
  { __typename?: 'Query' }
  & Pick<Types.Query, 'app_version_suggestion'>
);
...
export type GetProjectSuggestionQuery = (
  { __typename?: 'Query' }
  & { projectSuggestion: Array<Types.Maybe<(
    { __typename?: 'Project' }
    & Pick<Types.Project, 'id' | 'name' | 'workspace_id'>
  )>> }
);
...
export type GetErrorFieldSuggestionQuery = (
  { __typename?: 'Query' }
  & { error_field_suggestion?: Types.Maybe<Array<Types.Maybe<(
    { __typename?: 'ErrorField' }
    & Pick<Types.ErrorField, 'name' | 'value'>
  )>>> }
);
...
export type GetErrorSearchSuggestionsQuery = (
  { __typename?: 'Query' }
  & { visitedUrls?: Types.Maybe<Array<Types.Maybe<(
    { __typename?: 'ErrorField' }
    & Pick<Types.ErrorField, 'name' | 'value'>
  )>>>, fields?: Types.Maybe<Array<Types.Maybe<(
    { __typename?: 'ErrorField' }
...
export type GetSessionSearchResultsQuery = (
  { __typename?: 'Query' }
  & { trackProperties?: Types.Maybe<Array<Types.Maybe<(
    { __typename?: 'Field' }
    & Pick<Types.Field, 'id' | 'name' | 'value'>
  )>>>, userProperties?: Types.Maybe<Array<Types.Maybe<(
    { __typename?: 'Field' }
    & Pick<Types.Field, 'id' | 'name' | 'value'>
  )>>>, visitedUrls?: Types.Maybe<Array<Types.Maybe<(
    { __typename?: 'Field' }
    & Pick<Types.Field, 'id' | 'name' | 'value'>
  )>>>, referrers?: Types.Maybe<Array<Types.Maybe<(
    { __typename?: 'Field' }
    & Pick<Types.Field, 'id' | 'name' | 'value'>
  )>>> }
);
...
export type GetTrackSuggestionQuery = (
  { __typename?: 'Query' }
  & { property_suggestion?: Types.Maybe<Array<Types.Maybe<(
    { __typename?: 'Field' }
    & Pick<Types.Field, 'id' | 'name' | 'value'>
  )>>> }
);
...
export type GetUserSuggestionQuery = (
  { __typename?: 'Query' }
  & { property_suggestion?: Types.Maybe<Array<Types.Maybe<(
    { __typename?: 'Field' }
    & Pick<Types.Field, 'id' | 'name' | 'value'>
...
export type GetSegmentsQuery = (
  { __typename?: 'Query' }
  & { segments?: Types.Maybe<Array<Types.Maybe<(
    { __typename?: 'Segment' }
    & Pick<Types.Segment, 'id' | 'name'>
    & { params: (
      { __typename?: 'SearchParams' }
      & Pick<Types.SearchParams, 'query'>
    ) }
  )>>> }
);
...
export type GetErrorSegmentsQuery = (
  { __typename?: 'Query' }
  & { segments?: Types.Maybe<Array<Types.Maybe<(
    { __typename?: 'ErrorSegment' }
    & Pick<Types.ErrorSegment, 'id' | 'name'>
    & { params: (
      { __typename?: 'SearchParams' }
      & Pick<Types.SearchParams, 'query'>
    ) }
...
export type GetSavedSegmentsQuery = (
  { __typename?: 'Query' }
  & { saved_segments?: Types.Maybe<Array<Types.Maybe<(
    { __typename?: 'SavedSegment' }
    & Pick<Types.SavedSegment, 'id' | 'name'>
    & { params: (
      { __typename?: 'SearchParams' }
      & Pick<Types.SearchParams, 'query'>
    ) }
...
export type IsIntegratedQuery = (
  { __typename?: 'Query' }
  & Pick<Types.Query, 'isIntegrated'>
);
...
export type IsBackendIntegratedQuery = (
  { __typename?: 'Query' }
  & Pick<Types.Query, 'isBackendIntegrated'>
);
...
export type GetClientIntegrationQuery = (
  ...
  & { clientIntegration: (
    ...
    & Pick<Types.IntegrationStatus, 'integrated' | 'resourceType' | 'createdAt'>
  ) }
);
...
export type GetServerIntegrationQuery = (
  { __typename?: 'Query' }
  & { serverIntegration: (
    { __typename?: 'IntegrationStatus' }
    & Pick<Types.IntegrationStatus, 'integrated' | 'resourceType' | 'createdAt'>
...
export type GetLogsIntegrationQuery = (
  { __typename?: 'Query' }
  & { logsIntegration: (
    { __typename?: 'IntegrationStatus' }
    & Pick<Types.IntegrationStatus, 'integrated' | 'resourceType' | 'createdAt'>
...
export type GetTracesIntegrationQuery = (
  { __typename?: 'Query' }
  & { tracesIntegration: (
    { __typename?: 'IntegrationStatus' }
    & Pick<Types.IntegrationStatus, 'integrated' | 'resourceType' | 'createdAt'>
...
export type GetKeyPerformanceIndicatorsQuery = (
  { __typename?: 'Query' }
  & Pick<Types.Query, 'unprocessedSessionsCount' | 'liveUsersCount'>
  & { newUsersCount?: Types.Maybe<(
    { __typename?: 'NewUsersCount' }
    & Pick<Types.NewUsersCount, 'count'>
  )>, averageSessionLength?: Types.Maybe<(
    { __typename?: 'AverageSessionLength' }
    & Pick<Types.AverageSessionLength, 'length'>
  )>, userFingerprintCount?: Types.Maybe<(
    { __typename?: 'UserFingerprintCount' }
    & Pick<Types.UserFingerprintCount, 'count'>
  )> }
);
...
export type GetReferrersCountQuery = (
  { __typename?: 'Query' }
  & { referrers: Array<Types.Maybe<(
    { __typename?: 'ReferrerTablePayload' }
    & Pick<Types.ReferrerTablePayload, 'host' | 'count' | 'percent'>
  )>> }
);
...
export type GetNewUsersCountQuery = (
  { __typename?: 'Query' }
  & { newUsersCount?: Types.Maybe<(
    { __typename?: 'NewUsersCount' }
    & Pick<Types.NewUsersCount, 'count'>
...
export type GetAverageSessionLengthQuery = (
  { __typename?: 'Query' }
  & { averageSessionLength?: Types.Maybe<(
    { __typename?: 'AverageSessionLength' }
    & Pick<Types.AverageSessionLength, 'length'>
...
export type GetTopUsersQuery = (
  { __typename?: 'Query' }
  & { topUsers: Array<Types.Maybe<(
    { __typename?: 'TopUsersPayload' }
    & Pick<Types.TopUsersPayload, 'identifier' | 'total_active_time' | 'active_time_percentage' | 'id' | 'user_properties'>
  )>> }
);
...
export type GetDailySessionsCountQuery = (
  { __typename?: 'Query' }
  & { dailySessionsCount: Array<Types.Maybe<(
    { __typename?: 'DailySessionCount' }
    & Pick<Types.DailySessionCount, 'date' | 'count'>
  )>> }
);
...
export type GetDailyErrorsCountQuery = (
  { __typename?: 'Query' }
  & { dailyErrorsCount: Array<Types.Maybe<(
    { __typename?: 'DailyErrorCount' }
    & Pick<Types.DailyErrorCount, 'date' | 'count'>
  )>> }
);
...
export type GetRageClicksForProjectQuery = (
  { __typename?: 'Query' }
  & { rageClicksForProject: Array<(
    { __typename?: 'RageClickEventForProject' }
    & Pick<Types.RageClickEventForProject, 'identifier' | 'session_secure_id' | 'total_clicks' | 'user_properties'>
  )> }
);
...
export type GetDailyErrorFrequencyQuery = (
  { __typename?: 'Query' }
  & Pick<Types.Query, 'dailyErrorFrequency'>
);
...
export type GetSlackChannelSuggestionQuery = (
  { __typename?: 'Query' }
...
export type GetWorkspaceIsIntegratedWithLinearQuery = (
  ...
  & { linear_teams?: Types.Maybe<Array<(
    { __typename?: 'LinearTeam' }
    & Pick<Types.LinearTeam, 'team_id' | 'name' | 'key'>
  )>> }
);
...
export type GetWorkspaceIsIntegratedWithVercelQuery = (
  ...
  & { vercel_projects: Array<(
    ...
    & Pick<Types.VercelProject, 'id' | 'name'>
  )>, vercel_project_mappings: Array<(
    { __typename?: 'VercelProjectMapping' }
    & Pick<Types.VercelProjectMapping, 'vercel_project_id' | 'project_id'>
  )> }
);
...
export type GetJiraIntegrationSettingsQuery = (
  { __typename?: 'Query' }
  & { is_integrated: Types.Query['is_workspace_integrated_with'] }
  & { jira_projects?: Types.Maybe<Array<(
    { __typename?: 'JiraProject' }
    & Pick<Types.JiraProject, 'id' | 'name' | 'key'>
    & { issueTypes?: Types.Maybe<Array<Types.Maybe<(
      { __typename?: 'JiraIssueType' }
      & Pick<Types.JiraIssueType, 'id' | 'name' | 'description'>
    )>>> }
  )>> }
);
...
export type GetClickUpIntegrationSettingsQuery = (
  { __typename?: 'Query' }
  & { is_integrated: Types.Query['is_workspace_integrated_with'] }
  & { clickup_teams: Array<(
    { __typename?: 'ClickUpTeam' }
    & Pick<Types.ClickUpTeam, 'id' | 'name'>
    & { spaces: Array<(
      { __typename?: 'ClickUpSpace' }
      & Pick<Types.ClickUpSpace, 'id' | 'name'>
    )> }
  )>, project_mappings: Array<(
    { __typename?: 'ClickUpProjectMapping' }
    & Pick<Types.ClickUpProjectMapping, 'project_id' | 'clickup_space_id'>
  )> }
);
...
export type GetHeightIntegrationSettingsQuery = (
  { __typename?: 'Query' }
  & { is_integrated: Types.Query['is_workspace_integrated_with'] }
  & { height_workspaces: Array<(
    { __typename?: 'HeightWorkspace' }
    & Pick<Types.HeightWorkspace, 'id' | 'model' | 'name' | 'url'>
  )>, integration_project_mappings: Array<(
    { __typename?: 'IntegrationProjectMapping' }
    & Pick<Types.IntegrationProjectMapping, 'project_id' | 'external_id'>
  )> }
);
...
export type GetGitHubIntegrationSettingsQuery = (
  { __typename?: 'Query' }
  & { is_integrated: Types.Query['is_workspace_integrated_with'] }
  & { github_repos?: Types.Maybe<Array<(
    { __typename?: 'GitHubRepo' }
    & Pick<Types.GitHubRepo, 'repo_id' | 'name' | 'key'>
  )>> }
);
...
export type GetGitlabIntegrationSettingsQuery = (
  { __typename?: 'Query' }
  & { is_integrated: Types.Query['is_workspace_integrated_with'] }
  & { gitlab_projects?: Types.Maybe<Array<(
    { __typename?: 'GitlabProject' }
    & Pick<Types.GitlabProject, 'name' | 'id' | 'nameWithNameSpace'>
  )>> }
);
...
export type GetGitHubIssueLabelsQuery = (
  { __typename?: 'Query' }
  & Pick<Types.Query, 'github_issue_labels'>
);
...
export type GetProjectIntegratedWithQuery = (
  { __typename?: 'Query' }
  & Pick<Types.Query, 'is_project_integrated_with'>
);
...
export type GetClickUpFoldersQuery = (
  { __typename?: 'Query' }
  & { clickup_folders: Array<(
    { __typename?: 'ClickUpFolder' }
    & Pick<Types.ClickUpFolder, 'id' | 'name'>
    & { lists: Array<(
      { __typename?: 'ClickUpList' }
      & Pick<Types.ClickUpList, 'id' | 'name'>
    )> }
...
export type GetHeightListsQuery = (
  { __typename?: 'Query' }
  & { height_lists: Array<(
    { __typename?: 'HeightList' }
    & Pick<Types.HeightList, 'id' | 'name'>
  )> }
);
...
export type GetIdentifierSuggestionsQuery = (
  { __typename?: 'Query' }
  & Pick<Types.Query, 'identifier_suggestion'>
);
...
export type GetLogAlertQuery = (
  { __typename?: 'Query' }
  & { log_alert: (
    { __typename?: 'LogAlert' }
    & Pick<Types.LogAlert, 'CountThreshold' | 'DailyFrequency' | 'disabled' | 'EmailsToNotify' | 'ExcludedEnvironments' | 'id' | 'LastAdminToEditID' | 'Name' | 'updated_at' | 'BelowThreshold' | 'ThresholdWindow' | 'Type' | 'query'>
...
export type GetLogAlertsPagePayloadQuery = (
  { __typename?: 'Query' }
  & { is_integrated_with_slack: Types.Query['is_integrated_with'], is_integrated_with_discord: Types.Query['is_integrated_with'] }
  & { slack_channel_suggestion: Array<(
    { __typename?: 'SanitizedSlackChannel' }
    & Pick<Types.SanitizedSlackChannel, 'webhook_channel' | 'webhook_channel_id'>
...
export type GetAlertsPagePayloadQuery = (
  { __typename?: 'Query' }
  & { is_integrated_with_slack: Types.Query['is_integrated_with'], is_integrated_with_discord: Types.Query['is_integrated_with'] }
  & { slack_channel_suggestion: Array<(
    { __typename?: 'SanitizedSlackChannel' }
    ...
    { __typename?: 'Field' }
    & Pick<Types.Field, 'name' | 'value'>
  )>>>, error_alerts: Array<Types.Maybe<(
    { __typename?: 'ErrorAlert' }
    & Pick<Types.ErrorAlert, 'EmailsToNotify' | 'ExcludedEnvironments' | 'updated_at' | 'CountThreshold' | 'LastAdminToEditID' | 'ThresholdWindow' | 'RegexGroups' | 'Frequency' | 'id' | 'Type' | 'Name' | 'DailyFrequency' | 'disabled' | 'default'>
    & { ChannelsToNotify: Array<Types.Maybe<(
      { __typename?: 'SanitizedSlackChannel' }
      & Pick<Types.SanitizedSlackChannel, 'webhook_channel' | 'webhook_channel_id'>
    )>>, DiscordChannelsToNotify: Array<(
  ...
  )>>, new_session_alerts: Array<Types.Maybe<(
    { __typename?: 'SessionAlert' }
    & SessionAlertFragmentFragment
  )>>, rage_click_alerts: Array<Types.Maybe<(
    { __typename?: 'SessionAlert' }
    & SessionAlertFragmentFragment
  )>>, new_user_alerts?: Types.Maybe<Array<Types.Maybe<(
    { __typename?: 'SessionAlert' }
    & SessionAlertFragmentFragment
  )>>>, track_properties_alerts: Array<Types.Maybe<(
    { __typename?: 'SessionAlert' }
    & SessionAlertFragmentFragment
  )>>, user_properties_alerts: Array<Types.Maybe<(
    { __typename?: 'SessionAlert' }
    & SessionAlertFragmentFragment
  )>>, metric_monitors: Array<Types.Maybe<(
    { __typename?: 'MetricMonitor' }
    & Pick<Types.MetricMonitor, 'id' | 'updated_at' | 'name' | 'emails_to_notify' | 'aggregator' | 'period_minutes' | 'metric_to_monitor' | 'last_admin_to_edit_id' | 'threshold' | 'units' | 'disabled'>
    & { channels_to_notify: Array<Types.Maybe<(
      { __typename?: 'SanitizedSlackChannel' }
      & Pick<Types.SanitizedSlackChannel, 'webhook_channel' | 'webhook_channel_id'>
      ...
      { __typename?: 'WebhookDestination' }
      & Pick<Types.WebhookDestination, 'url' | 'authorization'>
    )>, filters?: Types.Maybe<Array<(
      { __typename?: 'MetricTagFilter' }
      & Pick<Types.MetricTagFilter, 'tag' | 'op' | 'value'>
    )>> }
  )>>, log_alerts: Array<Types.Maybe<(
    { __typename?: 'LogAlert' }
    & Pick<Types.LogAlert, 'CountThreshold' | 'DailyFrequency' | 'disabled' | 'default' | 'EmailsToNotify' | 'ExcludedEnvironments' | 'id' | 'LastAdminToEditID' | 'Name' | 'updated_at' | 'ThresholdWindow' | 'Type' | 'query'>
    & { ChannelsToNotify: Array<(
      { __typename?: 'SanitizedSlackChannel' }
      & Pick<Types.SanitizedSlackChannel, 'webhook_channel' | 'webhook_channel_id'>
    )>, DiscordChannelsToNotify: Array<(
...
export type GetMetricMonitorsQuery = (
  { __typename?: 'Query' }
  & { metric_monitors: Array<Types.Maybe<(
    { __typename?: 'MetricMonitor' }
    & Pick<Types.MetricMonitor, 'id' | 'updated_at' | 'name' | 'metric_to_monitor'>
  )>> }
);
...
export type GetCommentMentionSuggestionsQuery = (
  { __typename?: 'Query' }
  & { admins: Array<(
    { __typename?: 'WorkspaceAdminRole' }
    & { admin: (
...
export type GetCustomerPortalUrlQuery = (
  { __typename?: 'Query' }
  & Pick<Types.Query, 'customer_portal_url'>
);
...
export type OnSessionPayloadAppendedSubscription = (
  ...
  & { session_payload_appended?: Types.Maybe<(
    { __typename?: 'SessionPayload' }
    & SessionPayloadFragmentFragment
  )> }
);
...
export type GetWebVitalsQuery = (
  { __typename?: 'Query' }
  & { web_vitals: Array<(
    { __typename?: 'Metric' }
    & Pick<Types.Metric, 'name' | 'value'>
  )> }
);
...
export type GetDashboardDefinitionsQuery = (
  { __typename?: 'Query' }
  & { dashboard_definitions: Array<Types.Maybe<(
    { __typename?: 'DashboardDefinition' }
    & Pick<Types.DashboardDefinition, 'id' | 'updated_at' | 'project_id' | 'name' | 'is_default' | 'last_admin_to_edit_id' | 'layout'>
    & { metrics: Array<(
      { __typename?: 'DashboardMetricConfig' }
      & Pick<Types.DashboardMetricConfig, 'component_type' | 'name' | 'description' | 'max_good_value' | 'max_needs_improvement_value' | 'poor_value' | 'units' | 'help_article' | 'chart_type' | 'aggregator' | 'min_value' | 'min_percentile' | 'max_value' | 'max_percentile' | 'groups'>
      & { filters?: Types.Maybe<Array<(
        { __typename?: 'MetricTagFilter' }
        & Pick<Types.MetricTagFilter, 'value' | 'op' | 'tag'>
      )>> }
    )> }
  )>> }
);
...
export type GetSuggestedMetricsQuery = (
  { __typename?: 'Query' }
  & Pick<Types.Query, 'suggested_metrics'>
);
...
export type GetMetricTagsQuery = (
  { __typename?: 'Query' }
  & Pick<Types.Query, 'metric_tags'>
);
...
export type GetMetricTagValuesQuery = (
  { __typename?: 'Query' }
  & Pick<Types.Query, 'metric_tag_values'>
);
...
export type GetSourcemapFilesQuery = (
  { __typename?: 'Query' }
  & { sourcemap_files: Array<(
    { __typename?: 'S3File' }
    & Pick<Types.S3File, 'key'>
  )> }
);
...
export type GetSourcemapVersionsQuery = (
  { __typename?: 'Query' }
  & Pick<Types.Query, 'sourcemap_versions'>
);
...
export type GetOAuthClientMetadataQuery = (
  { __typename?: 'Query' }
  & { oauth_client_metadata?: Types.Maybe<(
    { __typename?: 'OAuthClient' }
    & Pick<Types.OAuthClient, 'id' | 'created_at' | 'app_name'>
  )> }
);

export type GetErrorGroupFrequenciesQueryVariables = Types.Exact<{
  project_id: Types.Scalars['ID'];
  error_group_secure_ids: Array<Types.Scalars['String']> | Types.Scalars['String'];
...
export type GetErrorGroupFrequenciesQuery = (
  { __typename?: 'Query' }
  & { errorGroupFrequencies: Array<Types.Maybe<(
    { __typename?: 'ErrorDistributionItem' }
    & Pick<Types.ErrorDistributionItem, 'error_group_id' | 'date' | 'name' | 'value'>
  )>> }
);
...
export type GetErrorGroupTagsQuery = (
  { __typename?: 'Query' }
  & { errorGroupTags: Array<(
    { __typename?: 'ErrorGroupTagAggregation' }
    & Pick<Types.ErrorGroupTagAggregation, 'key'>
    & { buckets: Array<(
      { __typename?: 'ErrorGroupTagAggregationBucket' }
      & Pick<Types.ErrorGroupTagAggregationBucket, 'key' | 'doc_count' | 'percent'>
    )> }
  )> }
);
...
export type GetEmailOptOutsQuery = (
  { __typename?: 'Query' }
  & Pick<Types.Query, 'email_opt_outs'>
);
...
export type GetLogsQuery = (
  ...
  & { logs: (
    ...
    & { edges: Array<(
      { __typename?: 'LogEdge' }
      & Pick<Types.LogEdge, 'cursor'>
      & { node: (
        { __typename?: 'Log' }
        & Pick<Types.Log, 'timestamp' | 'level' | 'message' | 'logAttributes' | 'traceID' | 'spanID' | 'secureSessionID' | 'source' | 'serviceName' | 'serviceVersion' | 'environment' | 'projectID'>
      ) }
    )>, pageInfo: (
      { __typename?: 'PageInfo' }
...
export type GetSessionLogsQuery = (
  ...
  & { sessionLogs: Array<(
    ...
    & { node: (
      { __typename?: 'Log' }
      & Pick<Types.Log, 'timestamp' | 'level' | 'message'>
    ) }
  )> }
);
...
export type GetLogsTotalCountQuery = (
  { __typename?: 'Query' }
  & Pick<Types.Query, 'logs_total_count'>
);
...
export type GetLogsHistogramQuery = (
  { __typename?: 'Query' }
  & { logs_histogram: (
    { __typename?: 'LogsHistogram' }
    & Pick<Types.LogsHistogram, 'totalCount' | 'objectCount' | 'sampleFactor'>
    & { buckets: Array<(
      { __typename?: 'LogsHistogramBucket' }
      & Pick<Types.LogsHistogramBucket, 'bucketId'>
      & { counts: Array<(
        { __typename?: 'LogsHistogramBucketCount' }
        & Pick<Types.LogsHistogramBucketCount, 'count' | 'level'>
      )> }
    )> }
  ) }
);
...
export type GetLogsKeysQuery = (
  { __typename?: 'Query' }
  & { keys: Array<(
    { __typename?: 'QueryKey' }
    & Pick<Types.QueryKey, 'name' | 'type'>
  )> }
);
...
export type GetLogsKeyValuesQuery = (
  { __typename?: 'Query' }
...
export type GetLogsErrorObjectsQuery = (
  { __typename?: 'Query' }
  & { logs_error_objects: Array<(
    { __typename?: 'ErrorObject' }
    & Pick<Types.ErrorObject, 'log_cursor' | 'error_group_secure_id' | 'id'>
  )> }
);
...
export type GetProjectSettingsQuery = (
  ...
  & { projectSettings?: Types.Maybe<(
    { __typename?: 'AllProjectSettings' }
    & Pick<Types.AllProjectSettings, 'id' | 'name' | 'verbose_id' | 'billing_email' | 'excluded_users' | 'error_filters' | 'error_json_paths' | 'filter_chrome_extension' | 'rage_click_window_seconds' | 'rage_click_radius_pixels' | 'rage_click_count' | 'filterSessionsWithoutError' | 'autoResolveStaleErrorsDayInterval'>
    & { sampling: (
      { __typename?: 'Sampling' }
      & Pick<Types.Sampling, 'session_sampling_rate' | 'error_sampling_rate' | 'log_sampling_rate' | 'trace_sampling_rate' | 'session_exclusion_query' | 'error_exclusion_query' | 'log_exclusion_query' | 'trace_exclusion_query' | 'session_minute_rate_limit' | 'error_minute_rate_limit' | 'log_minute_rate_limit' | 'trace_minute_rate_limit'>
    ) }
  )> }
);
...
export type GetWorkspacePendingInvitesQuery = (
  { __typename?: 'Query' }
  & { workspacePendingInvites: Array<Types.Maybe<(
    { __typename?: 'WorkspaceInviteLink' }
    & Pick<Types.WorkspaceInviteLink, 'id' | 'invitee_email' | 'invitee_role' | 'created_at'>
  )>> }
);
...
export type GetErrorResolutionSuggestionQuery = (
  { __typename?: 'Query' }
  & Pick<Types.Query, 'error_resolution_suggestion'>
);
...
export type GetWorkspaceSettingsQuery = (
  ...
  & { workspaceSettings?: Types.Maybe<(
    { __typename?: 'AllWorkspaceSettings' }
    & Pick<Types.AllWorkspaceSettings, 'workspace_id' | 'ai_application' | 'ai_insights' | 'enable_session_export' | 'enable_unlisted_sharing' | 'enable_ingest_sampling' | 'enable_data_deletion' | 'enable_grafana_dashboard'>
  )> }
);

export type GetSystemConfigurationQueryVariables = Types.Exact<{ [key: string]: never; }>;
...
export type GetSystemConfigurationQuery = (
  ...
  & { system_configuration: (
    ...
    & Pick<Types.SystemConfiguration, 'maintenance_start' | 'maintenance_end'>
  ) }
);
...
export type GetErrorObjectsQuery = (
  { __typename?: 'Query' }
  & { error_objects: (
    { __typename?: 'ErrorObjectConnection' }
    & { edges: Array<(
      { __typename?: 'ErrorObjectEdge' }
      & Pick<Types.ErrorObjectEdge, 'cursor'>
      & { node: (
        { __typename?: 'ErrorObjectNode' }
        & Pick<Types.ErrorObjectNode, 'id' | 'createdAt' | 'event' | 'timestamp' | 'errorGroupSecureID' | 'serviceVersion' | 'serviceName'>
        & { session?: Types.Maybe<(
          { __typename?: 'ErrorObjectNodeSession' }
          & Pick<Types.ErrorObjectNodeSession, 'secureID' | 'email' | 'fingerprint' | 'excluded'>
        )> }
      ) }
    )>, pageInfo: (
      { __typename?: 'PageInfo' }
...
export type GetServicesQuery = (
  ...
  & { services?: Types.Maybe<(
    ...
    & { edges: Array<Types.Maybe<(
      ...
      & Pick<Types.ServiceEdge, 'cursor'>
      & { node: (
        { __typename?: 'ServiceNode' }
        & Pick<Types.ServiceNode, 'id' | 'projectID' | 'name' | 'status' | 'githubRepoPath' | 'buildPrefix' | 'githubPrefix' | 'errorDetails'>
      ) }
    )>>, pageInfo: (
      { __typename?: 'PageInfo' }
      & Pick<Types.PageInfo, 'hasNextPage' | 'hasPreviousPage' | 'startCursor' | 'endCursor'>
...
export type GetErrorTagsQuery = (
  { __typename?: 'Query' }
  & { error_tags?: Types.Maybe<Array<Types.Maybe<(
    { __typename?: 'ErrorTag' }
    & ErrorTagFragment
  )>>> }
);
...
export type MatchErrorTagQuery = (
  { __typename?: 'Query' }
  & { match_error_tag?: Types.Maybe<Array<Types.Maybe<(
    { __typename?: 'MatchedErrorTag' }
    & Pick<Types.MatchedErrorTag, 'id' | 'title' | 'description' | 'score'>
  )>>> }
);
...
export type FindSimilarErrorsQuery = (
  { __typename?: 'Query' }
  & { find_similar_errors?: Types.Maybe<Array<Types.Maybe<(
    { __typename?: 'MatchedErrorObject' }
    & Pick<Types.MatchedErrorObject, 'id' | 'type' | 'event' | 'stack_trace' | 'score'>
  )>>> }
);
...
export type GetTraceQuery = (
  ...
  & { trace?: Types.Maybe<(
    ...
    & { trace: Array<(
      { __typename?: 'Trace' }
      & Pick<Types.Trace, 'timestamp' | 'traceID' | 'spanID' | 'parentSpanID' | 'projectID' | 'secureSessionID' | 'traceState' | 'spanName' | 'spanKind' | 'duration' | 'serviceName' | 'serviceVersion' | 'environment' | 'traceAttributes' | 'startTime' | 'statusCode' | 'statusMessage'>
    )>, errors: Array<(
      { __typename?: 'TraceError' }
      & Pick<Types.TraceError, 'created_at' | 'trace_id' | 'span_id' | 'log_cursor' | 'event' | 'type' | 'source' | 'timestamp' | 'error_group_secure_id'>
    )> }
  )> }
);
...
export type GetTracesQuery = (
  { __typename?: 'Query' }
  & { traces: (
    { __typename?: 'TraceConnection' }
    & { edges: Array<(
      { __typename?: 'TraceEdge' }
      & Pick<Types.TraceEdge, 'cursor'>
      & { node: (
        { __typename?: 'Trace' }
        & Pick<Types.Trace, 'timestamp' | 'traceID' | 'spanID' | 'parentSpanID' | 'projectID' | 'secureSessionID' | 'traceState' | 'spanName' | 'spanKind' | 'duration' | 'serviceName' | 'serviceVersion' | 'environment' | 'traceAttributes' | 'statusCode' | 'statusMessage'>
      ) }
    )>, pageInfo: (
      { __typename?: 'PageInfo' }
      & Pick<Types.PageInfo, 'hasNextPage' | 'hasPreviousPage' | 'startCursor' | 'endCursor'>
...
export type GetTracesMetricsQuery = (
  { __typename?: 'Query' }
  & { traces_metrics: (
    { __typename?: 'MetricsBuckets' }
    & Pick<Types.MetricsBuckets, 'bucket_count' | 'sample_factor'>
    & { buckets: Array<(
      { __typename?: 'MetricBucket' }
      & Pick<Types.MetricBucket, 'bucket_id' | 'group' | 'metric_type' | 'metric_value'>
    )> }
  ) }
);
...
export type GetTracesKeysQuery = (
  { __typename?: 'Query' }
  & { keys: Array<(
    { __typename?: 'QueryKey' }
    & Pick<Types.QueryKey, 'name' | 'type'>
...
export type GetTracesKeyValuesQuery = (
  { __typename?: 'Query' }
...
export const namedOperations = {
  Query: {
    ...
    GetSessionsHistogramClickhouse: 'GetSessionsHistogramClickhouse' as const,
    ...
    GetWorkspaceIsIntegratedWithFront: 'GetWorkspaceIsIntegratedWithFront' as const,
    GetWorkspaceIsIntegratedWithDiscord: 'GetWorkspaceIsIntegratedWithDiscord' as const,
    GetWorkspaceIsIntegratedWithVercel: 'GetWorkspaceIsIntegratedWithVercel' as const,
  ...
  Mutation: {
    ...
    RemoveIntegrationFromWorkspace: 'RemoveIntegrationFromWorkspace' as const,
    ...
    UpdateIntegrationProjectSettings: 'UpdateIntegrationProjectSettings' as const,
