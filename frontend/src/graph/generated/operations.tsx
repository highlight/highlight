...
export type GetRecentErrorsQuery = (
  { __typename?: 'Query' }
  & { error_group?: Types.Maybe<(
    { __typename?: 'ErrorGroup' }
    & Pick<Types.ErrorGroup, 'secure_id'>
    & { metadata_log: Array<Types.Maybe<(
      { __typename?: 'ErrorMetadata' }
      & Pick<Types.ErrorMetadata, 'error_id' | 'session_secure_id' | 'environment' | 'timestamp' | 'os' | 'browser' | 'visited_url' | 'fingerprint' | 'identifier' | 'user_properties' | 'request_id' | 'payload'>
    )>> }
  )> }
);
...
export type GetProjectSuggestionQuery = (
  ...
  & { projectSuggestion: Array<Types.Maybe<(
    { __typename?: 'Project' }
    & Pick<Types.Project, 'id' | 'name' | 'workspace_id'>
  )>>, workspaceSuggestion: Array<Types.Maybe<(
    { __typename?: 'Workspace' }
    & Pick<Types.Workspace, 'id' | 'name'>
  )>> }
);
...
export type GetErrorDistributionQuery = (
  { __typename?: 'Query' }
  & { errorDistribution: Array<Types.Maybe<(
    { __typename?: 'ErrorDistributionItem' }
    & Pick<Types.ErrorDistributionItem, 'name' | 'value'>
  )>> }
);
