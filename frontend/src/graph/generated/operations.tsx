...
export type EditProjectMutation = (
  ...
  & { editProject?: Types.Maybe<(
    { __typename?: 'Project' }
    & Pick<Types.Project, 'id' | 'name' | 'billing_email' | 'excluded_users' | 'error_json_paths' | 'rage_click_window_seconds' | 'rage_click_radius_pixels' | 'rage_click_count' | 'backend_domains'>
  )> }
);
...
export type CreateDefaultAlertsMutationVariables = Types.Exact<{
  ...
  slack_channels: Array<Types.SanitizedSlackChannelInput> | Types.SanitizedSlackChannelInput;
  emails: Array<Types.Scalars['String']> | Types.Scalars['String'];
}>;


export type CreateDefaultAlertsMutation = (
  { __typename?: 'Mutation' }
  & Pick<Types.Mutation, 'createDefaultAlerts'>
);
...
export type GetNotificationsQuery = (
  { __typename?: 'Query' }
  & { session_comments_for_project: Array<Types.Maybe<(
    { __typename?: 'SessionComment' }
    & Pick<Types.SessionComment, 'id' | 'timestamp' | 'updated_at' | 'session_id' | 'session_secure_id' | 'text' | 'type' | 'metadata' | 'tags'>
    & { author?: Types.Maybe<(
      { __typename?: 'SanitizedAdmin' }
      & Pick<Types.SanitizedAdmin, 'id' | 'name' | 'email' | 'photo_url'>
    )> }
  )>>, error_comments_for_project: Array<Types.Maybe<(
    { __typename?: 'ErrorComment' }
    & Pick<Types.ErrorComment, 'id' | 'updated_at' | 'project_id' | 'text' | 'error_id' | 'error_secure_id'>
    & { author: (
      { __typename?: 'SanitizedAdmin' }
      & Pick<Types.SanitizedAdmin, 'id' | 'name' | 'email' | 'photo_url'>
    ) }
...
export type GetSessionsOpenSearchQuery = (
  ...
  & { sessions_opensearch: (
    ...
    & { sessions: Array<(
      { __typename?: 'Session' }
      & Pick<Types.Session, 'id' | 'secure_id' | 'client_id' | 'fingerprint' | 'identifier' | 'identified' | 'os_name' | 'os_version' | 'browser_name' | 'browser_version' | 'city' | 'state' | 'country' | 'postal' | 'created_at' | 'language' | 'length' | 'active_length' | 'enable_recording_network_contents' | 'viewed' | 'starred' | 'processed' | 'has_rage_clicks' | 'has_errors' | 'first_time' | 'user_properties' | 'event_counts' | 'last_user_interaction_time'>
      & { fields?: Types.Maybe<Array<Types.Maybe<(
        { __typename?: 'Field' }
...
export type GetProjectDropdownOptionsQuery = (
  ...
  & { project?: Types.Maybe<(
    { __typename?: 'Project' }
    & Pick<Types.Project, 'id' | 'name' | 'verbose_id' | 'billing_email' | 'secret' | 'workspace_id'>
  )>, workspace?: Types.Maybe<(
    { __typename?: 'Workspace' }
    & Pick<Types.Workspace, 'id' | 'name'>
    & { projects: Array<Types.Maybe<(
...
export type GetProjectQuery = (
  ...
  & { project?: Types.Maybe<(
    { __typename?: 'Project' }
    & Pick<Types.Project, 'id' | 'name' | 'verbose_id' | 'billing_email' | 'excluded_users' | 'error_json_paths' | 'rage_click_window_seconds' | 'rage_click_radius_pixels' | 'rage_click_count' | 'backend_domains' | 'secret'>
  )>, workspace?: Types.Maybe<(
    { __typename?: 'Workspace' }
...
export type GetBillingDetailsForProjectQuery = (
  ...
  & { billingDetailsForProject?: Types.Maybe<(
    ...
    & Pick<Types.BillingDetails, 'meter' | 'membersMeter' | 'sessionsOutOfQuota'>
    & { plan: (
      { __typename?: 'Plan' }
      & Pick<Types.Plan, 'type' | 'quota' | 'interval' | 'membersLimit'>
    ) }
...
export type GetBillingDetailsQuery = (
  ...
  & { billingDetails: (
    { __typename?: 'BillingDetails' }
    & Pick<Types.BillingDetails, 'meter' | 'membersMeter' | 'errorsMeter'>
    & { plan: (
      { __typename?: 'Plan' }
      & Pick<Types.Plan, 'type' | 'quota' | 'interval' | 'membersLimit' | 'errorsLimit'>
    ) }
  ), workspace?: Types.Maybe<(
    { __typename?: 'Workspace' }
    & Pick<Types.Workspace, 'id' | 'trial_end_date' | 'billing_period_end' | 'next_invoice_date' | 'allow_meter_overage' | 'eligible_for_trial_extension' | 'retention_period'>
  )> }
);
...
export type GetErrorObjectQuery = (
  ...
  & { error_object?: Types.Maybe<(
    { __typename?: 'ErrorObject' }
    & Pick<Types.ErrorObject, 'id' | 'created_at' | 'project_id' | 'error_group_id' | 'error_group_secure_id' | 'event' | 'type' | 'url' | 'source' | 'lineNumber' | 'columnNumber' | 'stack_trace' | 'timestamp' | 'payload' | 'request_id' | 'os' | 'browser' | 'environment'>
    & { session?: Types.Maybe<(
      { __typename?: 'Session' }
      & Pick<Types.Session, 'identifier' | 'fingerprint' | 'secure_id' | 'city' | 'state' | 'country' | 'user_properties'>
    )>, structured_stack_trace: Array<Types.Maybe<(
      { __typename?: 'ErrorTrace' }
      & Pick<Types.ErrorTrace, 'fileName' | 'lineNumber' | 'functionName' | 'columnNumber' | 'lineContent' | 'linesBefore' | 'linesAfter' | 'error'>
    )>> }
...
export type GetErrorInstanceQuery = (
  ...
  & { error_instance?: Types.Maybe<(
    ...
    & { error_object: (
      { __typename?: 'ErrorObject' }
      & Pick<Types.ErrorObject, 'id' | 'created_at' | 'project_id' | 'session_id' | 'error_group_id' | 'error_group_secure_id' | 'event' | 'type' | 'url' | 'source' | 'lineNumber' | 'columnNumber' | 'stack_trace' | 'timestamp' | 'payload' | 'request_id' | 'os' | 'browser' | 'environment'>
      & { session?: Types.Maybe<(
        { __typename?: 'Session' }
        & Pick<Types.Session, 'identifier' | 'fingerprint' | 'secure_id' | 'city' | 'state' | 'country' | 'user_properties'>
      )>, structured_stack_trace: Array<Types.Maybe<(
...
export type GetErrorSegmentsQuery = (
  { __typename?: 'Query' }
  & { error_segments?: Types.Maybe<Array<Types.Maybe<(
    { __typename?: 'ErrorSegment' }
...
export type GetAlertsPagePayloadQuery = (
  ...
  )>>, session_feedback_alerts: Array<Types.Maybe<(
    { __typename?: 'SessionAlert' }
...
export type GetLogsQuery = (
  ...
  & { logs: (
    ...
    & { edges: Array<(
      ...
      & { node: (
        { __typename?: 'Log' }
        & Pick<Types.Log, 'timestamp' | 'severityText' | 'body' | 'logAttributes'>
      ) }
    )>, pageInfo: (
      { __typename?: 'PageInfo' }
