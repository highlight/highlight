...
export type MarkSessionAsStarredMutation = (
  { __typename?: 'Mutation' }
  & { markSessionAsStarred?: Types.Maybe<(
    { __typename?: 'Session' }
    & Pick<Types.Session, 'secure_id' | 'starred'>
  )> }
);
...
export type EditWorkspaceSettingsMutation = (
  ...
  & { editWorkspaceSettings?: Types.Maybe<(
    ...
    & Pick<Types.AllWorkspaceSettings, 'workspace_id' | 'ai_insights'>
  )> }
);
...
export type SessionAlertFragmentFragment = (
  { __typename?: 'SessionAlert' }
  & Pick<Types.SessionAlert, 'CountThreshold' | 'DailyFrequency' | 'disabled' | 'EmailsToNotify' | 'ExcludedEnvironments' | 'ExcludeRules' | 'id' | 'LastAdminToEditID' | 'Name' | 'updated_at' | 'ThresholdWindow' | 'Type'>
  & { ChannelsToNotify: Array<Types.Maybe<(
    { __typename?: 'SanitizedSlackChannel' }
    & Pick<Types.SanitizedSlackChannel, 'webhook_channel' | 'webhook_channel_id'>
  )>>, DiscordChannelsToNotify: Array<(
...
export type GetErrorGroupQuery = (
  ...
  & { error_group?: Types.Maybe<(
    { __typename?: 'ErrorGroup' }
    & Pick<Types.ErrorGroup, 'created_at' | 'updated_at' | 'id' | 'secure_id' | 'type' | 'project_id' | 'event' | 'state' | 'snoozed_until' | 'mapped_stack_trace' | 'stack_trace' | 'error_frequency' | 'is_public' | 'last_occurrence' | 'first_occurrence'>
    & { structured_stack_trace: Array<Types.Maybe<(
      { __typename?: 'ErrorTrace' }
...
export type ErrorObjectFragment = (
  { __typename?: 'ErrorObject' }
  & Pick<Types.ErrorObject, 'id' | 'created_at' | 'project_id' | 'session_id' | 'trace_id' | 'span_id' | 'log_cursor' | 'error_group_id' | 'error_group_secure_id' | 'event' | 'type' | 'url' | 'source' | 'lineNumber' | 'columnNumber' | 'stack_trace' | 'timestamp' | 'payload' | 'request_id' | 'os' | 'browser' | 'environment'>
  & { session?: Types.Maybe<(
    { __typename?: 'Session' }
...
export type GetAlertsPagePayloadQuery = (
  ...
  & { slack_channel_suggestion: Array<(
    ...
    { __typename?: 'ErrorAlert' }
    & Pick<Types.ErrorAlert, 'EmailsToNotify' | 'ExcludedEnvironments' | 'updated_at' | 'CountThreshold' | 'LastAdminToEditID' | 'ThresholdWindow' | 'RegexGroups' | 'Frequency' | 'id' | 'Type' | 'Name' | 'DailyFrequency' | 'disabled'>
    & { ChannelsToNotify: Array<Types.Maybe<(
      { __typename?: 'SanitizedSlackChannel' }
      & Pick<Types.SanitizedSlackChannel, 'webhook_channel' | 'webhook_channel_id'>
    )>>, DiscordChannelsToNotify: Array<(
    ...
    { __typename?: 'LogAlert' }
    & Pick<Types.LogAlert, 'CountThreshold' | 'DailyFrequency' | 'disabled' | 'EmailsToNotify' | 'ExcludedEnvironments' | 'id' | 'LastAdminToEditID' | 'Name' | 'updated_at' | 'ThresholdWindow' | 'Type' | 'query'>
    & { ChannelsToNotify: Array<(
      { __typename?: 'SanitizedSlackChannel' }
      & Pick<Types.SanitizedSlackChannel, 'webhook_channel' | 'webhook_channel_id'>
    )>, DiscordChannelsToNotify: Array<(
...
export type GetLogsQuery = (
  ...
  & { logs: (
    ...
    & { edges: Array<(
      ...
      & { node: (
        { __typename?: 'Log' }
        & Pick<Types.Log, 'timestamp' | 'level' | 'message' | 'logAttributes' | 'traceID' | 'spanID' | 'secureSessionID' | 'source' | 'serviceName'>
      ) }
    )>, pageInfo: (
      { __typename?: 'PageInfo' }
