...
export type EditProjectMutation = (
  ...
  & { editProject?: Types.Maybe<(
    { __typename?: 'Project' }
    & Pick<Types.Project, 'id' | 'name' | 'billing_email' | 'excluded_users' | 'error_filters' | 'error_json_paths' | 'filter_chrome_extension' | 'rage_click_window_seconds' | 'rage_click_radius_pixels' | 'rage_click_count' | 'backend_domains'>
  )> }
);
...
export type EditProjectSettingsMutation = (
  ...
  & { editProjectSettings?: Types.Maybe<(
    ...
    & Pick<Types.AllProjectSettings, 'id' | 'name' | 'billing_email' | 'excluded_users' | 'error_filters' | 'error_json_paths' | 'filter_chrome_extension' | 'rage_click_window_seconds' | 'rage_click_radius_pixels' | 'rage_click_count' | 'backend_domains' | 'filterSessionsWithoutError' | 'autoResolveStaleErrorsDayInterval'>
  )> }
);
...
export type CreateSegmentMutation = (
  ...
  & { createSegment?: Types.Maybe<(
    ...
    & { params: (
      ...
      & Pick<Types.SearchParams, 'os' | 'browser' | 'visited_url' | 'referrer' | 'identified' | 'hide_viewed' | 'app_versions' | 'environments' | 'device_id' | 'show_live_sessions'>
      & { user_properties?: Types.Maybe<Array<Types.Maybe<(
        { __typename?: 'UserProperty' }
        & Pick<Types.UserProperty, 'name' | 'value'>
      )>>>, excluded_properties?: Types.Maybe<Array<Types.Maybe<(
        { __typename?: 'UserProperty' }
        & Pick<Types.UserProperty, 'name' | 'value'>
      )>>>, date_range?: Types.Maybe<(
        { __typename?: 'DateRange' }
        & Pick<Types.DateRange, 'start_date' | 'end_date'>
      )> }
    ) }
  )> }
);
...
export type CreateErrorSegmentMutation = (
  ...
  & { createErrorSegment?: Types.Maybe<(
    ...
    & { params: (
      ...
      & Pick<Types.ErrorSearchParams, 'os' | 'browser' | 'visited_url' | 'state'>
      & { date_range?: Types.Maybe<(
        { __typename?: 'DateRange' }
        & Pick<Types.DateRange, 'start_date' | 'end_date'>
      )> }
...
export type GetMetricsHistogramQuery = (
  { __typename?: 'Query' }
  & { metrics_histogram?: Types.Maybe<(
    { __typename?: 'HistogramPayload' }
    & Pick<Types.HistogramPayload, 'min' | 'max'>
    & { buckets: Array<(
      { __typename?: 'HistogramBucket' }
      & Pick<Types.HistogramBucket, 'bucket' | 'range_start' | 'range_end' | 'count'>
    )> }
  )> }
);
...
export type GetFieldTypesQuery = (
  { __typename?: 'Query' }
  & { field_types: Array<(
    { __typename?: 'Field' }
...
export type GetProjectQuery = (
  ...
  & { project?: Types.Maybe<(
    { __typename?: 'Project' }
    & Pick<Types.Project, 'id' | 'name' | 'verbose_id' | 'billing_email' | 'excluded_users' | 'error_filters' | 'error_json_paths' | 'filter_chrome_extension' | 'rage_click_window_seconds' | 'rage_click_radius_pixels' | 'rage_click_count' | 'backend_domains' | 'secret'>
  )>, workspace?: Types.Maybe<(
    { __typename?: 'Workspace' }
...
export type GetBillingDetailsForProjectQuery = (
  ...
  & { billingDetailsForProject?: Types.Maybe<(
    ...
    & Pick<Types.BillingDetails, 'meter' | 'membersMeter' | 'errorsMeter' | 'logsMeter' | 'sessionsBillingLimit' | 'errorsBillingLimit' | 'logsBillingLimit'>
    & { plan: (
      { __typename?: 'Plan' }
      & Pick<Types.Plan, 'type' | 'quota' | 'interval' | 'membersLimit' | 'errorsLimit' | 'logsLimit'>
    ) }
...
export type GetBillingDetailsQuery = (
  ...
  & { billingDetails: (
    { __typename?: 'BillingDetails' }
    & Pick<Types.BillingDetails, 'meter' | 'membersMeter' | 'errorsMeter' | 'logsMeter' | 'sessionsBillingLimit' | 'errorsBillingLimit' | 'logsBillingLimit' | 'sessionsDailyAverage' | 'errorsDailyAverage' | 'logsDailyAverage'>
    & { plan: (
      { __typename?: 'Plan' }
      & Pick<Types.Plan, 'type' | 'quota' | 'interval' | 'membersLimit' | 'errorsLimit' | 'logsLimit'>
    ) }
    ...
    & Pick<Types.SubscriptionDetails, 'baseAmount' | 'discountAmount' | 'discountPercent'>
    ...
    { __typename?: 'Workspace' }
    & Pick<Types.Workspace, 'id' | 'trial_end_date' | 'billing_period_end' | 'next_invoice_date' | 'allow_meter_overage' | 'eligible_for_trial_extension' | 'retention_period' | 'errors_retention_period' | 'sessions_max_cents' | 'errors_max_cents' | 'logs_max_cents'>
  )> }
);
...
export type GetSegmentsQuery = (
  ...
  & { segments?: Types.Maybe<Array<Types.Maybe<(
    ...
    & { params: (
      { __typename?: 'SearchParams' }
      & Pick<Types.SearchParams, 'os' | 'browser' | 'visited_url' | 'referrer' | 'identified' | 'hide_viewed' | 'first_time' | 'app_versions' | 'environments' | 'device_id' | 'show_live_sessions' | 'query'>
      & { user_properties?: Types.Maybe<Array<Types.Maybe<(
        { __typename?: 'UserProperty' }
        & Pick<Types.UserProperty, 'name' | 'value'>
      )>>>, excluded_properties?: Types.Maybe<Array<Types.Maybe<(
        { __typename?: 'UserProperty' }
        & Pick<Types.UserProperty, 'name' | 'value'>
      )>>>, track_properties?: Types.Maybe<Array<Types.Maybe<(
        { __typename?: 'UserProperty' }
        & Pick<Types.UserProperty, 'name' | 'value'>
      )>>>, date_range?: Types.Maybe<(
        { __typename?: 'DateRange' }
        ...
        & Pick<Types.LengthRange, 'min' | 'max'>
      )> }
    ) }
  )>>> }
);
...
export type GetErrorSegmentsQuery = (
  ...
  & { segments?: Types.Maybe<Array<Types.Maybe<(
    ...
    & { params: (
      { __typename?: 'ErrorSearchParams' }
      & Pick<Types.ErrorSearchParams, 'os' | 'browser' | 'visited_url' | 'state' | 'event' | 'query'>
      & { date_range?: Types.Maybe<(
        { __typename?: 'DateRange' }
        & Pick<Types.DateRange, 'start_date' | 'end_date'>
      )> }
...
export type GetLogsQuery = (
  ...
  & { logs: (
    ...
    & { edges: Array<(
      ...
      & { node: (
        { __typename?: 'Log' }
        & Pick<Types.Log, 'timestamp' | 'level' | 'message' | 'logAttributes' | 'traceID' | 'spanID' | 'secureSessionID' | 'source' | 'serviceName' | 'serviceVersion'>
      ) }
    )>, pageInfo: (
      { __typename?: 'PageInfo' }
...
export type GetProjectSettingsQuery = (
  ...
  & { projectSettings?: Types.Maybe<(
    { __typename?: 'AllProjectSettings' }
    & Pick<Types.AllProjectSettings, 'id' | 'name' | 'verbose_id' | 'billing_email' | 'excluded_users' | 'error_filters' | 'error_json_paths' | 'filter_chrome_extension' | 'rage_click_window_seconds' | 'rage_click_radius_pixels' | 'rage_click_count' | 'backend_domains' | 'filterSessionsWithoutError' | 'autoResolveStaleErrorsDayInterval'>
  )> }
);
...
export type GetWorkspaceSettingsQuery = (
  ...
  & { workspaceSettings?: Types.Maybe<(
    { __typename?: 'AllWorkspaceSettings' }
    & Pick<Types.AllWorkspaceSettings, 'workspace_id' | 'ai_application' | 'ai_insights' | 'enable_session_export'>
  )> }
);
  ...
  & { error_objects: (
    ...
    & { edges: Array<(
      ...
      & { node: (
        ...
        & Pick<Types.ErrorObjectNode, 'id' | 'createdAt' | 'event' | 'timestamp' | 'errorGroupSecureID' | 'serviceVersion'>
        & { session?: Types.Maybe<(
...
export type GetTracesQuery = (
  ...
  & { traces: (
    ...
    & { edges: Array<(
      ...
      & { node: (
        { __typename?: 'Trace' }
        & Pick<Types.Trace, 'timestamp' | 'traceID' | 'spanID' | 'parentSpanID' | 'projectID' | 'secureSessionID' | 'traceState' | 'spanName' | 'spanKind' | 'duration' | 'serviceName' | 'serviceVersion' | 'traceAttributes' | 'statusCode' | 'statusMessage'>
      ) }
    )>, pageInfo: (
      { __typename?: 'PageInfo' }
      & Pick<Types.PageInfo, 'hasNextPage' | 'hasPreviousPage' | 'startCursor' | 'endCursor'>
