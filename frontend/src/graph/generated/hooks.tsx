...
export const SaveBillingPlanDocument = gql`
    mutation SaveBillingPlan($workspace_id: ID!, $sessionsLimitCents: Int, $sessionsRetention: RetentionPeriod!, $errorsLimitCents: Int, $errorsRetention: RetentionPeriod!, $logsLimitCents: Int, $logsRetention: RetentionPeriod!, $tracesLimitCents: Int, $tracesRetention: RetentionPeriod!) {
  saveBillingPlan(
...
export const EditProjectDocument = gql`
    mutation EditProject($id: ID!, $name: String, $billing_email: String, $excluded_users: StringArray, $error_filters: StringArray, $error_json_paths: StringArray, $filter_chrome_extension: Boolean, $rage_click_window_seconds: Int, $rage_click_radius_pixels: Int, $rage_click_count: Int) {
  editProject(
    id: $id
    name: $name
...
export const EditWorkspaceSettingsDocument = gql`
    mutation EditWorkspaceSettings($workspace_id: ID!, $ai_application: Boolean, $ai_insights: Boolean) {
  editWorkspaceSettings(
    ...
    `;
export type EditWorkspaceSettingsMutationFn = Apollo.MutationFunction<Types.EditWorkspaceSettingsMutation, Types.EditWorkspaceSettingsMutationVariables>;
 ...
 * });
 */
export function useEditWorkspaceSettingsMutation(baseOptions?: Apollo.MutationHookOptions<Types.EditWorkspaceSettingsMutation, Types.EditWorkspaceSettingsMutationVariables>) {
        return Apollo.useMutation<Types.EditWorkspaceSettingsMutation, Types.EditWorkspaceSettingsMutationVariables>(EditWorkspaceSettingsDocument, baseOptions);
      }
export type EditWorkspaceSettingsMutationHookResult = ReturnType<typeof useEditWorkspaceSettingsMutation>;
export type EditWorkspaceSettingsMutationResult = Apollo.MutationResult<Types.EditWorkspaceSettingsMutation>;
export type EditWorkspaceSettingsMutationOptions = Apollo.BaseMutationOptions<Types.EditWorkspaceSettingsMutation, Types.EditWorkspaceSettingsMutationVariables>;
...
export const EditSegmentDocument = gql`
    mutation EditSegment($project_id: ID!, $id: ID!, $query: String!, $name: String!) {
  editSegment(project_id: $project_id, id: $id, query: $query, name: $name)
}
    `;
...
export const CreateIssueForSessionCommentDocument = gql`
    mutation CreateIssueForSessionComment($project_id: ID!, $session_comment_id: Int!, $text_for_attachment: String!, $session_url: String!, $time: Float!, $author_name: String!, $integrations: [IntegrationType]!, $issue_title: String, $issue_team_id: String, $issue_description: String, $issue_type_id: String) {
...
export const CreateIssueForErrorCommentDocument = gql`
    mutation CreateIssueForErrorComment($project_id: ID!, $error_comment_id: Int!, $text_for_attachment: String!, $error_url: String!, $author_name: String!, $integrations: [IntegrationType]!, $issue_title: String, $issue_team_id: String, $issue_description: String, $issue_type_id: String) {
...
export const EditErrorSegmentDocument = gql`
    mutation EditErrorSegment($project_id: ID!, $id: ID!, $query: String!, $name: String!) {
  editErrorSegment(project_id: $project_id, id: $id, query: $query, name: $name)
}
    `;
...
export const CreateErrorSegmentDocument = gql`
    mutation CreateErrorSegment($project_id: ID!, $name: String!, $query: String!) {
  createErrorSegment(project_id: $project_id, name: $name, query: $query) {
    name
    id
  }
}
...
export const CreateErrorAlertDocument = gql`
    mutation CreateErrorAlert($project_id: ID!, $name: String!, $count_threshold: Int!, $threshold_window: Int!, $slack_channels: [SanitizedSlackChannelInput]!, $discord_channels: [DiscordChannelInput!]!, $webhook_destinations: [WebhookDestinationInput!]!, $emails: [String]!, $environments: [String]!, $regex_groups: [String]!, $frequency: Int!, $default: Boolean) {
  createErrorAlert(
    project_id: $project_id
...
export const DeleteSessionsDocument = gql`
    mutation DeleteSessions($project_id: ID!, $query: ClickhouseQuery!, $sessionCount: Int!) {
  deleteSessions(
    project_id: $project_id
    query: $query
...
export const ExportSessionDocument = gql`
  ...
  exportSession(session_secure_id: $session_secure_id)
    ...
    `;
export type ExportSessionMutationFn = Apollo.MutationFunction<Types.ExportSessionMutation, Types.ExportSessionMutationVariables>;
 ...
 * });
 */
export function useExportSessionMutation(baseOptions?: Apollo.MutationHookOptions<Types.ExportSessionMutation, Types.ExportSessionMutationVariables>) {
        return Apollo.useMutation<Types.ExportSessionMutation, Types.ExportSessionMutationVariables>(ExportSessionDocument, baseOptions);
      }
export type ExportSessionMutationHookResult = ReturnType<typeof useExportSessionMutation>;
export type ExportSessionMutationResult = Apollo.MutationResult<Types.ExportSessionMutation>;
export type ExportSessionMutationOptions = Apollo.BaseMutationOptions<Types.ExportSessionMutation, Types.ExportSessionMutationVariables>;
...
export const EditServiceGithubSettingsDocument = gql`
    mutation EditServiceGithubSettings($id: ID!, $project_id: ID!, $github_repo_path: String, $build_prefix: String, $github_prefix: String) {
  editServiceGithubSettings(
    ...
    `;
export type EditServiceGithubSettingsMutationFn = Apollo.MutationFunction<Types.EditServiceGithubSettingsMutation, Types.EditServiceGithubSettingsMutationVariables>;
 ...
 * });
 */
export function useEditServiceGithubSettingsMutation(baseOptions?: Apollo.MutationHookOptions<Types.EditServiceGithubSettingsMutation, Types.EditServiceGithubSettingsMutationVariables>) {
        return Apollo.useMutation<Types.EditServiceGithubSettingsMutation, Types.EditServiceGithubSettingsMutationVariables>(EditServiceGithubSettingsDocument, baseOptions);
      }
export type EditServiceGithubSettingsMutationHookResult = ReturnType<typeof useEditServiceGithubSettingsMutation>;
export type EditServiceGithubSettingsMutationResult = Apollo.MutationResult<Types.EditServiceGithubSettingsMutation>;
export type EditServiceGithubSettingsMutationOptions = Apollo.BaseMutationOptions<Types.EditServiceGithubSettingsMutation, Types.EditServiceGithubSettingsMutationVariables>;
export const CreateErrorTagDocument = gql`
  ...
  createErrorTag(title: $title, description: $description) {
    ...
    `;
export type CreateErrorTagMutationFn = Apollo.MutationFunction<Types.CreateErrorTagMutation, Types.CreateErrorTagMutationVariables>;
 ...
 * });
 */
export function useCreateErrorTagMutation(baseOptions?: Apollo.MutationHookOptions<Types.CreateErrorTagMutation, Types.CreateErrorTagMutationVariables>) {
        return Apollo.useMutation<Types.CreateErrorTagMutation, Types.CreateErrorTagMutationVariables>(CreateErrorTagDocument, baseOptions);
      }
export type CreateErrorTagMutationHookResult = ReturnType<typeof useCreateErrorTagMutation>;
export type CreateErrorTagMutationResult = Apollo.MutationResult<Types.CreateErrorTagMutation>;
export type CreateErrorTagMutationOptions = Apollo.BaseMutationOptions<Types.CreateErrorTagMutation, Types.CreateErrorTagMutationVariables>;
export const UpdateErrorTagsDocument = gql`
    mutation UpdateErrorTags {
  updateErrorTags
}
    `;
export type UpdateErrorTagsMutationFn = Apollo.MutationFunction<Types.UpdateErrorTagsMutation, Types.UpdateErrorTagsMutationVariables>;
 ...
 * });
 */
export function useUpdateErrorTagsMutation(baseOptions?: Apollo.MutationHookOptions<Types.UpdateErrorTagsMutation, Types.UpdateErrorTagsMutationVariables>) {
        return Apollo.useMutation<Types.UpdateErrorTagsMutation, Types.UpdateErrorTagsMutationVariables>(UpdateErrorTagsDocument, baseOptions);
      }
export type UpdateErrorTagsMutationHookResult = ReturnType<typeof useUpdateErrorTagsMutation>;
export type UpdateErrorTagsMutationResult = Apollo.MutationResult<Types.UpdateErrorTagsMutation>;
export type UpdateErrorTagsMutationOptions = Apollo.BaseMutationOptions<Types.UpdateErrorTagsMutation, Types.UpdateErrorTagsMutationVariables>;
export const UpsertSlackChannelDocument = gql`
  ...
  upsertSlackChannel(project_id: $project_id, name: $name) {
    ...
    `;
export type UpsertSlackChannelMutationFn = Apollo.MutationFunction<Types.UpsertSlackChannelMutation, Types.UpsertSlackChannelMutationVariables>;
 ...
 * });
 */
export function useUpsertSlackChannelMutation(baseOptions?: Apollo.MutationHookOptions<Types.UpsertSlackChannelMutation, Types.UpsertSlackChannelMutationVariables>) {
        return Apollo.useMutation<Types.UpsertSlackChannelMutation, Types.UpsertSlackChannelMutationVariables>(UpsertSlackChannelDocument, baseOptions);
      }
export type UpsertSlackChannelMutationHookResult = ReturnType<typeof useUpsertSlackChannelMutation>;
export type UpsertSlackChannelMutationResult = Apollo.MutationResult<Types.UpsertSlackChannelMutation>;
export type UpsertSlackChannelMutationOptions = Apollo.BaseMutationOptions<Types.UpsertSlackChannelMutation, Types.UpsertSlackChannelMutationVariables>;
export const UpsertDiscordChannelDocument = gql`
  ...
  upsertDiscordChannel(project_id: $project_id, name: $name) {
    ...
    `;
export type UpsertDiscordChannelMutationFn = Apollo.MutationFunction<Types.UpsertDiscordChannelMutation, Types.UpsertDiscordChannelMutationVariables>;
 ...
 * });
 */
export function useUpsertDiscordChannelMutation(baseOptions?: Apollo.MutationHookOptions<Types.UpsertDiscordChannelMutation, Types.UpsertDiscordChannelMutationVariables>) {
        return Apollo.useMutation<Types.UpsertDiscordChannelMutation, Types.UpsertDiscordChannelMutationVariables>(UpsertDiscordChannelDocument, baseOptions);
      }
export type UpsertDiscordChannelMutationHookResult = ReturnType<typeof useUpsertDiscordChannelMutation>;
export type UpsertDiscordChannelMutationResult = Apollo.MutationResult<Types.UpsertDiscordChannelMutation>;
export type UpsertDiscordChannelMutationOptions = Apollo.BaseMutationOptions<Types.UpsertDiscordChannelMutation, Types.UpsertDiscordChannelMutationVariables>;
export const TestErrorEnhancementDocument = gql`
    mutation testErrorEnhancement($error_object_id: ID!, $github_repo_path: String!, $github_prefix: String, $build_prefix: String, $save_error: Boolean) {
  testErrorEnhancement(
    ...
    `;
export type TestErrorEnhancementMutationFn = Apollo.MutationFunction<Types.TestErrorEnhancementMutation, Types.TestErrorEnhancementMutationVariables>;
 ...
 * });
 */
export function useTestErrorEnhancementMutation(baseOptions?: Apollo.MutationHookOptions<Types.TestErrorEnhancementMutation, Types.TestErrorEnhancementMutationVariables>) {
        return Apollo.useMutation<Types.TestErrorEnhancementMutation, Types.TestErrorEnhancementMutationVariables>(TestErrorEnhancementDocument, baseOptions);
      }
export type TestErrorEnhancementMutationHookResult = ReturnType<typeof useTestErrorEnhancementMutation>;
export type TestErrorEnhancementMutationResult = Apollo.MutationResult<Types.TestErrorEnhancementMutation>;
export type TestErrorEnhancementMutationOptions = Apollo.BaseMutationOptions<Types.TestErrorEnhancementMutation, Types.TestErrorEnhancementMutationVariables>;
export const DeleteSavedSegmentDocument = gql`
  ...
  deleteSavedSegment(segment_id: $segment_id)
    ...
    `;
export type DeleteSavedSegmentMutationFn = Apollo.MutationFunction<Types.DeleteSavedSegmentMutation, Types.DeleteSavedSegmentMutationVariables>;
 ...
 * });
 */
export function useDeleteSavedSegmentMutation(baseOptions?: Apollo.MutationHookOptions<Types.DeleteSavedSegmentMutation, Types.DeleteSavedSegmentMutationVariables>) {
        return Apollo.useMutation<Types.DeleteSavedSegmentMutation, Types.DeleteSavedSegmentMutationVariables>(DeleteSavedSegmentDocument, baseOptions);
      }
export type DeleteSavedSegmentMutationHookResult = ReturnType<typeof useDeleteSavedSegmentMutation>;
export type DeleteSavedSegmentMutationResult = Apollo.MutationResult<Types.DeleteSavedSegmentMutation>;
export type DeleteSavedSegmentMutationOptions = Apollo.BaseMutationOptions<Types.DeleteSavedSegmentMutation, Types.DeleteSavedSegmentMutationVariables>;
export const EditSavedSegmentDocument = gql`
    mutation EditSavedSegment($project_id: ID!, $id: ID!, $query: String!, $name: String!, $entity_type: SavedSegmentEntityType!) {
  editSavedSegment(
    project_id: $project_id
    id: $id
    query: $query
    ...
    `;
export type EditSavedSegmentMutationFn = Apollo.MutationFunction<Types.EditSavedSegmentMutation, Types.EditSavedSegmentMutationVariables>;
 ...
 * });
 */
export function useEditSavedSegmentMutation(baseOptions?: Apollo.MutationHookOptions<Types.EditSavedSegmentMutation, Types.EditSavedSegmentMutationVariables>) {
        return Apollo.useMutation<Types.EditSavedSegmentMutation, Types.EditSavedSegmentMutationVariables>(EditSavedSegmentDocument, baseOptions);
      }
export type EditSavedSegmentMutationHookResult = ReturnType<typeof useEditSavedSegmentMutation>;
export type EditSavedSegmentMutationResult = Apollo.MutationResult<Types.EditSavedSegmentMutation>;
export type EditSavedSegmentMutationOptions = Apollo.BaseMutationOptions<Types.EditSavedSegmentMutation, Types.EditSavedSegmentMutationVariables>;
export const CreateSavedSegmentDocument = gql`
    mutation CreateSavedSegment($project_id: ID!, $name: String!, $query: String!, $entity_type: SavedSegmentEntityType!) {
  createSavedSegment(
    project_id: $project_id
    entity_type: $entity_type
    name: $name
    ...
    `;
export type CreateSavedSegmentMutationFn = Apollo.MutationFunction<Types.CreateSavedSegmentMutation, Types.CreateSavedSegmentMutationVariables>;
 ...
 * });
 */
export function useCreateSavedSegmentMutation(baseOptions?: Apollo.MutationHookOptions<Types.CreateSavedSegmentMutation, Types.CreateSavedSegmentMutationVariables>) {
        return Apollo.useMutation<Types.CreateSavedSegmentMutation, Types.CreateSavedSegmentMutationVariables>(CreateSavedSegmentDocument, baseOptions);
      }
export type CreateSavedSegmentMutationHookResult = ReturnType<typeof useCreateSavedSegmentMutation>;
export type CreateSavedSegmentMutationResult = Apollo.MutationResult<Types.CreateSavedSegmentMutation>;
export type CreateSavedSegmentMutationOptions = Apollo.BaseMutationOptions<Types.CreateSavedSegmentMutation, Types.CreateSavedSegmentMutationVariables>;
 ...
 * });
 */
export function useGetSessionExportsQuery(baseOptions: Apollo.QueryHookOptions<Types.GetSessionExportsQuery, Types.GetSessionExportsQueryVariables>) {
        return Apollo.useQuery<Types.GetSessionExportsQuery, Types.GetSessionExportsQueryVariables>(GetSessionExportsDocument, baseOptions);
      }
export function useGetSessionExportsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Types.GetSessionExportsQuery, Types.GetSessionExportsQueryVariables>) {
          return Apollo.useLazyQuery<Types.GetSessionExportsQuery, Types.GetSessionExportsQueryVariables>(GetSessionExportsDocument, baseOptions);
        }
export type GetSessionExportsQueryHookResult = ReturnType<typeof useGetSessionExportsQuery>;
export type GetSessionExportsLazyQueryHookResult = ReturnType<typeof useGetSessionExportsLazyQuery>;
export type GetSessionExportsQueryResult = Apollo.QueryResult<Types.GetSessionExportsQuery, Types.GetSessionExportsQueryVariables>;
 ...
 * });
 */
export function useGetWebSocketEventsQuery(baseOptions: Apollo.QueryHookOptions<Types.GetWebSocketEventsQuery, Types.GetWebSocketEventsQueryVariables>) {
        return Apollo.useQuery<Types.GetWebSocketEventsQuery, Types.GetWebSocketEventsQueryVariables>(GetWebSocketEventsDocument, baseOptions);
      }
export function useGetWebSocketEventsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Types.GetWebSocketEventsQuery, Types.GetWebSocketEventsQueryVariables>) {
          return Apollo.useLazyQuery<Types.GetWebSocketEventsQuery, Types.GetWebSocketEventsQueryVariables>(GetWebSocketEventsDocument, baseOptions);
        }
export type GetWebSocketEventsQueryHookResult = ReturnType<typeof useGetWebSocketEventsQuery>;
export type GetWebSocketEventsLazyQueryHookResult = ReturnType<typeof useGetWebSocketEventsLazyQuery>;
export type GetWebSocketEventsQueryResult = Apollo.QueryResult<Types.GetWebSocketEventsQuery, Types.GetWebSocketEventsQueryVariables>;
export const GetFieldTypesClickhouseDocument = gql`
    query GetFieldTypesClickhouse($project_id: ID!, $start_date: Timestamp!, $end_date: Timestamp!) {
 ...
 * });
 */
export function useGetFieldTypesClickhouseQuery(baseOptions: Apollo.QueryHookOptions<Types.GetFieldTypesClickhouseQuery, Types.GetFieldTypesClickhouseQueryVariables>) {
        return Apollo.useQuery<Types.GetFieldTypesClickhouseQuery, Types.GetFieldTypesClickhouseQueryVariables>(GetFieldTypesClickhouseDocument, baseOptions);
      }
export function useGetFieldTypesClickhouseLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Types.GetFieldTypesClickhouseQuery, Types.GetFieldTypesClickhouseQueryVariables>) {
          return Apollo.useLazyQuery<Types.GetFieldTypesClickhouseQuery, Types.GetFieldTypesClickhouseQueryVariables>(GetFieldTypesClickhouseDocument, baseOptions);
        }
export type GetFieldTypesClickhouseQueryHookResult = ReturnType<typeof useGetFieldTypesClickhouseQuery>;
export type GetFieldTypesClickhouseLazyQueryHookResult = ReturnType<typeof useGetFieldTypesClickhouseLazyQuery>;
export type GetFieldTypesClickhouseQueryResult = Apollo.QueryResult<Types.GetFieldTypesClickhouseQuery, Types.GetFieldTypesClickhouseQueryVariables>;
export const GetFieldsClickhouseDocument = gql`
    query GetFieldsClickhouse($project_id: ID!, $count: Int!, $field_type: String!, $field_name: String!, $query: String!, $start_date: Timestamp!, $end_date: Timestamp!) {
  fields_clickhouse(
    project_id: $project_id
    count: $count
 ...
 * });
 */
export function useGetFieldsClickhouseQuery(baseOptions: Apollo.QueryHookOptions<Types.GetFieldsClickhouseQuery, Types.GetFieldsClickhouseQueryVariables>) {
        return Apollo.useQuery<Types.GetFieldsClickhouseQuery, Types.GetFieldsClickhouseQueryVariables>(GetFieldsClickhouseDocument, baseOptions);
      }
export function useGetFieldsClickhouseLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Types.GetFieldsClickhouseQuery, Types.GetFieldsClickhouseQueryVariables>) {
          return Apollo.useLazyQuery<Types.GetFieldsClickhouseQuery, Types.GetFieldsClickhouseQueryVariables>(GetFieldsClickhouseDocument, baseOptions);
        }
export type GetFieldsClickhouseQueryHookResult = ReturnType<typeof useGetFieldsClickhouseQuery>;
export type GetFieldsClickhouseLazyQueryHookResult = ReturnType<typeof useGetFieldsClickhouseLazyQuery>;
export type GetFieldsClickhouseQueryResult = Apollo.QueryResult<Types.GetFieldsClickhouseQuery, Types.GetFieldsClickhouseQueryVariables>;
export const GetErrorFieldsClickhouseDocument = gql`
    query GetErrorFieldsClickhouse($project_id: ID!, $count: Int!, $field_type: String!, $field_name: String!, $query: String!, $start_date: Timestamp!, $end_date: Timestamp!) {
 ...
 * });
 */
export function useGetErrorFieldsClickhouseQuery(baseOptions: Apollo.QueryHookOptions<Types.GetErrorFieldsClickhouseQuery, Types.GetErrorFieldsClickhouseQueryVariables>) {
        return Apollo.useQuery<Types.GetErrorFieldsClickhouseQuery, Types.GetErrorFieldsClickhouseQueryVariables>(GetErrorFieldsClickhouseDocument, baseOptions);
      }
export function useGetErrorFieldsClickhouseLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Types.GetErrorFieldsClickhouseQuery, Types.GetErrorFieldsClickhouseQueryVariables>) {
          return Apollo.useLazyQuery<Types.GetErrorFieldsClickhouseQuery, Types.GetErrorFieldsClickhouseQueryVariables>(GetErrorFieldsClickhouseDocument, baseOptions);
        }
export type GetErrorFieldsClickhouseQueryHookResult = ReturnType<typeof useGetErrorFieldsClickhouseQuery>;
export type GetErrorFieldsClickhouseLazyQueryHookResult = ReturnType<typeof useGetErrorFieldsClickhouseLazyQuery>;
export type GetErrorFieldsClickhouseQueryResult = Apollo.QueryResult<Types.GetErrorFieldsClickhouseQuery, Types.GetErrorFieldsClickhouseQueryVariables>;
 ...
 * });
 */
export function useGetSessionsClickhouseQuery(baseOptions: Apollo.QueryHookOptions<Types.GetSessionsClickhouseQuery, Types.GetSessionsClickhouseQueryVariables>) {
        return Apollo.useQuery<Types.GetSessionsClickhouseQuery, Types.GetSessionsClickhouseQueryVariables>(GetSessionsClickhouseDocument, baseOptions);
      }
export function useGetSessionsClickhouseLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Types.GetSessionsClickhouseQuery, Types.GetSessionsClickhouseQueryVariables>) {
          return Apollo.useLazyQuery<Types.GetSessionsClickhouseQuery, Types.GetSessionsClickhouseQueryVariables>(GetSessionsClickhouseDocument, baseOptions);
        }
export type GetSessionsClickhouseQueryHookResult = ReturnType<typeof useGetSessionsClickhouseQuery>;
export type GetSessionsClickhouseLazyQueryHookResult = ReturnType<typeof useGetSessionsClickhouseLazyQuery>;
export type GetSessionsClickhouseQueryResult = Apollo.QueryResult<Types.GetSessionsClickhouseQuery, Types.GetSessionsClickhouseQueryVariables>;
export const GetSessionsHistogramClickhouseDocument = gql`
    query GetSessionsHistogramClickhouse($project_id: ID!, $query: ClickhouseQuery!, $histogram_options: DateHistogramOptions!) {
 ...
 * });
 */
export function useGetSessionsHistogramClickhouseQuery(baseOptions: Apollo.QueryHookOptions<Types.GetSessionsHistogramClickhouseQuery, Types.GetSessionsHistogramClickhouseQueryVariables>) {
        return Apollo.useQuery<Types.GetSessionsHistogramClickhouseQuery, Types.GetSessionsHistogramClickhouseQueryVariables>(GetSessionsHistogramClickhouseDocument, baseOptions);
      }
export function useGetSessionsHistogramClickhouseLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Types.GetSessionsHistogramClickhouseQuery, Types.GetSessionsHistogramClickhouseQueryVariables>) {
          return Apollo.useLazyQuery<Types.GetSessionsHistogramClickhouseQuery, Types.GetSessionsHistogramClickhouseQueryVariables>(GetSessionsHistogramClickhouseDocument, baseOptions);
        }
export type GetSessionsHistogramClickhouseQueryHookResult = ReturnType<typeof useGetSessionsHistogramClickhouseQuery>;
export type GetSessionsHistogramClickhouseLazyQueryHookResult = ReturnType<typeof useGetSessionsHistogramClickhouseLazyQuery>;
export type GetSessionsHistogramClickhouseQueryResult = Apollo.QueryResult<Types.GetSessionsHistogramClickhouseQuery, Types.GetSessionsHistogramClickhouseQueryVariables>;
 ...
 * });
 */
export function useGetSessionsReportQuery(baseOptions: Apollo.QueryHookOptions<Types.GetSessionsReportQuery, Types.GetSessionsReportQueryVariables>) {
        return Apollo.useQuery<Types.GetSessionsReportQuery, Types.GetSessionsReportQueryVariables>(GetSessionsReportDocument, baseOptions);
      }
export function useGetSessionsReportLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Types.GetSessionsReportQuery, Types.GetSessionsReportQueryVariables>) {
          return Apollo.useLazyQuery<Types.GetSessionsReportQuery, Types.GetSessionsReportQueryVariables>(GetSessionsReportDocument, baseOptions);
        }
export type GetSessionsReportQueryHookResult = ReturnType<typeof useGetSessionsReportQuery>;
export type GetSessionsReportLazyQueryHookResult = ReturnType<typeof useGetSessionsReportLazyQuery>;
export type GetSessionsReportQueryResult = Apollo.QueryResult<Types.GetSessionsReportQuery, Types.GetSessionsReportQueryVariables>;
export const GetErrorGroupsClickhouseDocument = gql`
    query GetErrorGroupsClickhouse($project_id: ID!, $count: Int!, $query: ClickhouseQuery!, $page: Int) {
 ...
 * });
 */
export function useGetErrorGroupsClickhouseQuery(baseOptions: Apollo.QueryHookOptions<Types.GetErrorGroupsClickhouseQuery, Types.GetErrorGroupsClickhouseQueryVariables>) {
        return Apollo.useQuery<Types.GetErrorGroupsClickhouseQuery, Types.GetErrorGroupsClickhouseQueryVariables>(GetErrorGroupsClickhouseDocument, baseOptions);
      }
export function useGetErrorGroupsClickhouseLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Types.GetErrorGroupsClickhouseQuery, Types.GetErrorGroupsClickhouseQueryVariables>) {
          return Apollo.useLazyQuery<Types.GetErrorGroupsClickhouseQuery, Types.GetErrorGroupsClickhouseQueryVariables>(GetErrorGroupsClickhouseDocument, baseOptions);
        }
export type GetErrorGroupsClickhouseQueryHookResult = ReturnType<typeof useGetErrorGroupsClickhouseQuery>;
export type GetErrorGroupsClickhouseLazyQueryHookResult = ReturnType<typeof useGetErrorGroupsClickhouseLazyQuery>;
export type GetErrorGroupsClickhouseQueryResult = Apollo.QueryResult<Types.GetErrorGroupsClickhouseQuery, Types.GetErrorGroupsClickhouseQueryVariables>;
export const GetErrorsHistogramClickhouseDocument = gql`
    query GetErrorsHistogramClickhouse($project_id: ID!, $query: ClickhouseQuery!, $histogram_options: DateHistogramOptions!) {
 ...
 * });
 */
export function useGetErrorsHistogramClickhouseQuery(baseOptions: Apollo.QueryHookOptions<Types.GetErrorsHistogramClickhouseQuery, Types.GetErrorsHistogramClickhouseQueryVariables>) {
        return Apollo.useQuery<Types.GetErrorsHistogramClickhouseQuery, Types.GetErrorsHistogramClickhouseQueryVariables>(GetErrorsHistogramClickhouseDocument, baseOptions);
      }
export function useGetErrorsHistogramClickhouseLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Types.GetErrorsHistogramClickhouseQuery, Types.GetErrorsHistogramClickhouseQueryVariables>) {
          return Apollo.useLazyQuery<Types.GetErrorsHistogramClickhouseQuery, Types.GetErrorsHistogramClickhouseQueryVariables>(GetErrorsHistogramClickhouseDocument, baseOptions);
        }
export type GetErrorsHistogramClickhouseQueryHookResult = ReturnType<typeof useGetErrorsHistogramClickhouseQuery>;
export type GetErrorsHistogramClickhouseLazyQueryHookResult = ReturnType<typeof useGetErrorsHistogramClickhouseLazyQuery>;
export type GetErrorsHistogramClickhouseQueryResult = Apollo.QueryResult<Types.GetErrorsHistogramClickhouseQuery, Types.GetErrorsHistogramClickhouseQueryVariables>;
...
export const GetSavedSegmentsDocument = gql`
    query GetSavedSegments($project_id: ID!, $entity_type: SavedSegmentEntityType!) {
 ...
 * });
 */
export function useGetSavedSegmentsQuery(baseOptions: Apollo.QueryHookOptions<Types.GetSavedSegmentsQuery, Types.GetSavedSegmentsQueryVariables>) {
        return Apollo.useQuery<Types.GetSavedSegmentsQuery, Types.GetSavedSegmentsQueryVariables>(GetSavedSegmentsDocument, baseOptions);
      }
export function useGetSavedSegmentsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Types.GetSavedSegmentsQuery, Types.GetSavedSegmentsQueryVariables>) {
          return Apollo.useLazyQuery<Types.GetSavedSegmentsQuery, Types.GetSavedSegmentsQueryVariables>(GetSavedSegmentsDocument, baseOptions);
        }
export type GetSavedSegmentsQueryHookResult = ReturnType<typeof useGetSavedSegmentsQuery>;
export type GetSavedSegmentsLazyQueryHookResult = ReturnType<typeof useGetSavedSegmentsLazyQuery>;
export type GetSavedSegmentsQueryResult = Apollo.QueryResult<Types.GetSavedSegmentsQuery, Types.GetSavedSegmentsQueryVariables>;
 ...
 * });
 */
export function useGetTracesIntegrationQuery(baseOptions: Apollo.QueryHookOptions<Types.GetTracesIntegrationQuery, Types.GetTracesIntegrationQueryVariables>) {
        return Apollo.useQuery<Types.GetTracesIntegrationQuery, Types.GetTracesIntegrationQueryVariables>(GetTracesIntegrationDocument, baseOptions);
      }
export function useGetTracesIntegrationLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Types.GetTracesIntegrationQuery, Types.GetTracesIntegrationQueryVariables>) {
          return Apollo.useLazyQuery<Types.GetTracesIntegrationQuery, Types.GetTracesIntegrationQueryVariables>(GetTracesIntegrationDocument, baseOptions);
        }
export type GetTracesIntegrationQueryHookResult = ReturnType<typeof useGetTracesIntegrationQuery>;
export type GetTracesIntegrationLazyQueryHookResult = ReturnType<typeof useGetTracesIntegrationLazyQuery>;
export type GetTracesIntegrationQueryResult = Apollo.QueryResult<Types.GetTracesIntegrationQuery, Types.GetTracesIntegrationQueryVariables>;
export const GetKeyPerformanceIndicatorsDocument = gql`
  ...
  averageSessionLength(project_id: $project_id, lookback_days: $lookback_days) {
    length
  }
  userFingerprintCount(project_id: $project_id, lookback_days: $lookback_days) {
    count
  }
}
    `;
...
export const GetRageClicksForProjectDocument = gql`
  ...
  rageClicksForProject(project_id: $project_id, lookback_days: $lookback_days) {
    identifier
    session_secure_id
    total_clicks
    user_properties
 ...
 * });
 */
export function useGetJiraIntegrationSettingsQuery(baseOptions: Apollo.QueryHookOptions<Types.GetJiraIntegrationSettingsQuery, Types.GetJiraIntegrationSettingsQueryVariables>) {
        return Apollo.useQuery<Types.GetJiraIntegrationSettingsQuery, Types.GetJiraIntegrationSettingsQueryVariables>(GetJiraIntegrationSettingsDocument, baseOptions);
      }
export function useGetJiraIntegrationSettingsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Types.GetJiraIntegrationSettingsQuery, Types.GetJiraIntegrationSettingsQueryVariables>) {
          return Apollo.useLazyQuery<Types.GetJiraIntegrationSettingsQuery, Types.GetJiraIntegrationSettingsQueryVariables>(GetJiraIntegrationSettingsDocument, baseOptions);
        }
export type GetJiraIntegrationSettingsQueryHookResult = ReturnType<typeof useGetJiraIntegrationSettingsQuery>;
export type GetJiraIntegrationSettingsLazyQueryHookResult = ReturnType<typeof useGetJiraIntegrationSettingsLazyQuery>;
export type GetJiraIntegrationSettingsQueryResult = Apollo.QueryResult<Types.GetJiraIntegrationSettingsQuery, Types.GetJiraIntegrationSettingsQueryVariables>;
 ...
 * });
 */
export function useGetGitlabIntegrationSettingsQuery(baseOptions: Apollo.QueryHookOptions<Types.GetGitlabIntegrationSettingsQuery, Types.GetGitlabIntegrationSettingsQueryVariables>) {
        return Apollo.useQuery<Types.GetGitlabIntegrationSettingsQuery, Types.GetGitlabIntegrationSettingsQueryVariables>(GetGitlabIntegrationSettingsDocument, baseOptions);
      }
export function useGetGitlabIntegrationSettingsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Types.GetGitlabIntegrationSettingsQuery, Types.GetGitlabIntegrationSettingsQueryVariables>) {
          return Apollo.useLazyQuery<Types.GetGitlabIntegrationSettingsQuery, Types.GetGitlabIntegrationSettingsQueryVariables>(GetGitlabIntegrationSettingsDocument, baseOptions);
        }
export type GetGitlabIntegrationSettingsQueryHookResult = ReturnType<typeof useGetGitlabIntegrationSettingsQuery>;
export type GetGitlabIntegrationSettingsLazyQueryHookResult = ReturnType<typeof useGetGitlabIntegrationSettingsLazyQuery>;
export type GetGitlabIntegrationSettingsQueryResult = Apollo.QueryResult<Types.GetGitlabIntegrationSettingsQuery, Types.GetGitlabIntegrationSettingsQueryVariables>;
...
export const GetMetricTagsDocument = gql`
  ...
  metric_tags(project_id: $project_id, metric_name: $metric_name, query: $query)
}
    `;
...
export const GetErrorGroupFrequenciesDocument = gql`
    query GetErrorGroupFrequencies($project_id: ID!, $error_group_secure_ids: [String!]!, $params: ErrorGroupFrequenciesParamsInput!, $metric: String!, $use_clickhouse: Boolean) {
...
export const GetErrorGroupTagsDocument = gql`
    query GetErrorGroupTags($error_group_secure_id: String!, $use_clickhouse: Boolean) {
  errorGroupTags(
    error_group_secure_id: $error_group_secure_id
    use_clickhouse: $use_clickhouse
  ) {
...
export const GetLogsKeysDocument = gql`
    query GetLogsKeys($project_id: ID!, $date_range: DateRangeRequiredInput!, $query: String) {
  keys: logs_keys(project_id: $project_id, date_range: $date_range, query: $query) {
    name
    type
  }
}
 ...
 * });
 */
export function useGetErrorResolutionSuggestionQuery(baseOptions: Apollo.QueryHookOptions<Types.GetErrorResolutionSuggestionQuery, Types.GetErrorResolutionSuggestionQueryVariables>) {
        return Apollo.useQuery<Types.GetErrorResolutionSuggestionQuery, Types.GetErrorResolutionSuggestionQueryVariables>(GetErrorResolutionSuggestionDocument, baseOptions);
      }
export function useGetErrorResolutionSuggestionLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Types.GetErrorResolutionSuggestionQuery, Types.GetErrorResolutionSuggestionQueryVariables>) {
          return Apollo.useLazyQuery<Types.GetErrorResolutionSuggestionQuery, Types.GetErrorResolutionSuggestionQueryVariables>(GetErrorResolutionSuggestionDocument, baseOptions);
        }
export type GetErrorResolutionSuggestionQueryHookResult = ReturnType<typeof useGetErrorResolutionSuggestionQuery>;
export type GetErrorResolutionSuggestionLazyQueryHookResult = ReturnType<typeof useGetErrorResolutionSuggestionLazyQuery>;
export type GetErrorResolutionSuggestionQueryResult = Apollo.QueryResult<Types.GetErrorResolutionSuggestionQuery, Types.GetErrorResolutionSuggestionQueryVariables>;
 ...
 * });
 */
export function useGetWorkspaceSettingsQuery(baseOptions: Apollo.QueryHookOptions<Types.GetWorkspaceSettingsQuery, Types.GetWorkspaceSettingsQueryVariables>) {
        return Apollo.useQuery<Types.GetWorkspaceSettingsQuery, Types.GetWorkspaceSettingsQueryVariables>(GetWorkspaceSettingsDocument, baseOptions);
      }
export function useGetWorkspaceSettingsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Types.GetWorkspaceSettingsQuery, Types.GetWorkspaceSettingsQueryVariables>) {
          return Apollo.useLazyQuery<Types.GetWorkspaceSettingsQuery, Types.GetWorkspaceSettingsQueryVariables>(GetWorkspaceSettingsDocument, baseOptions);
        }
...
export type GetWorkspaceSettingsQueryResult = Apollo.QueryResult<Types.GetWorkspaceSettingsQuery, Types.GetWorkspaceSettingsQueryVariables>;
 ...
 * });
 */
export function useGetSystemConfigurationQuery(baseOptions?: Apollo.QueryHookOptions<Types.GetSystemConfigurationQuery, Types.GetSystemConfigurationQueryVariables>) {
        return Apollo.useQuery<Types.GetSystemConfigurationQuery, Types.GetSystemConfigurationQueryVariables>(GetSystemConfigurationDocument, baseOptions);
      }
export function useGetSystemConfigurationLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Types.GetSystemConfigurationQuery, Types.GetSystemConfigurationQueryVariables>) {
          return Apollo.useLazyQuery<Types.GetSystemConfigurationQuery, Types.GetSystemConfigurationQueryVariables>(GetSystemConfigurationDocument, baseOptions);
        }
export type GetSystemConfigurationQueryHookResult = ReturnType<typeof useGetSystemConfigurationQuery>;
export type GetSystemConfigurationLazyQueryHookResult = ReturnType<typeof useGetSystemConfigurationLazyQuery>;
export type GetSystemConfigurationQueryResult = Apollo.QueryResult<Types.GetSystemConfigurationQuery, Types.GetSystemConfigurationQueryVariables>;
export const GetErrorObjectsDocument = gql`
    query GetErrorObjects($errorGroupSecureID: String!, $after: String, $before: String, $query: String!) {
  error_objects(
 ...
 * });
 */
export function useGetErrorObjectsQuery(baseOptions: Apollo.QueryHookOptions<Types.GetErrorObjectsQuery, Types.GetErrorObjectsQueryVariables>) {
        return Apollo.useQuery<Types.GetErrorObjectsQuery, Types.GetErrorObjectsQueryVariables>(GetErrorObjectsDocument, baseOptions);
      }
export function useGetErrorObjectsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Types.GetErrorObjectsQuery, Types.GetErrorObjectsQueryVariables>) {
          return Apollo.useLazyQuery<Types.GetErrorObjectsQuery, Types.GetErrorObjectsQueryVariables>(GetErrorObjectsDocument, baseOptions);
        }
export type GetErrorObjectsQueryHookResult = ReturnType<typeof useGetErrorObjectsQuery>;
export type GetErrorObjectsLazyQueryHookResult = ReturnType<typeof useGetErrorObjectsLazyQuery>;
export type GetErrorObjectsQueryResult = Apollo.QueryResult<Types.GetErrorObjectsQuery, Types.GetErrorObjectsQueryVariables>;
export const GetServicesDocument = gql`
    query GetServices($project_id: ID!, $query: String, $after: String, $before: String) {
  services(project_id: $project_id, query: $query, after: $after, before: $before) {
    edges {
      cursor
      node {
        id
 ...
 * });
 */
export function useGetServicesQuery(baseOptions: Apollo.QueryHookOptions<Types.GetServicesQuery, Types.GetServicesQueryVariables>) {
        return Apollo.useQuery<Types.GetServicesQuery, Types.GetServicesQueryVariables>(GetServicesDocument, baseOptions);
      }
export function useGetServicesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Types.GetServicesQuery, Types.GetServicesQueryVariables>) {
          return Apollo.useLazyQuery<Types.GetServicesQuery, Types.GetServicesQueryVariables>(GetServicesDocument, baseOptions);
        }
...
export type GetServicesQueryResult = Apollo.QueryResult<Types.GetServicesQuery, Types.GetServicesQueryVariables>;
 ...
 * });
 */
export function useGetServiceByNameQuery(baseOptions: Apollo.QueryHookOptions<Types.GetServiceByNameQuery, Types.GetServiceByNameQueryVariables>) {
        return Apollo.useQuery<Types.GetServiceByNameQuery, Types.GetServiceByNameQueryVariables>(GetServiceByNameDocument, baseOptions);
      }
export function useGetServiceByNameLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Types.GetServiceByNameQuery, Types.GetServiceByNameQueryVariables>) {
          return Apollo.useLazyQuery<Types.GetServiceByNameQuery, Types.GetServiceByNameQueryVariables>(GetServiceByNameDocument, baseOptions);
        }
export type GetServiceByNameQueryHookResult = ReturnType<typeof useGetServiceByNameQuery>;
export type GetServiceByNameLazyQueryHookResult = ReturnType<typeof useGetServiceByNameLazyQuery>;
export type GetServiceByNameQueryResult = Apollo.QueryResult<Types.GetServiceByNameQuery, Types.GetServiceByNameQueryVariables>;
 ...
 * });
 */
export function useGetErrorTagsQuery(baseOptions?: Apollo.QueryHookOptions<Types.GetErrorTagsQuery, Types.GetErrorTagsQueryVariables>) {
        return Apollo.useQuery<Types.GetErrorTagsQuery, Types.GetErrorTagsQueryVariables>(GetErrorTagsDocument, baseOptions);
      }
export function useGetErrorTagsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Types.GetErrorTagsQuery, Types.GetErrorTagsQueryVariables>) {
          return Apollo.useLazyQuery<Types.GetErrorTagsQuery, Types.GetErrorTagsQueryVariables>(GetErrorTagsDocument, baseOptions);
        }
export type GetErrorTagsQueryHookResult = ReturnType<typeof useGetErrorTagsQuery>;
export type GetErrorTagsLazyQueryHookResult = ReturnType<typeof useGetErrorTagsLazyQuery>;
export type GetErrorTagsQueryResult = Apollo.QueryResult<Types.GetErrorTagsQuery, Types.GetErrorTagsQueryVariables>;
 ...
 * });
 */
export function useMatchErrorTagQuery(baseOptions: Apollo.QueryHookOptions<Types.MatchErrorTagQuery, Types.MatchErrorTagQueryVariables>) {
        return Apollo.useQuery<Types.MatchErrorTagQuery, Types.MatchErrorTagQueryVariables>(MatchErrorTagDocument, baseOptions);
      }
export function useMatchErrorTagLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Types.MatchErrorTagQuery, Types.MatchErrorTagQueryVariables>) {
          return Apollo.useLazyQuery<Types.MatchErrorTagQuery, Types.MatchErrorTagQueryVariables>(MatchErrorTagDocument, baseOptions);
        }
export type MatchErrorTagQueryHookResult = ReturnType<typeof useMatchErrorTagQuery>;
export type MatchErrorTagLazyQueryHookResult = ReturnType<typeof useMatchErrorTagLazyQuery>;
export type MatchErrorTagQueryResult = Apollo.QueryResult<Types.MatchErrorTagQuery, Types.MatchErrorTagQueryVariables>;
 ...
 * });
 */
export function useFindSimilarErrorsQuery(baseOptions: Apollo.QueryHookOptions<Types.FindSimilarErrorsQuery, Types.FindSimilarErrorsQueryVariables>) {
        return Apollo.useQuery<Types.FindSimilarErrorsQuery, Types.FindSimilarErrorsQueryVariables>(FindSimilarErrorsDocument, baseOptions);
      }
export function useFindSimilarErrorsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Types.FindSimilarErrorsQuery, Types.FindSimilarErrorsQueryVariables>) {
          return Apollo.useLazyQuery<Types.FindSimilarErrorsQuery, Types.FindSimilarErrorsQueryVariables>(FindSimilarErrorsDocument, baseOptions);
        }
export type FindSimilarErrorsQueryHookResult = ReturnType<typeof useFindSimilarErrorsQuery>;
export type FindSimilarErrorsLazyQueryHookResult = ReturnType<typeof useFindSimilarErrorsLazyQuery>;
export type FindSimilarErrorsQueryResult = Apollo.QueryResult<Types.FindSimilarErrorsQuery, Types.FindSimilarErrorsQueryVariables>;
 ...
 * });
 */
export function useGetTraceQuery(baseOptions: Apollo.QueryHookOptions<Types.GetTraceQuery, Types.GetTraceQueryVariables>) {
        return Apollo.useQuery<Types.GetTraceQuery, Types.GetTraceQueryVariables>(GetTraceDocument, baseOptions);
      }
export function useGetTraceLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Types.GetTraceQuery, Types.GetTraceQueryVariables>) {
          return Apollo.useLazyQuery<Types.GetTraceQuery, Types.GetTraceQueryVariables>(GetTraceDocument, baseOptions);
        }
export type GetTraceQueryHookResult = ReturnType<typeof useGetTraceQuery>;
export type GetTraceLazyQueryHookResult = ReturnType<typeof useGetTraceLazyQuery>;
export type GetTraceQueryResult = Apollo.QueryResult<Types.GetTraceQuery, Types.GetTraceQueryVariables>;
 ...
 * });
 */
export function useGetTracesQuery(baseOptions: Apollo.QueryHookOptions<Types.GetTracesQuery, Types.GetTracesQueryVariables>) {
        return Apollo.useQuery<Types.GetTracesQuery, Types.GetTracesQueryVariables>(GetTracesDocument, baseOptions);
      }
export function useGetTracesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Types.GetTracesQuery, Types.GetTracesQueryVariables>) {
          return Apollo.useLazyQuery<Types.GetTracesQuery, Types.GetTracesQueryVariables>(GetTracesDocument, baseOptions);
        }
export type GetTracesQueryHookResult = ReturnType<typeof useGetTracesQuery>;
export type GetTracesLazyQueryHookResult = ReturnType<typeof useGetTracesLazyQuery>;
export type GetTracesQueryResult = Apollo.QueryResult<Types.GetTracesQuery, Types.GetTracesQueryVariables>;
export const GetTracesMetricsDocument = gql`
    query GetTracesMetrics($project_id: ID!, $params: QueryInput!, $column: String!, $metric_types: [MetricAggregator!]!, $group_by: [String!]!, $bucket_by: String, $limit: Int, $limit_aggregator: MetricAggregator, $limit_column: String) {
  traces_metrics(
    project_id: $project_id
    params: $params
    column: $column
 ...
 * });
 */
export function useGetTracesMetricsQuery(baseOptions: Apollo.QueryHookOptions<Types.GetTracesMetricsQuery, Types.GetTracesMetricsQueryVariables>) {
        return Apollo.useQuery<Types.GetTracesMetricsQuery, Types.GetTracesMetricsQueryVariables>(GetTracesMetricsDocument, baseOptions);
      }
export function useGetTracesMetricsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Types.GetTracesMetricsQuery, Types.GetTracesMetricsQueryVariables>) {
          return Apollo.useLazyQuery<Types.GetTracesMetricsQuery, Types.GetTracesMetricsQueryVariables>(GetTracesMetricsDocument, baseOptions);
        }
export type GetTracesMetricsQueryHookResult = ReturnType<typeof useGetTracesMetricsQuery>;
export type GetTracesMetricsLazyQueryHookResult = ReturnType<typeof useGetTracesMetricsLazyQuery>;
export type GetTracesMetricsQueryResult = Apollo.QueryResult<Types.GetTracesMetricsQuery, Types.GetTracesMetricsQueryVariables>;
export const GetTracesKeysDocument = gql`
    query GetTracesKeys($project_id: ID!, $date_range: DateRangeRequiredInput!, $query: String) {
  keys: traces_keys(
    project_id: $project_id
    date_range: $date_range
    query: $query
 ...
 * });
 */
export function useGetTracesKeysQuery(baseOptions: Apollo.QueryHookOptions<Types.GetTracesKeysQuery, Types.GetTracesKeysQueryVariables>) {
        return Apollo.useQuery<Types.GetTracesKeysQuery, Types.GetTracesKeysQueryVariables>(GetTracesKeysDocument, baseOptions);
      }
export function useGetTracesKeysLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Types.GetTracesKeysQuery, Types.GetTracesKeysQueryVariables>) {
          return Apollo.useLazyQuery<Types.GetTracesKeysQuery, Types.GetTracesKeysQueryVariables>(GetTracesKeysDocument, baseOptions);
        }
export type GetTracesKeysQueryHookResult = ReturnType<typeof useGetTracesKeysQuery>;
export type GetTracesKeysLazyQueryHookResult = ReturnType<typeof useGetTracesKeysLazyQuery>;
export type GetTracesKeysQueryResult = Apollo.QueryResult<Types.GetTracesKeysQuery, Types.GetTracesKeysQueryVariables>;
export const GetTracesKeyValuesDocument = gql`
    query GetTracesKeyValues($project_id: ID!, $key_name: String!, $date_range: DateRangeRequiredInput!) {
 ...
 * });
 */
export function useGetTracesKeyValuesQuery(baseOptions: Apollo.QueryHookOptions<Types.GetTracesKeyValuesQuery, Types.GetTracesKeyValuesQueryVariables>) {
        return Apollo.useQuery<Types.GetTracesKeyValuesQuery, Types.GetTracesKeyValuesQueryVariables>(GetTracesKeyValuesDocument, baseOptions);
      }
export function useGetTracesKeyValuesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Types.GetTracesKeyValuesQuery, Types.GetTracesKeyValuesQueryVariables>) {
          return Apollo.useLazyQuery<Types.GetTracesKeyValuesQuery, Types.GetTracesKeyValuesQueryVariables>(GetTracesKeyValuesDocument, baseOptions);
        }
export type GetTracesKeyValuesQueryHookResult = ReturnType<typeof useGetTracesKeyValuesQuery>;
export type GetTracesKeyValuesLazyQueryHookResult = ReturnType<typeof useGetTracesKeyValuesLazyQuery>;
export type GetTracesKeyValuesQueryResult = Apollo.QueryResult<Types.GetTracesKeyValuesQuery, Types.GetTracesKeyValuesQueryVariables>;