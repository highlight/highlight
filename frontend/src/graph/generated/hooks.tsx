...
export const GetFieldsOpensearchDocument = gql`
    query GetFieldsOpensearch($project_id: ID!, $count: Int!, $field_type: String!, $field_name: String!, $query: String!, $start_date: Timestamp, $end_date: Timestamp, $use_clickhouse: Boolean) {
  fields_opensearch(
    project_id: $project_id
    count: $count
...
export const GetErrorFieldsOpensearchDocument = gql`
    query GetErrorFieldsOpensearch($project_id: ID!, $count: Int!, $field_type: String!, $field_name: String!, $query: String!, $start_date: Timestamp, $end_date: Timestamp, $use_clickhouse: Boolean) {
...
export const GetSessionsOpenSearchDocument = gql`
    query GetSessionsOpenSearch($project_id: ID!, $count: Int!, $query: String!, $clickhouse_query: ClickhouseQuery, $sort_desc: Boolean!, $sort_field: String, $page: Int) {
  sessions_opensearch(
    project_id: $project_id
    count: $count
    query: $query
...
export const GetSessionsHistogramDocument = gql`
    query GetSessionsHistogram($project_id: ID!, $query: String!, $histogram_options: DateHistogramOptions!, $clickhouse_query: ClickhouseQuery) {
  sessions_histogram(
    project_id: $project_id
    query: $query
...
export const GetErrorGroupsOpenSearchDocument = gql`
    query GetErrorGroupsOpenSearch($project_id: ID!, $count: Int!, $query: String!, $clickhouse_query: ClickhouseQuery, $page: Int) {
...
export const GetErrorsHistogramDocument = gql`
    query GetErrorsHistogram($project_id: ID!, $query: String!, $clickhouse_query: ClickhouseQuery, $histogram_options: DateHistogramOptions!) {
  errors_histogram(
    project_id: $project_id
    query: $query
    clickhouse_query: $clickhouse_query
