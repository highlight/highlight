...
export type CreateCloudflareProxyMutationOptions = Apollo.BaseMutationOptions<
	...
	Types.CreateCloudflareProxyMutationVariables
>
export const CreateAwsCredentialsDocument = gql`
...
`
export type CreateAwsCredentialsMutationFn = Apollo.MutationFunction<
	Types.CreateAwsCredentialsMutation,
	Types.CreateAwsCredentialsMutationVariables
>

/**
 * __useCreateAwsCredentialsMutation__
 *
 * To run a mutation, you first call `useCreateAwsCredentialsMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateAwsCredentialsMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [createAwsCredentialsMutation, { data, loading, error }] = useCreateAwsCredentialsMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useCreateAwsCredentialsMutation(
	baseOptions?: Apollo.MutationHookOptions<
		Types.CreateAwsCredentialsMutation,
		Types.CreateAwsCredentialsMutationVariables
	>,
	...
	return Apollo.useMutation<
		Types.CreateAwsCredentialsMutation,
		Types.CreateAwsCredentialsMutationVariables
	>(CreateAwsCredentialsDocument, baseOptions)
}
export type CreateAwsCredentialsMutationHookResult = ReturnType<
	typeof useCreateAwsCredentialsMutation
>
export type CreateAwsCredentialsMutationResult =
	Apollo.MutationResult<Types.CreateAwsCredentialsMutation>
export type CreateAwsCredentialsMutationOptions = Apollo.BaseMutationOptions<
	Types.CreateAwsCredentialsMutation,
	Types.CreateAwsCredentialsMutationVariables
>
