...
export type GetCustomerPortalUrlQueryResult = Apollo.QueryResult<
    ...
    Types.GetCustomerPortalUrlQueryVariables
>;
export const OnEventsAddedDocument = gql`
    subscription OnEventsAdded(
        $session_secure_id: String!
...
/**
 * __useOnEventsAddedSubscription__
 *
 * To run a query within a React component, call `useOnEventsAddedSubscription` and pass it any options that fit your needs.
 * When your component renders, `useOnEventsAddedSubscription` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the subscription, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useOnEventsAddedSubscription({
 *   variables: {
 *      session_secure_id: // value for 'session_secure_id'
 ...
 * });
 */
export function useOnEventsAddedSubscription(
    baseOptions: Apollo.SubscriptionHookOptions<
        Types.OnEventsAddedSubscription,
        Types.OnEventsAddedSubscriptionVariables
    >
) {
    return Apollo.useSubscription<
        Types.OnEventsAddedSubscription,
        Types.OnEventsAddedSubscriptionVariables
    >(OnEventsAddedDocument, baseOptions);
}
export type OnEventsAddedSubscriptionHookResult = ReturnType<
