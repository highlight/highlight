...
declare module '@highlight-run/react-mentions' {
    ...
    export const Mention: React.FC<
        React.PropsWithChildren<React.PropsWithChildren<MentionProps>>
    >;
     ...
     */
    export type MentionsInputClass = React.ComponentClass<MentionsInputProps>;
