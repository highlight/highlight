...
export default class SearchGrammarLexer extends Lexer {
	...
	public static readonly _serializedATN: number[] = [
		...
		17, 9, 19, 10, 21, 11, 23, 12, 25, 13, 27, 14, 29, 15, 1, 0, 2, 5, 0,
		45, 46, 48, 57, 65, 90, 95, 95, 97, 122, 3, 0, 9, 10, 12, 13, 32, 32,
		...
		0, 0, 0, 35, 36, 5, 79, 0, 0, 36, 37, 5, 82, 0, 0, 37, 4, 1, 0, 0, 0,
		38, 39, 5, 78, 0, 0, 39, 40, 5, 79, 0, 0, 40, 41, 5, 84, 0, 0, 41, 6, 1,
		0, 0, 0, 42, 43, 5, 61, 0, 0, 43, 8, 1, 0, 0, 0, 44, 45, 5, 33, 0, 0,
		45, 46, 5, 61, 0, 0, 46, 10, 1, 0, 0, 0, 47, 48, 5, 60, 0, 0, 48, 12, 1,
		0, 0, 0, 49, 50, 5, 60, 0, 0, 50, 51, 5, 61, 0, 0, 51, 14, 1, 0, 0, 0,
		52, 53, 5, 62, 0, 0, 53, 16, 1, 0, 0, 0, 54, 55, 5, 62, 0, 0, 55, 56, 5,
		61, 0, 0, 56, 18, 1, 0, 0, 0, 57, 58, 5, 40, 0, 0, 58, 20, 1, 0, 0, 0,
		59, 60, 5, 41, 0, 0, 60, 22, 1, 0, 0, 0, 61, 62, 5, 58, 0, 0, 62, 24, 1,
		0, 0, 0, 63, 65, 7, 0, 0, 0, 64, 63, 1, 0, 0, 0, 65, 66, 1, 0, 0, 0, 66,
		64, 1, 0, 0, 0, 66, 67, 1, 0, 0, 0, 67, 26, 1, 0, 0, 0, 68, 72, 5, 34,
		0, 0, 69, 71, 9, 0, 0, 0, 70, 69, 1, 0, 0, 0, 71, 74, 1, 0, 0, 0, 72,
		73, 1, 0, 0, 0, 72, 70, 1, 0, 0, 0, 73, 75, 1, 0, 0, 0, 74, 72, 1, 0, 0,
		0, 75, 76, 5, 34, 0, 0, 76, 28, 1, 0, 0, 0, 77, 79, 7, 1, 0, 0, 78, 77,
		1, 0, 0, 0, 79, 80, 1, 0, 0, 0, 80, 78, 1, 0, 0, 0, 80, 81, 1, 0, 0, 0,
		81, 82, 1, 0, 0, 0, 82, 83, 6, 14, 0, 0, 83, 30, 1, 0, 0, 0, 4, 0, 66,
		72, 80, 1, 6, 0, 0,
	]
