    ...
    return (
        <div className={inputStyles.commonInputWrapper}>
            <AsyncCreatableSelect
                ...
                cacheOptions
                value={
                    errorSearchParams.visited_url
                        ? {
                              label: errorSearchParams.visited_url,
                              value: errorSearchParams.visited_url,
                          }
                        : null
                }
                components={{
...
export const ViewedSessionsSwitch = () => {
    ...
    return (
        <div className={inputStyles.switchRow}>
            <Switch
                checked={errorSearchParams.hide_viewed}
