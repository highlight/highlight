...
ENV CONNECT_CONSUMER_MAX_POLL_RECORDS=300000
...
# 16 MiB
ENV CONNECT_CONSUMER_FETCH_MIN_BYTES=16777216
# 128 MiB
ENV CONNECT_CONSUMER_FETCH_MAX_BYTES=134217728
# 32 MiB
ENV CONNECT_CONSUMER_MAX_PARTITION_FETCH_BYTES=33554432

# ensures the values above override per kafka connect worker.
ENV CONNECT_CONNECTOR_CLIENT_CONFIG_OVERRIDE_POLICY=All

ENV KAFKA_HEAP_OPTS="-Xms16g -Xmx31g"
