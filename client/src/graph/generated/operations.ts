...
export type PushMetricsMutationVariables = Types.Exact<{
  metrics: Array<Types.Maybe<Types.MetricInput>> | Types.Maybe<Types.MetricInput>;
}>;


export type PushMetricsMutation = (
  { __typename?: 'Mutation' }
  & Pick<Types.Mutation, 'pushMetrics'>
);
...
export type InitializeSessionMutationVariables = Types.Exact<{
  ...
  client_id?: Types.Maybe<Types.Scalars['String']>;
}>;
...
export const InitializeSessionDocument = gql`
    mutation initializeSession($organization_verbose_id: String!, $enable_strict_privacy: Boolean!, $enable_recording_network_contents: Boolean!, $clientVersion: String!, $firstloadVersion: String!, $clientConfig: String!, $environment: String!, $id: String!, $appVersion: String, $session_secure_id: String, $client_id: String) {
  initializeSession(
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    pushMetrics(variables: PushMetricsMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<PushMetricsMutation> {
      return withWrapper(() => client.request<PushMetricsMutation>(print(PushMetricsDocument), variables, requestHeaders));
    },
