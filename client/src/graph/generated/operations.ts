...
export type PushPayloadMutation = { __typename?: 'Mutation', pushPayload: number };
...
export type IdentifySessionMutation = { __typename?: 'Mutation', identifySession?: string | null };
...
export type AddSessionPropertiesMutation = { __typename?: 'Mutation', addSessionProperties?: string | null };
...
export type PushMetricsMutation = { __typename?: 'Mutation', pushMetrics: number };
...
export type AddTrackPropertiesMutation = { __typename?: 'Mutation', addTrackProperties?: string | null };
...
export type AddSessionFeedbackMutation = { __typename?: 'Mutation', addSessionFeedback: string };
...
export type InitializeSessionMutation = { __typename?: 'Mutation', initializeSession?: { __typename?: 'Session', secure_id: string, organization_id: string, project_id: string } | null };
...
export const PushPayloadDocument = gql`
    mutation PushPayload($session_secure_id: String!, $events: ReplayEventsInput!, $messages: String!, $resources: String!, $errors: [ErrorObjectInput]!, $is_beacon: Boolean, $has_session_unloaded: Boolean, $highlight_logs: String, $payload_id: ID) {
  pushPayload(
...
export const IdentifySessionDocument = gql`
    mutation identifySession($session_secure_id: String!, $user_identifier: String!, $user_object: Any) {
  identifySession(
    session_secure_id: $session_secure_id
...
export const AddSessionPropertiesDocument = gql`
    mutation addSessionProperties($session_secure_id: String!, $properties_object: Any) {
...
export const AddTrackPropertiesDocument = gql`
    mutation addTrackProperties($session_secure_id: String!, $properties_object: Any) {
  addTrackProperties(
    session_secure_id: $session_secure_id
    properties_object: $properties_object
  )
...
export const AddSessionFeedbackDocument = gql`
    mutation addSessionFeedback($session_secure_id: String!, $user_name: String, $user_email: String, $verbatim: String!, $timestamp: Timestamp!) {
  addSessionFeedback(
    session_secure_id: $session_secure_id
    user_name: $user_name
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    PushPayload(variables: PushPayloadMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<PushPayloadMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<PushPayloadMutation>(PushPayloadDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'PushPayload', 'mutation');
    },
    identifySession(variables: IdentifySessionMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<IdentifySessionMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<IdentifySessionMutation>(IdentifySessionDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'identifySession', 'mutation');
    },
    addSessionProperties(variables: AddSessionPropertiesMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<AddSessionPropertiesMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<AddSessionPropertiesMutation>(AddSessionPropertiesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'addSessionProperties', 'mutation');
    },
    pushMetrics(variables: PushMetricsMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<PushMetricsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<PushMetricsMutation>(PushMetricsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'pushMetrics', 'mutation');
    },
    addTrackProperties(variables: AddTrackPropertiesMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<AddTrackPropertiesMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<AddTrackPropertiesMutation>(AddTrackPropertiesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'addTrackProperties', 'mutation');
    },
    addSessionFeedback(variables: AddSessionFeedbackMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<AddSessionFeedbackMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<AddSessionFeedbackMutation>(AddSessionFeedbackDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'addSessionFeedback', 'mutation');
    },
    initializeSession(variables: InitializeSessionMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<InitializeSessionMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<InitializeSessionMutation>(InitializeSessionDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'initializeSession', 'mutation');
    },
    Ignore(variables: IgnoreQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<IgnoreQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<IgnoreQuery>(IgnoreDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'Ignore', 'query');
    }
  };
}
