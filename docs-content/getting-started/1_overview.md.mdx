...
<DocsCardGroup>
	...
	<DocsCard
		...
		href="./7_native-opentelemetry/2_error-monitoring.md"
	>
...
<DocsCardGroup>
	...
	<DocsCard
		title="Native OpenTelemetry"
		href="./7_native-opentelemetry/3_logging.md"
	>
		{'Get started with OpenTelemetry'}
	</DocsCard>
</DocsCardGroup>
...
<DocsCardGroup>
	...
	<DocsCard
		...
		href="./backend-logging/11_fluentforward.md"
	>
...
<DocsCardGroup>
	...
	<DocsCard
		title="Native OpenTelemetry"
		href="./7_native-opentelemetry/4_tracing.md"
	>
