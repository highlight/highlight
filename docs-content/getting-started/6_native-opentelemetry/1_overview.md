...
The highlight.io SDKs are powered by [OpenTelemetry](https://opentelemetry.io/) under the hood and report data to our deployed OpenTelemetry [collector](https://otel.highlight.io). You can always use our [in-house SDKS](../4_server/1_go/1_overview.md), but if you prefer to report raw OTEL data instead, continue reading!
