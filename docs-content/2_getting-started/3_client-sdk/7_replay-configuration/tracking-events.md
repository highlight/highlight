...
A track event is a named event that you've defined. Adding a track event is useful if you want to be able to be alerted (see [alerts](../../../6_product-features/3_general-features/alerts.md)) or [search for sessions](../../../6_product-features/1_session-replay/session-search.md#track-searching) where the user has done an action.
