...
<DocsCardGroup>
	...
	<DocsCard
		...
		href="../../../getting-started/3_client-sdk/7_replay-configuration/versioning-sessions-and-errors.md"
	>
		{'Send highlight.io metadata so you can version errors across deploys.'}
	</DocsCard>
	<DocsCard
		title="Filtering and Ignoring Errors"
		href="./filtering-errors.md"
	>
