...
Interested in contributing to [highlight.io](https://highlight.io)? Its now easier than ever to get started with our new codespaces setup. Check out our [contributing guide](../company/open-source/contributing/1_getting-started.md) for more info.
