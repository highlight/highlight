...
<section className="section">
	<div className="left">
		...
		<p>
			Highlight's Cloudflare Worker SDK lets you track your errors and
			responses in Cloudflare Workers with no impact on performance..
		</p>
	</div>
	<div className="right">
		...
		<p>
			...
			guide](../getting-started/4_backend-sdk/03_js/cloudflare.md) to get
