...
<section className="section">
	<div className="left">
		...
		<p>
			Highlight's [Go
			SDK](https://pkg.go.dev/github.com/highlight/highlight/sdk/highlight-go)
			makes it easy to monitor errors and logs on your Go backend.
		</p>
	</div>
	<div className="right">
		...
		<p>
			...
			guide](../getting-started/4_backend-sdk/01_go/1_overview.md) to get
...
<section className="section">
	<div className="left">
		...
		<p>
			...
			This allows the user kill the highlight worker by canceling their
			context.CancelFunc.
		</p>
		<h6>Method Parameters</h6>
		<aside className="parameter">
			<h5>
				ctx <code>context.Context</code> <code>required</code>
			</h5>
		...
		<aside className="parameter">
			<h5>
				<code>WithServiceName</code> <code>optional</code>
			</h5>
			<p>The name of your app.</p>
			<h5>
				<code>WithServiceVersion</code> <code>optional</code>
			</h5>
			<p>
				The version of this app. We recommend setting this to the most
				recent deploy SHA of your app.
			</p>
		</aside>
	</div>
	<div className="right">
		<code>
			ctx := context.Background() ... highlight.startWithContext(ctx,
			highlight.WithServiceName("my-app"),
			highlight.WithServiceVersion("git-sha"), )
		</code>
	</div>
...
<section className="section">
	<div className="left">
		...
		<p>
			Stop the Highlight client. Does not wait for all un-flushed data to
			be sent.
		</p>
	</div>
	<div className="right">
		<code>highlight.Stop()</code>
	</div>
</section>
...
<section className="section">
	<div className="left">
		...
		<p>
			Record metrics from your backend to be visualized in Highlight
			charts.
		</p>
		<h6>Method Parameters</h6>
		<aside className="parameter">
			...
			<p>
				The request context which should have highlight parameters set
				from highlight.InterceptRequest().
			</p>
			<h5>
				name <code>string</code> <code>required</code>
			</h5>
			<p>The metric name.</p>
			<h5>
				value <code>float64</code> <code>required</code>
			</h5>
	...
	<div className="right">
		<code>
			start := time.Now() defer func(){' '}
			{highlight.RecordMetric(
				ctx,
				'my.operation.duration-s',
...
<section className="section">
	<div className="left">
		...
		<aside className="parameter">
			<h5>
				service<code>string</code> <code>required</code>
			</h5>
