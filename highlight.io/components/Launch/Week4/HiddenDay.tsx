...
const HiddenDay = ({ title }: { title: string }) => {
	return (
		<div id="day-1" className="w-full max-w-[550px] md:max-w-none z-50">
			<div className="flex flex-col gap-2 py-6 lg:flex-row justify-between items-center border-x-[1px] border-b-[1px] border-[#C8C7CB] lg:h-[58px] px-4">
			...
			>
				<div
					className={classNames(
						'col-span-2 border-[1px] border-[#C8C7CB] border-t-[0px] h-[250px] md:h-[450px] w-full',
						styles.gridItem,
					)}
				>
					<div className="flex flex-col h-full justify-center">
						<div className="flex flex-col gap-2 items-center mx-auto">
							<Typography
								className="bg-[#6F6E77] bg-opacity-[0.2] px-4 py-1 text-[#6F6E77] rounded-[6px]"
								type="copy3"
								emphasis
							>
								Check back later
