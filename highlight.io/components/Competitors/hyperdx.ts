import hyperdxsmall from '../../public/images/hyperdx-small.png'
import hyperdxfull from '../../public/images/hyperdx.png'
...
export const HyperDxSpec: Competitor = {
	name: 'HyperDX',
	header: 'A Truly Open Source HyperDX Alternative.',
	subheader:
		'Session replay of your frontend, fullstack error monitoring, and powerful logging.',
	logoDesktop: hyperdxfull,
	logoMobile: hyperdxsmall,
	sections: [
		{
			title: 'General',
			rows: [
	...
	paragraphs: [
		HighlightIsOpenAndTransparent('HyperDX'),
		HighlightShipsNewFeatures,
		{
