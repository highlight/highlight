import pendosmall from '../../public/images/pendo-small.webp'
import pendofull from '../../public/images/pendo.svg'
...
export const PendoSpec: Competitor = {
	name: 'Pendo',
	header: 'A Truly Open Source Pendo Alternative.',
	subheader:
		'Session replay of your frontend, fullstack error monitoring, and powerful logging.',
	logoDesktop: pendofull,
	logoMobile: pendosmall,
	sections: [
		{
			title: 'General',
			rows: [
	...
	paragraphs: [
		HighlightIsOpenAndTransparent('Pendo'),
		HighlightShipsNewFeatures,
		{
			header: 'Full-stack Observability',
			body: 'While Pendo provides a comprehensive set of separate features for session replay, it does not support error monitoring or logging. [Highlight.io](https://highlight.io) enables teams to monitor and optimize their entire tech stack, pairing server-side infrastructure with your frontend web applications. This makes Highlight.io a more comprehensive solution for developers who need to monitor their entire tech stack, in a simple, easy to implement solution.',
		},
	],
}
