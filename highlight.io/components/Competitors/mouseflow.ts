import mouseflowfull from '../../public/images/mouseflow.svg'
import mouseflowsmall from '../../public/images/mouseflow-small.svg'
...
export const MouseflowSpec: Competitor = {
	name: 'Mouseflow',
	header: 'A Truly Open Source Mouseflow Alternative.',
	subheader:
		'Session replay of your frontend, fullstack error monitoring, and powerful logging.',
	logoDesktop: mouseflowfull,
	logoMobile: mouseflowsmall,
	sections: [
		{
			title: 'General',
			rows: [
	...
	paragraphs: [
		HighlightIsOpenAndTransparent('Mouseflow'),
		HighlightShipsNewFeatures,
		{
			header: 'Full-stack Observability',
			body: 'While Mouseflow provides a comprehensive set of separate features for session replay, it does not support error monitoring or logging. [Highlight.io](https://highlight.io) enables teams to monitor and optimize their entire tech stack, pairing server-side infrastructure with your frontend web applications. This makes Highlight.io a more comprehensive solution for developers who need to monitor their entire tech stack, in a simple, easy to implement solution.',
		},
	],
}
