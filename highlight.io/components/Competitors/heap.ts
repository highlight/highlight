import heapsmall from '../../public/images/heap-small.svg'
import heapfull from '../../public/images/heap.svg'
...
export const HeapSpec: Competitor = {
	name: 'Heap',
	header: 'A Truly Open Source Heap Alternative.',
	subheader:
		'Session replay of your frontend, fullstack error monitoring, and powerful logging.',
	logoDesktop: heapfull,
	logoMobile: heapsmall,
	sections: [
		{
			title: 'General',
			rows: [
	...
	paragraphs: [
		HighlightIsOpenAndTransparent('Heap'),
		HighlightShipsNewFeatures,
		{
			header: 'Full-stack Observability',
			body: 'While Heap provides a comprehensive set of separate features for session replay, it does not support logging and has limited features for error monitoring. [Highlight.io](https://highlight.io) enables teams to monitor and optimize their entire tech stack, pairing server-side infrastructure with your frontend web applications. This makes Highlight.io a more comprehensive solution for developers who need to monitor their entire tech stack, in a simple, easy to implement solution.',
		},
	],
}
