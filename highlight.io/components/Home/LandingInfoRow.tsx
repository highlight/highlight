...
const LandingInfoRow = ({
	...
	return (
		<div className={styles.landingInfoRow}>
			...
			<div className="flex md:hidden w-full h-[1px] bg-divider-on-dark">
				{' '}
			</div>
				...
				<div className="flex justify-start">
					<PrimaryButton
						...
						className={classNames(
							productStyles.hollowButton,
							productStyles.docsButton,
							'lg:mt-5',
						)}
					>
			...
			>
				...
				{code && (
					<div className="flex flex-col justify-center w-full">
						...
						<Typography
							type="copy3"
							className="text-copy-on-dark mx-auto mt-1"
						>
