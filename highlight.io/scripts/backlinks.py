...
server_technologies_logging = {
    'backend-sdk': ['go/overview', 'go/chi', 'go/echo', 'go/fiber', 'go/gin', 'go/gqlgen', 'go/mux', 'js/overview', 'js/apollo', 'js/aws-lambda', 'js/cloudflare', 'js/express', 'js/firebase', 'js/hono', 'js/nestjs', 'js/nextjs', 'js/nodejs', 'js/trpc', 'python/overview', 'python/aws-lambda', 'python/azure-functions', 'python/django', 'python/fastapi', 'python/flask', 'python/google-cloud-functions', 'python/other', 'ruby/overview', 'ruby/other', 'ruby/rails', 'rust/overview', 'rust/actix', 'rust/other', 'elixir/overview', 'elixir/other', 'dotnet', 'dotnet-4'],
    'backend-logging': ['go/overview', 'go/fiber', 'go/logrus', 'go/other', 'js/overview', 'js/cloudflare', 'js/nestjs', 'js/nodejs', 'js/pino', 'js/winston', 'python/overview', 'python/loguru', 'python/otel', 'python/other', 'ruby/overview', 'ruby/other', 'ruby/rails', 'rust/overview', 'rust/actix', 'rust/other', 'hosting/overview', 'hosting/aws-metrics', 'hosting/aws', 'hosting/azure', 'hosting/fly-io', 'hosting/gcp', 'hosting/heroku', 'hosting/render', 'hosting/trigger', 'hosting/vercel', 'elixir/overview', 'elixir/other', 'dotnet', 'dotnet-4', 'docker', 'file', 'fluent-forward', 'http', 'otlp', 'syslog', 'systemd'],
    'backend-tracing': ['go/overview', 'go/manual', 'go/gorm', 'node-js/manual', 'node-js/nextjs', 'python/overview', 'python/manual', 'python/aws-lambda', 'python/azure-functions', 'python/django', 'python/fastapi', 'python/flask', 'python/google-cloud-functions', 'python/python-libraries', 'python/python-ai', 'ruby/overview', 'ruby/other', 'ruby/rails', 'rust/overview', 'rust/actix', 'rust/other', 'serverless/aws-lambda', 'dotnet', 'dotnet-4'],
}
