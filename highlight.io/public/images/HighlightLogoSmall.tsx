...
function SvgHighlightLogoSmall(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 183 183" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <circle cx={91.5} cy={91.5} r={91.5} fill="url(#highlight-logo-small_svg__paint0_linear)" />
      <path
